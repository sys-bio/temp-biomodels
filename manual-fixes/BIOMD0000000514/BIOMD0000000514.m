...
# Reaction: id = TPI_g, name = TPI_g
	...
	reaction_TPI_g=function_v1sub1prod(reaction_TPI_g_TPI_g_Vmax, reaction_TPI_g_TPI_g_Keq, x(4), reaction_TPI_g_TPI_g_KmDHAP, x(26), reaction_TPI_g_TPI_g_KmGA3P);
...
# Reaction: id = G6PDH_g, name = G6PDH_g
	...
	reaction_G6PDH_g=function_v2sub2prod(reaction_G6PDH_g_G6PDH_g_Vmax, reaction_G6PDH_g_G6PDH_g_Keq, x(6), reaction_G6PDH_g_G6PDH_g_KmGlc6P, x(12), reaction_G6PDH_g_G6PDH_g_KmNADP, x(32), reaction_G6PDH_g_G6PDH_g_Km6PGL, x(21), reaction_G6PDH_g_G6PDH_g_KmNADPH);
...
# Reaction: id = G6PDH_c, name = G6PDH_c
	...
	reaction_G6PDH_c=function_v2sub2prod(reaction_G6PDH_c_G6PDH_c_Vmax, reaction_G6PDH_c_G6PDH_c_Keq, x(17), reaction_G6PDH_c_G6PDH_c_KmGlc6P, x(10), reaction_G6PDH_c_G6PDH_c_KmNADP, x(30), reaction_G6PDH_c_G6PDH_c_Km6PGL, x(22), reaction_G6PDH_c_G6PDH_c_KmNADPH);
...
# Reaction: id = HXK_g, name = HXK_g
	...
	reaction_HXK_g=function_v2sub2prod(reaction_HXK_g_HXK_g_Vmax, reaction_HXK_g_HXK_g_Keq, x(20), reaction_HXK_g_HXK_g_KmGlc, x(3), reaction_HXK_g_HXK_g_KmATP, x(6), reaction_HXK_g_HXK_g_KmGlc6P, x(5), reaction_HXK_g_HXK_g_KmADP);
# Reaction: id = _3PGAT_g, name = _3PGAT_g

	# Local Parameter:   id =  _3PGAT_g_k, name = _3PGAT_g_k
	reaction__3PGAT_g__3PGAT_g_k=250.0;

	reaction__3PGAT_g=function_mass_action_rev(reaction__3PGAT_g__3PGAT_g_k, x(35), reaction__3PGAT_g__3PGAT_g_k, x(8));
...
# Reaction: id = HXK_c, name = HXK_c
	...
	reaction_HXK_c=function_v2sub2prod(reaction_HXK_c_HXK_c_Vmax, reaction_HXK_c_HXK_c_Keq, x(19), reaction_HXK_c_HXK_c_KmGlc, x(11), reaction_HXK_c_HXK_c_KmATP, x(17), reaction_HXK_c_HXK_c_KmGlc6P, x(7), reaction_HXK_c_HXK_c_KmADP);
...
# Reaction: id = AK_c, name = AK_c
	...
	reaction_AK_c=function_vAK(x(7), x(36), x(11), reaction_AK_c_AK_c_k1, reaction_AK_c_AK_c_k2);
...
# Reaction: id = AK_g, name = AK_g
	...
	reaction_AK_g=function_vAK(x(5), x(34), x(3), reaction_AK_g_AK_g_k1, reaction_AK_g_AK_g_k2);
...
# Reaction: id = _6PGDH_c, name = _6PGDH_c
	...
	reaction__6PGDH_c=function_v2sub2prod(reaction__6PGDH_c__6PGDH_c_Vmax, reaction__6PGDH_c__6PGDH_c_Keq, x(15), reaction__6PGDH_c__6PGDH_c_Km6PG, x(10), reaction__6PGDH_c__6PGDH_c_KmNADP, x(14), reaction__6PGDH_c__6PGDH_c_KmRul5P, x(22), reaction__6PGDH_c__6PGDH_c_KmNADPH);
...
# Reaction: id = TR_c, name = TR_c
	...
	reaction_TR_c=function_v2sub2prod(reaction_TR_c_TR_c_Vmax, reaction_TR_c_TR_c_Keq, x(31), reaction_TR_c_TR_c_KmTS2, x(22), reaction_TR_c_TR_c_KmNADPH, x(27), reaction_TR_c_TR_c_KmTSH2, x(10), reaction_TR_c_TR_c_KmNADP);
# Reaction: id = PGK_g, name = PGK_g
	...
	reaction_PGK_g=function_v2sub2prod(reaction_PGK_g_PGK_g_Vmax, reaction_PGK_g_PGK_g_Keq, x(18), reaction_PGK_g_PGK_g_Km13BPGA, x(5), reaction_PGK_g_PGK_g_KmADP, x(35), reaction_PGK_g_PGK_g_Km3PGA, x(3), reaction_PGK_g_PGK_g_KmATP);
# Reaction: id = G3PDH_g, name = G3PDH_g
	...
	reaction_G3PDH_g=function_v2sub2prod(reaction_G3PDH_g_G3PDH_g_Vmax, reaction_G3PDH_g_G3PDH_g_Keq, x(4), reaction_G3PDH_g_G3PDH_g_KmDHAP, x(37), reaction_G3PDH_g_G3PDH_g_KmNADH, x(29), reaction_G3PDH_g_G3PDH_g_KmGly3P, x(24), reaction_G3PDH_g_G3PDH_g_KmNAD);
...
# Reaction: id = GK_g, name = GK_g
	...
	reaction_GK_g=function_v2sub2prod(reaction_GK_g_GK_g_Vmax, reaction_GK_g_GK_g_Keq, x(29), reaction_GK_g_GK_g_KmGly3P, x(5), reaction_GK_g_GK_g_KmADP, const_species_Gly_e, reaction_GK_g_GK_g_KmGly, x(3), reaction_GK_g_GK_g_KmATP);
