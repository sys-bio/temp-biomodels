...
switch MODEL
    ...
    case 'MYSDEITO'
        ...
        if( (strcmp(LOADDATA,'N') && strcmp(PARESTIMATE,'N')) || (strcmp(LOADDATA,'N') && strcmp(PARESTIMATE,'Y')) ||  (strcmp(LOADDATA,'Y') && strcmp(PARESTIMATE,'N')) )
            Xzero1 = input('\nWrite the value of the initial condition X01: ');
            if(isempty(Xzero1))
                error('X0 must be specified');
            end
            Xzero2 = input('\nWrite the value of the initial condition X02: ');
            if(isempty(Xzero2))
                error('X0 must be specified');
            end
            Xzero3 = input('\nWrite the value of the initial condition X03: ');
            if(isempty(Xzero3))
                error('X0 must be specified');
            end
            Xzero4 = input('\nWrite the value of the initial condition X04: ');
            if(isempty(Xzero4))
                error('X0 must be specified');
            end
            Xzero5 = input('\nWrite the value of the initial condition X05: ');
            if(isempty(Xzero5))
                error('X0 must be specified');
            end
            Xzero6 = input('\nWrite the value of the initial condition X06: ');
            if(isempty(Xzero6))
                error('X0 must be specified');
            end
            ...
            bigtheta(6+3)  = 10            ;
            bigtheta(6+4)  = 0.5           ;
            bigtheta(6+5)  = 0.4/3600      ;
            bigtheta(6+6)  = 37            ;
            bigtheta(6+7)  = 0.4           ;
            bigtheta(6+8)  = 0.55          ;
            bigtheta(6+9)  = 10            ;
            bigtheta(6+10) = 0.032         ;
            bigtheta(6+11) = 12/pi*3600    ;
            bigtheta(6+12) = 0.99729       ;
            bigtheta(6+13) = 24.2          ;
            bigtheta(6+14) = 0.13          ;
            bigtheta(6+15) = -0.7          ;
            bigtheta(6+16) = 1             ;
        ...
        %:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
        PARMASK = [0,0,0,0,0,0];  % write 1 for parameters to be estimated and 0 for fixed parameters. WARNING: PARMASK(1) should always be set to zero (corresponds to the SDE initial condition)
        %:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
