...
%
% Model name = Kerkhoven2013 - Glycolysis and Pentose Phosphate Pathway in T.brucei - MODEL D in fructose medium (with ATP:ADP antiporter)
%
% is http://identifiers.org/biomodels.db/MODEL1401310003
% is http://identifiers.org/biomodels.db/BIOMD0000000516
% isDescribedBy http://identifiers.org/pubmed/24339766
% isDerivedFrom http://identifiers.org/biomodels.db/BIOMD0000000511
%
...
% Reaction: id = TPI_g, name = TPI_g	% Local Parameter:   id =  TPI_g_Vmax, name = TPI_g_Vmax
	...
	reaction_TPI_g=v1sub1prod(reaction_TPI_g_TPI_g_Vmax, reaction_TPI_g_TPI_g_Keq, x(6), reaction_TPI_g_TPI_g_KmDHAP, x(28), reaction_TPI_g_TPI_g_KmGA3P);
...
% Reaction: id = PYK_c, name = PYK_c	% Local Parameter:   id =  PYK_c_Vmax, name = PYK_c_Vmax
	...
	reaction_PYK_c=reaction_PYK_c_PYK_c_Vmax*x(9)*(1-x(25)*x(13)/(reaction_PYK_c_PYK_c_Keq*x(35)*x(9)))*(x(35)/(reaction_PYK_c_PYK_c_KmPEP*(1+x(9)/reaction_PYK_c_PYK_c_KiADP+x(13)/reaction_PYK_c_PYK_c_KiATP)))^reaction_PYK_c_PYK_c_n/(reaction_PYK_c_PYK_c_KmADP*(1+(x(35)/(reaction_PYK_c_PYK_c_KmPEP*(1+x(9)/reaction_PYK_c_PYK_c_KiADP+x(13)/reaction_PYK_c_PYK_c_KiATP)))^reaction_PYK_c_PYK_c_n+x(25)/reaction_PYK_c_PYK_c_KmPyr)*(1+x(9)/reaction_PYK_c_PYK_c_KmADP+x(13)/reaction_PYK_c_PYK_c_KmATP));
...
% Reaction: id = PFK_g, name = PFK_g	% Local Parameter:   id =  PFK_g_Vmax, name = PFK_g_Vmax
	...
	reaction_PFK_g=reaction_PFK_g_PFK_g_Vmax*reaction_PFK_g_PFK_g_Ki1*x(11)*x(5)*(1-x(27)*x(7)/(reaction_PFK_g_PFK_g_Keq*x(11)*x(5)))/(reaction_PFK_g_PFK_g_KmFru6P*reaction_PFK_g_PFK_g_KmATP*(x(27)+reaction_PFK_g_PFK_g_Ki1)*(reaction_PFK_g_PFK_g_KsATP/reaction_PFK_g_PFK_g_KmATP+x(11)/reaction_PFK_g_PFK_g_KmFru6P+x(5)/reaction_PFK_g_PFK_g_KmATP+x(7)/reaction_PFK_g_PFK_g_KmADP+x(27)*x(7)/(reaction_PFK_g_PFK_g_KmADP*reaction_PFK_g_PFK_g_Ki2)+x(11)*x(5)/(reaction_PFK_g_PFK_g_KmFru6P*reaction_PFK_g_PFK_g_KmATP)));
...
% Reaction: id = G6PDH_g, name = G6PDH_g	% Local Parameter:   id =  G6PDH_g_Vmax, name = G6PDH_g_Vmax
	...
	reaction_G6PDH_g=v2sub2prod(reaction_G6PDH_g_G6PDH_g_Vmax, reaction_G6PDH_g_G6PDH_g_Keq, x(8), reaction_G6PDH_g_G6PDH_g_KmGlc6P, x(14), reaction_G6PDH_g_G6PDH_g_KmNADP, x(34), reaction_G6PDH_g_G6PDH_g_Km6PGL, x(23), reaction_G6PDH_g_G6PDH_g_KmNADPH);
...
% Reaction: id = PyrT_c, name = PyrT_c	% Local Parameter:   id =  PyrT_c_Vmax, name = PyrT_c_Vmax
	...
	reaction_PyrT_c=v1sub(reaction_PyrT_c_PyrT_c_Vmax, x(25), reaction_PyrT_c_PyrT_c_KmPyr);
...
% Reaction: id = G6PDH_c, name = G6PDH_c	% Local Parameter:   id =  G6PDH_c_Vmax, name = G6PDH_c_Vmax
	...
	reaction_G6PDH_c=v2sub2prod(reaction_G6PDH_c_G6PDH_c_Vmax, reaction_G6PDH_c_G6PDH_c_Keq, x(19), reaction_G6PDH_c_G6PDH_c_KmGlc6P, x(12), reaction_G6PDH_c_G6PDH_c_KmNADP, x(32), reaction_G6PDH_c_G6PDH_c_Km6PGL, x(24), reaction_G6PDH_c_G6PDH_c_KmNADPH);
...
% Reaction: id = ENO_c, name = ENO_c	% Local Parameter:   id =  ENO_c_Vmax, name = ENO_c_Vmax
	...
	reaction_ENO_c=v1sub1prod(reaction_ENO_c_ENO_c_Vmax, reaction_ENO_c_ENO_c_Keq, x(1), reaction_ENO_c_ENO_c_Km2PGA, x(35), reaction_ENO_c_ENO_c_KmPEP);
...
% Reaction: id = HXK_g, name = HXK_g	% Local Parameter:   id =  HXK_g_Vmax, name = HXK_g_Vmax
	...
	reaction_HXK_g=v2sub2prod_compinhib(reaction_HXK_g_HXK_g_Vmax, reaction_HXK_g_HXK_g_Keq, x(22), reaction_HXK_g_HXK_g_KmGlc, x(5), reaction_HXK_g_HXK_g_KmATP, x(8), reaction_HXK_g_HXK_g_KmGlc6P, x(7), reaction_HXK_g_HXK_g_KmADP, x(2), reaction_HXK_g_HXK_g_KiFru, x(11), reaction_HXK_g_HXK_g_KiFru6P);

% Reaction: id = _3PGAT_g, name = _3PGAT_g	% Local Parameter:   id =  _3PGAT_g_k, name = _3PGAT_g_k
	reaction__3PGAT_g__3PGAT_g_k=250.0;

	reaction__3PGAT_g=mass_action_rev(reaction__3PGAT_g__3PGAT_g_k, x(37), reaction__3PGAT_g__3PGAT_g_k, x(10));

% Reaction: id = NADPHu_c, name = NADPHu_c	% Local Parameter:   id =  NADPHu_c_k, name = NADPHu_c_k
	reaction_NADPHu_c_NADPHu_c_k=2.0;

	reaction_NADPHu_c=mass_action_irrev(reaction_NADPHu_c_NADPHu_c_k, x(24));
...
% Reaction: id = HXK_c, name = HXK_c	% Local Parameter:   id =  HXK_c_Vmax, name = HXK_c_Vmax
	...
	reaction_HXK_c=v2sub2prod_compinhib(reaction_HXK_c_HXK_c_Vmax, reaction_HXK_c_HXK_c_Keq, x(21), reaction_HXK_c_HXK_c_KmGlc, x(13), reaction_HXK_c_HXK_c_KmATP, x(19), reaction_HXK_c_HXK_c_KmGlc6P, x(9), reaction_HXK_c_HXK_c_KmADP, x(3), reaction_HXK_c_HXK_c_KiFru, const_species_Fru6P_c, reaction_HXK_c_HXK_c_KiFru6P);

% Reaction: id = NADPHu_g, name = NADPHu_g	% Local Parameter:   id =  NADPHu_g_k, name = NADPHu_g_k
	reaction_NADPHu_g_NADPHu_g_k=2.0;

	reaction_NADPHu_g=mass_action_irrev(reaction_NADPHu_g_NADPHu_g_k, x(23));
...
% Reaction: id = G6PP_c, name = G6PP_c	% Local Parameter:   id =  G6PP_c_Vmax, name = G6PP_c_Vmax
	...
	reaction_G6PP_c=v1sub1prod(reaction_G6PP_c_G6PP_c_Vmax, reaction_G6PP_c_G6PP_c_Keq, x(19), reaction_G6PP_c_G6PP_c_KmGlc6P, x(21), reaction_G6PP_c_G6PP_c_KmGlc);
...
% Reaction: id = AK_c, name = AK_c	% Local Parameter:   id =  AK_c_k1, name = AK_c_k1
	...
	reaction_AK_c=vAK(x(9), x(38), x(13), reaction_AK_c_AK_c_k1, reaction_AK_c_AK_c_k2);
...
% Reaction: id = PGI_g, name = PGI_g	% Local Parameter:   id =  PGI_g_Vmax, name = PGI_g_Vmax
	...
	reaction_PGI_g=reaction_PGI_g_PGI_g_Vmax*x(8)*(1-x(11)/(reaction_PGI_g_PGI_g_Keq*x(8)))/(reaction_PGI_g_PGI_g_KmGlc6P*(1+x(8)/reaction_PGI_g_PGI_g_KmGlc6P+x(11)/reaction_PGI_g_PGI_g_KmFru6P+x(15)/reaction_PGI_g_PGI_g_Ki6PG));
...
% Reaction: id = HXKfru_c, name = HXKfru_c	% Local Parameter:   id =  HXKfru_c_Vmax, name = HXKfru_c_Vmax
	...
	reaction_HXKfru_c=v2sub2prod_compinhib(reaction_HXKfru_c_HXKfru_c_Vmax, reaction_HXKfru_c_HXKfru_c_Keq, x(3), reaction_HXKfru_c_HXKfru_c_KmFru, x(13), reaction_HXKfru_c_HXKfru_c_KmATP, const_species_Fru6P_c, reaction_HXKfru_c_HXKfru_c_KmFru6P, x(9), reaction_HXKfru_c_HXKfru_c_KmADP, x(21), reaction_HXKfru_c_HXKfru_c_KiGlc, x(19), reaction_HXKfru_c_HXKfru_c_KiGlc6P);

% Reaction: id = TOX_c, name = TOX_c	% Local Parameter:   id =  TOX_c_k, name = TOX_c_k
	reaction_TOX_c_TOX_c_k=2.0;

	reaction_TOX_c=mass_action_irrev(reaction_TOX_c_TOX_c_k, x(29));

% Reaction: id = GDA_g, name = GDA_g	% Local Parameter:   id =  GDA_g_k, name = GDA_g_k
	reaction_GDA_g_GDA_g_k=600.0;

	reaction_GDA_g=x(31)*reaction_GDA_g_GDA_g_k*x(4)-x(30)*reaction_GDA_g_GDA_g_k*x(6);

% Reaction: id = ATPT_g, name = ATPT_g	% Local Parameter:   id =  ATPT_g_Vmax, name = ATPT_g_Vmax
	reaction_ATPT_g_ATPT_g_Vmax=1.5;
	% Local Parameter:   id =  ATPT_g_Keq, name = ATPT_g_Keq
	reaction_ATPT_g_ATPT_g_Keq=1.0;
	% Local Parameter:   id =  ATPT_g_KmADP, name = ATPT_g_KmADP
	reaction_ATPT_g_ATPT_g_KmADP=0.02;
	% Local Parameter:   id =  ATPT_g_KmATP, name = ATPT_g_KmATP
	reaction_ATPT_g_ATPT_g_KmATP=0.02;

	reaction_ATPT_g=v2sub2prod(reaction_ATPT_g_ATPT_g_Vmax, reaction_ATPT_g_ATPT_g_Keq, x(7), reaction_ATPT_g_ATPT_g_KmADP, x(13), reaction_ATPT_g_ATPT_g_KmATP, x(9), reaction_ATPT_g_ATPT_g_KmADP, x(5), reaction_ATPT_g_ATPT_g_KmATP);
...
% Reaction: id = PGL_c, name = PGL_c	% Local Parameter:   id =  PGL_c_Vmax, name = PGL_c_Vmax
	...
	reaction_PGL_c=reaction_PGL_c_PGL_c_k*compartment_cytosol*(x(32)-x(17)/reaction_PGL_c_PGL_c_Keq)+v1sub1prod(reaction_PGL_c_PGL_c_Vmax, reaction_PGL_c_PGL_c_Keq, x(32), reaction_PGL_c_PGL_c_Km6PGL, x(17), reaction_PGL_c_PGL_c_Km6PG);
...
% Reaction: id = AK_g, name = AK_g	% Local Parameter:   id =  AK_g_k1, name = AK_g_k1
	...
	reaction_AK_g=vAK(x(7), x(36), x(5), reaction_AK_g_AK_g_k1, reaction_AK_g_AK_g_k2);
...
% Reaction: id = _6PGDH_c, name = _6PGDH_c	% Local Parameter:   id =  _6PGDH_c_Vmax, name = _6PGDH_c_Vmax
	...
	reaction__6PGDH_c=v2sub2prod(reaction__6PGDH_c__6PGDH_c_Vmax, reaction__6PGDH_c__6PGDH_c_Keq, x(17), reaction__6PGDH_c__6PGDH_c_Km6PG, x(12), reaction__6PGDH_c__6PGDH_c_KmNADP, x(16), reaction__6PGDH_c__6PGDH_c_KmRul5P, x(24), reaction__6PGDH_c__6PGDH_c_KmNADPH);
...
% Reaction: id = PPI_c, name = PPI_c	% Local Parameter:   id =  PPI_c_Vmax, name = PPI_c_Vmax
	...
	reaction_PPI_c=v1sub1prod(reaction_PPI_c_PPI_c_Vmax, reaction_PPI_c_PPI_c_Keq, x(16), reaction_PPI_c_PPI_c_KmRul5P, const_species_Rib5P_c, reaction_PPI_c_PPI_c_KmRib5P);
...
% Reaction: id = PPI_g, name = PPI_g	% Local Parameter:   id =  PPI_g_Vmax, name = PPI_g_Vmax
	...
	reaction_PPI_g=v1sub1prod(reaction_PPI_g_PPI_g_Vmax, reaction_PPI_g_PPI_g_Keq, x(18), reaction_PPI_g_PPI_g_KmRul5P, const_species_Rib5P_g, reaction_PPI_g_PPI_g_KmRib5P);
...
% Reaction: id = _6PGDH_g, name = _6PGDH_g	% Local Parameter:   id =  _6PGDH_g_Vmax, name = _6PGDH_g_Vmax
	...
	reaction__6PGDH_g=v2sub2prod(reaction__6PGDH_g__6PGDH_g_Vmax, reaction__6PGDH_g__6PGDH_g_Keq, x(15), reaction__6PGDH_g__6PGDH_g_Km6PG, x(14), reaction__6PGDH_g__6PGDH_g_KmNADP, x(18), reaction__6PGDH_g__6PGDH_g_KmRul5P, x(23), reaction__6PGDH_g__6PGDH_g_KmNADPH);
...
% Reaction: id = GlcT_g, name = GlcT_g	% Local Parameter:   id =  GlcT_g_k1, name = GlcT_g_k1
	...
	reaction_GlcT_g=mass_action_rev(reaction_GlcT_g_GlcT_g_k1, x(21), reaction_GlcT_g_GlcT_g_k2, x(22));
...
% Reaction: id = GlcT_c, name = GlcT_c	% Local Parameter:   id =  GlcT_c_Vmax, name = GlcT_c_Vmax
	...
	reaction_GlcT_c=reaction_GlcT_c_GlcT_c_Vmax*(const_species_Glc_e-x(21))/(reaction_GlcT_c_GlcT_c_KmGlc+const_species_Glc_e+x(21)+reaction_GlcT_c_GlcT_c_alpha*const_species_Glc_e*x(21)/reaction_GlcT_c_GlcT_c_KmGlc);
...
% Reaction: id = PGL_g, name = PGL_g	% Local Parameter:   id =  PGL_g_Vmax, name = PGL_g_Vmax
	...
	reaction_PGL_g=compartment_glycosome*reaction_PGL_g_PGL_g_k*(x(34)-x(15)/reaction_PGL_g_PGL_g_Keq)+v1sub1prod(reaction_PGL_g_PGL_g_Vmax, reaction_PGL_g_PGL_g_Keq, x(34), reaction_PGL_g_PGL_g_Km6PGL, x(15), reaction_PGL_g_PGL_g_Km6PG);
...
% Reaction: id = TR_c, name = TR_c	% Local Parameter:   id =  TR_c_Vmax, name = TR_c_Vmax
	...
	reaction_TR_c=v2sub2prod(reaction_TR_c_TR_c_Vmax, reaction_TR_c_TR_c_Keq, x(33), reaction_TR_c_TR_c_KmTS2, x(24), reaction_TR_c_TR_c_KmNADPH, x(29), reaction_TR_c_TR_c_KmTSH2, x(12), reaction_TR_c_TR_c_KmNADP);
...
% Reaction: id = PGK_g, name = PGK_g	% Local Parameter:   id =  PGK_g_Vmax, name = PGK_g_Vmax
	...
	reaction_PGK_g=v2sub2prod(reaction_PGK_g_PGK_g_Vmax, reaction_PGK_g_PGK_g_Keq, x(20), reaction_PGK_g_PGK_g_Km13BPGA, x(7), reaction_PGK_g_PGK_g_KmADP, x(37), reaction_PGK_g_PGK_g_Km3PGA, x(5), reaction_PGK_g_PGK_g_KmATP);
...
% Reaction: id = G3PDH_g, name = G3PDH_g	% Local Parameter:   id =  G3PDH_g_Vmax, name = G3PDH_g_Vmax
	...
	reaction_G3PDH_g=v2sub2prod(reaction_G3PDH_g_G3PDH_g_Vmax, reaction_G3PDH_g_G3PDH_g_Keq, x(6), reaction_G3PDH_g_G3PDH_g_KmDHAP, x(39), reaction_G3PDH_g_G3PDH_g_KmNADH, x(31), reaction_G3PDH_g_G3PDH_g_KmGly3P, x(26), reaction_G3PDH_g_G3PDH_g_KmNAD);
...
% Reaction: id = ATPu_c, name = ATPu_c	% Local Parameter:   id =  ATPu_c_k, name = ATPu_c_k
	...
	reaction_ATPu_c=reaction_ATPu_c_ATPu_c_k*x(13)/x(9);
...
% Reaction: id = GK_g, name = GK_g	% Local Parameter:   id =  GK_g_Vmax, name = GK_g_Vmax
	...
	reaction_GK_g=v2sub2prod(reaction_GK_g_GK_g_Vmax, reaction_GK_g_GK_g_Keq, x(31), reaction_GK_g_GK_g_KmGly3P, x(7), reaction_GK_g_GK_g_KmADP, const_species_Gly_e, reaction_GK_g_GK_g_KmGly, x(5), reaction_GK_g_GK_g_KmATP);
...
% Reaction: id = ALD_g, name = ALD_g	% Local Parameter:   id =  ALD_g_Vmax, name = ALD_g_Vmax
	...
	reaction_ALD_g=reaction_ALD_g_ALD_g_Vmax*x(27)*(1-x(28)*x(6)/(x(27)*reaction_ALD_g_ALD_g_Keq))/(reaction_ALD_g_ALD_g_KmFru16BP*(1+x(5)/reaction_ALD_g_ALD_g_KiATP+x(7)/reaction_ALD_g_ALD_g_KiADP+x(36)/reaction_ALD_g_ALD_g_KiAMP)*(1+x(28)/reaction_ALD_g_ALD_g_KmGA3P+x(6)/reaction_ALD_g_ALD_g_KmDHAP+x(27)/(reaction_ALD_g_ALD_g_KmFru16BP*(1+x(5)/reaction_ALD_g_ALD_g_KiATP+x(7)/reaction_ALD_g_ALD_g_KiADP+x(36)/reaction_ALD_g_ALD_g_KiAMP))+x(28)*x(6)/(reaction_ALD_g_ALD_g_KmGA3P*reaction_ALD_g_ALD_g_KmDHAP)+x(27)*x(28)/(reaction_ALD_g_ALD_g_KmFru16BP*reaction_ALD_g_ALD_g_KiGA3P*(1+x(5)/reaction_ALD_g_ALD_g_KiATP+x(7)/reaction_ALD_g_ALD_g_KiADP+x(36)/reaction_ALD_g_ALD_g_KiAMP))));
...
% Reaction: id = GAPDH_g, name = GAPDH_g	% Local Parameter:   id =  GAPDH_g_Vmax, name = GAPDH_g_Vmax
	...
	reaction_GAPDH_g=v2sub2prod(reaction_GAPDH_g_GAPDH_g_Vmax, reaction_GAPDH_g_GAPDH_g_Keq, x(28), reaction_GAPDH_g_GAPDH_g_KmGA3P, x(26), reaction_GAPDH_g_GAPDH_g_KmNAD, x(20), reaction_GAPDH_g_GAPDH_g_Km13BPGA, x(39), reaction_GAPDH_g_GAPDH_g_KmNADH);
...
% Reaction: id = GPO_c, name = GPO_c	% Local Parameter:   id =  GPO_c_Vmax, name = GPO_c_Vmax
	...
	reaction_GPO_c=v1sub(reaction_GPO_c_GPO_c_Vmax, x(30), reaction_GPO_c_GPO_c_KmGly3P);
...
% Species:   id = Fru_c, name = Fru_c, affected by kineticLaw
	xdot(3) = (1/(compartment_cytosol))*((-1.0 * reaction_HXKfru_c) + ( 1.0 * reaction_FruT_c) + (-1.0 * reaction_FruT_g));
...
% Species:   id = ATP_g, name = ATP_g, affected by kineticLaw
	xdot(5) = (1/(compartment_glycosome))*((-1.0 * reaction_PFK_g) + (-1.0 * reaction_HXK_g) + (-1.0 * reaction_HXKfru_g) + ( 1.0 * reaction_ATPT_g) + ( 1.0 * reaction_AK_g) + ( 1.0 * reaction_PGK_g) + ( 1.0 * reaction_GK_g));
...
% Species:   id = ADP_g, name = ADP_g, affected by kineticLaw
	xdot(7) = (1/(compartment_glycosome))*(( 1.0 * reaction_PFK_g) + ( 1.0 * reaction_HXK_g) + ( 1.0 * reaction_HXKfru_g) + (-1.0 * reaction_ATPT_g) + (-2.0 * reaction_AK_g) + (-1.0 * reaction_PGK_g) + (-1.0 * reaction_GK_g));
...
% Species:   id = ADP_c, name = ADP_c, affected by kineticLaw
	xdot(9) = (1/(compartment_cytosol))*((-1.0 * reaction_PYK_c) + ( 1.0 * reaction_HXK_c) + (-2.0 * reaction_AK_c) + ( 1.0 * reaction_HXKfru_c) + ( 1.0 * reaction_ATPT_g) + ( 1.0 * reaction_ATPu_c));
...
% Species:   id = Fru6P_g, name = Fru6P_g, affected by kineticLaw
	xdot(11) = (1/(compartment_glycosome))*((-1.0 * reaction_PFK_g) + ( 1.0 * reaction_HXKfru_g) + ( 1.0 * reaction_PGI_g));
	
% Species:   id = NADP_c, name = NADP_c, affected by kineticLaw
	xdot(12) = (1/(compartment_cytosol))*((-1.0 * reaction_G6PDH_c) + ( 1.0 * reaction_NADPHu_c) + (-1.0 * reaction__6PGDH_c) + ( 1.0 * reaction_TR_c));
	
% Species:   id = ATP_c, name = ATP_c, affected by kineticLaw
	xdot(13) = (1/(compartment_cytosol))*(( 1.0 * reaction_PYK_c) + (-1.0 * reaction_HXK_c) + ( 1.0 * reaction_AK_c) + (-1.0 * reaction_HXKfru_c) + (-1.0 * reaction_ATPT_g) + (-1.0 * reaction_ATPu_c));
	
% Species:   id = NADP_g, name = NADP_g, affected by kineticLaw
	xdot(14) = (1/(compartment_glycosome))*((-1.0 * reaction_G6PDH_g) + ( 1.0 * reaction_NADPHu_g) + (-1.0 * reaction__6PGDH_g));
	
% Species:   id = _6PG_g, name = _6PG_g, affected by kineticLaw
	xdot(15) = (1/(compartment_glycosome))*((-1.0 * reaction__6PGDH_g) + ( 1.0 * reaction_PGL_g));
	
% Species:   id = Rul5P_c, name = Rul5P_c, affected by kineticLaw
	xdot(16) = (1/(compartment_cytosol))*(( 1.0 * reaction__6PGDH_c) + (-1.0 * reaction_PPI_c));
	
% Species:   id = _6PG_c, name = _6PG_c, affected by kineticLaw
	xdot(17) = (1/(compartment_cytosol))*(( 1.0 * reaction_PGL_c) + (-1.0 * reaction__6PGDH_c));
	
% Species:   id = Rul5P_g, name = Rul5P_g, affected by kineticLaw
	xdot(18) = (1/(compartment_glycosome))*((-1.0 * reaction_PPI_g) + ( 1.0 * reaction__6PGDH_g));
	
% Species:   id = Glc6P_c, name = Glc6P_c, affected by kineticLaw
	xdot(19) = (1/(compartment_cytosol))*((-1.0 * reaction_G6PDH_c) + ( 1.0 * reaction_HXK_c) + (-1.0 * reaction_G6PP_c));
	
% Species:   id = _13BPGA_g, name = _13BPGA_g, affected by kineticLaw
	xdot(20) = (1/(compartment_glycosome))*((-1.0 * reaction_PGK_g) + ( 1.0 * reaction_GAPDH_g));
	
% Species:   id = Glc_c, name = Glc_c, affected by kineticLaw
	xdot(21) = (1/(compartment_cytosol))*((-1.0 * reaction_HXK_c) + ( 1.0 * reaction_G6PP_c) + (-1.0 * reaction_GlcT_g) + ( 1.0 * reaction_GlcT_c));
	
% Species:   id = Glc_g, name = Glc_g, affected by kineticLaw
	xdot(22) = (1/(compartment_glycosome))*((-1.0 * reaction_HXK_g) + ( 1.0 * reaction_GlcT_g));
	
% Species:   id = NADPH_g, name = NADPH_g, affected by kineticLaw
	xdot(23) = (1/(compartment_glycosome))*(( 1.0 * reaction_G6PDH_g) + (-1.0 * reaction_NADPHu_g) + ( 1.0 * reaction__6PGDH_g));
	
% Species:   id = NADPH_c, name = NADPH_c, affected by kineticLaw
	xdot(24) = (1/(compartment_cytosol))*(( 1.0 * reaction_G6PDH_c) + (-1.0 * reaction_NADPHu_c) + ( 1.0 * reaction__6PGDH_c) + (-1.0 * reaction_TR_c));
	
% Species:   id = Pyr_c, name = Pyr_c, affected by kineticLaw
	xdot(25) = (1/(compartment_cytosol))*(( 1.0 * reaction_PYK_c) + (-1.0 * reaction_PyrT_c));
...
% Species:   id = Fru16BP_g, name = Fru16BP_g, affected by kineticLaw
	xdot(27) = (1/(compartment_glycosome))*(( 1.0 * reaction_PFK_g) + (-1.0 * reaction_ALD_g));
	
% Species:   id = GA3P_g, name = GA3P_g, affected by kineticLaw
	xdot(28) = (1/(compartment_glycosome))*(( 1.0 * reaction_TPI_g) + ( 1.0 * reaction_ALD_g) + (-1.0 * reaction_GAPDH_g));
	
% Species:   id = TSH2_c, name = TSH2_c, affected by kineticLaw
	xdot(29) = (1/(compartment_cytosol))*((-1.0 * reaction_TOX_c) + ( 1.0 * reaction_TR_c));
	
% Species:   id = Gly3P_c, name = Gly3P_c, affected by kineticLaw
	xdot(30) = (1/(compartment_cytosol))*(( 1.0 * reaction_GDA_g) + (-1.0 * reaction_GPO_c));
	
% Species:   id = Gly3P_g, name = Gly3P_g, affected by kineticLaw
	xdot(31) = (1/(compartment_glycosome))*((-1.0 * reaction_GDA_g) + ( 1.0 * reaction_G3PDH_g) + (-1.0 * reaction_GK_g));
	
% Species:   id = _6PGL_c, name = _6PGL_c, affected by kineticLaw
	xdot(32) = (1/(compartment_cytosol))*(( 1.0 * reaction_G6PDH_c) + (-1.0 * reaction_PGL_c));
	
% Species:   id = TS2_c, name = TS2_c, affected by kineticLaw
	xdot(33) = (1/(compartment_cytosol))*(( 1.0 * reaction_TOX_c) + (-1.0 * reaction_TR_c));
	
% Species:   id = _6PGL_g, name = _6PGL_g, affected by kineticLaw
	xdot(34) = (1/(compartment_glycosome))*(( 1.0 * reaction_G6PDH_g) + (-1.0 * reaction_PGL_g));
	
% Species:   id = PEP_c, name = PEP_c, affected by kineticLaw
	xdot(35) = (1/(compartment_cytosol))*((-1.0 * reaction_PYK_c) + ( 1.0 * reaction_ENO_c));
	
% Species:   id = AMP_g, name = AMP_g, affected by kineticLaw
	xdot(36) = (1/(compartment_glycosome))*(( 1.0 * reaction_AK_g));
	
% Species:   id = _3PGA_g, name = _3PGA_g, affected by kineticLaw
	xdot(37) = (1/(compartment_glycosome))*((-1.0 * reaction__3PGAT_g) + ( 1.0 * reaction_PGK_g));
	
% Species:   id = AMP_c, name = AMP_c, affected by kineticLaw
	xdot(38) = (1/(compartment_cytosol))*(( 1.0 * reaction_AK_c));
	
% Species:   id = NADH_g, name = NADH_g, affected by kineticLaw
	xdot(39) = (1/(compartment_glycosome))*((-1.0 * reaction_G3PDH_g) + ( 1.0 * reaction_GAPDH_g));
end
