...
function z=function_CACT(Vf,Vr,Kms1,Kms2,Kmp1,Kmp2,Kis1,Kip2,Keq,S1,S2,P1,P2), z=(Vf*(S1*S2-P1*P2/Keq)/(S1*S2+Kms2*S1+Kms1*S2*(1+P2/Kip2)+Vf/(Vr*Keq)*(Kmp2*P1*(1+S1/Kis1)+P2*(Kmp1+P1))));endfunction
...
function z=function_CROT(sf,V,Kms1,Kms2,Kms3,Kms4,Kms5,Kms6,Kms7,Kmp1,Kmp2,Kmp3,Kmp4,Kmp5,Kmp6,Kmp7,Ki1,Keq,S1,S2,S3,S4,S5,S6,S7,P1,P2,P3,P4,P5,P6,P7,I1), z=(sf*V*(S1/Kms1-P1/(Kms1*Keq))/(1+S1/Kms1+P1/Kmp1+S2/Kms2+P2/Kmp2+S3/Kms3+P3/Kmp3+S4/Kms4+P4/Kmp4+S5/Kms5+P5/Kmp5+S6/Kms6+P6/Kmp6+S7/Kms7+P7/Kmp7+I1/Ki1));endfunction

function z=function_MSCHAD(sf,V,Kms1,Kms2,Kms3,Kms4,Kms5,Kms6,Kms7,Kms8,Kmp1,Kmp2,Kmp3,Kmp4,Kmp5,Kmp6,Kmp7,Kmp8,Keq,S1,S2,S3,S4,S5,S6,S7,S8,P1,P2,P3,P4,P5,P6,P7,P8), z=(sf*V*(S1*(S8-P8)/(Kms1*Kms8)-P1*P8/(Kms1*Kms8*Keq))/((1+S1/Kms1+P1/Kmp1+S2/Kms2+P2/Kmp2+S3/Kms3+P3/Kmp3+S4/Kms4+P4/Kmp4+S5/Kms5+P5/Kmp5+S6/Kms6+P6/Kmp6+S7/Kms7+P7/Kmp7)*(1+(S8-P8)/Kms8+P8/Kmp8)));endfunction
...
# Reaction: id = vcactC12
	...
	reaction_vcactC12=function_CACT(global_par_Vfcact, global_par_Vrcact, reaction_vcactC12_KmcactC12AcylCarCYT, global_par_KmcactCarMAT, reaction_vcactC12_KmcactC12AcylCarMAT, global_par_KmcactCarCYT, reaction_vcactC12_KicactC12AcylCarCYT, global_par_KicactCarCYT, global_par_Keqcact, x(13), const_species_CarMAT, x(14), const_species_CarCYT);
# Reaction: id = vcactC10
...
# Reaction: id = vcactC6
	...
	reaction_vcactC6=function_CACT(global_par_Vfcact, global_par_Vrcact, reaction_vcactC6_KmcactC6AcylCarCYT, global_par_KmcactCarMAT, reaction_vcactC6_KmcactC6AcylCarMAT, global_par_KmcactCarCYT, reaction_vcactC6_KicactC6AcylCarCYT, global_par_KicactCarCYT, global_par_Keqcact, x(31), const_species_CarMAT, x(32), const_species_CarCYT);
# Reaction: id = vcactC4
...
# Reaction: id = vlcadC8
	...
	# Local Parameter:   id =  sflcadC8, name = sflcadC8
...
# Reaction: id = vmcadC4
	...
	# Local Parameter:   id =  sfmcadC4, name = sfmcadC4
...
# Reaction: id = vscadC6
	...
	# Local Parameter:   id =  sfscadC6, name = sfscadC6
	reaction_vscadC6_sfscadC6=0.3;

	reaction_vscadC6=function_SCAD(reaction_vscadC6_sfscadC6, global_par_Vscad, global_par_KmscadC6AcylCoAMAT, global_par_KmscadC4AcylCoAMAT, global_par_KmscadFAD, global_par_KmscadC6EnoylCoAMAT, global_par_KmscadC4EnoylCoAMAT, global_par_KmscadFADH, global_par_Keqscad, x(33), x(39), const_species_FADtMAT, x(34), x(40), x(44));
# Reaction: id = vscadC4

	# Local Parameter:   id =  sfscadC4, name = sfscadC4
	reaction_vscadC4_sfscadC4=1.0;

	reaction_vscadC4=function_SCAD(reaction_vscadC4_sfscadC4, global_par_Vscad, global_par_KmscadC4AcylCoAMAT, global_par_KmscadC6AcylCoAMAT, global_par_KmscadFAD, global_par_KmscadC4EnoylCoAMAT, global_par_KmscadC6EnoylCoAMAT, global_par_KmscadFADH, global_par_Keqscad, x(39), x(33), const_species_FADtMAT, x(40), x(34), x(44));
# Reaction: id = vcrotC16

	# Local Parameter:   id =  sfcrotC16, name = sfcrotC16
...
# Reaction: id = vcrotC14

	# Local Parameter:   id =  sfcrotC14, name = sfcrotC14
...
# Reaction: id = vcrotC12

	# Local Parameter:   id =  sfcrotC12, name = sfcrotC12
...
# Reaction: id = vcrotC10

	# Local Parameter:   id =  sfcrotC10, name = sfcrotC10
	reaction_vcrotC10_sfcrotC10=0.33;

	reaction_vcrotC10=function_CROT(reaction_vcrotC10_sfcrotC10, global_par_Vcrot, global_par_KmcrotC10EnoylCoAMAT, global_par_KmcrotC16EnoylCoAMAT, global_par_KmcrotC14EnoylCoAMAT, global_par_KmcrotC12EnoylCoAMAT, global_par_KmcrotC8EnoylCoAMAT, global_par_KmcrotC6EnoylCoAMAT, global_par_KmcrotC4EnoylCoAMAT, global_par_KmcrotC10HydroxyacylCoAMAT, global_par_KmcrotC16HydroxyacylCoAMAT, global_par_KmcrotC14HydroxyacylCoAMAT, global_par_KmcrotC12HydroxyacylCoAMAT, global_par_KmcrotC8HydroxyacylCoAMAT, global_par_KmcrotC6HydroxyacylCoAMAT, global_par_KmcrotC4HydroxyacylCoAMAT, global_par_KicrotC4AcetoacylCoA, global_par_Keqcrot, x(22), x(4), x(10), x(16), x(28), x(34), x(40), x(23), x(5), x(11), x(17), x(29), x(35), x(41), x(42));
# Reaction: id = vcrotC8

	# Local Parameter:   id =  sfcrotC8, name = sfcrotC8
...
# Reaction: id = vmschadC16

	# Local Parameter:   id =  sfmschadC16, name = sfmschadC16
...
# Reaction: id = vmschadC14

	# Local Parameter:   id =  sfmschadC14, name = sfmschadC14
...
# Reaction: id = vmschadC12

	# Local Parameter:   id =  sfmschadC12, name = sfmschadC12
...
# Reaction: id = vmschadC10

	# Local Parameter:   id =  sfmschadC10, name = sfmschadC10
...
# Reaction: id = vmschadC8

	# Local Parameter:   id =  sfmschadC8, name = sfmschadC8
...
# Reaction: id = vmckatC16

	# Local Parameter:   id =  sfmckatC16, name = sfmckatC16
...
# Reaction: id = vmckatC14

	# Local Parameter:   id =  sfmckatC14, name = sfmckatC14
...
# Reaction: id = vmckatC12

	# Local Parameter:   id =  sfmckatC12, name = sfmckatC12
...
# Reaction: id = vmckatC10

	# Local Parameter:   id =  sfmckatC10, name = sfmckatC10
...
# Reaction: id = vmckatC8

	# Local Parameter:   id =  sfmckatC8, name = sfmckatC8
...
# Reaction: id = vacesink
	...
	reaction_vacesink=function_RES(reaction_vacesink_Ksacesink, x(43), reaction_vacesink_K1acesink);
# Reaction: id = vfadhsink

	# Local Parameter:   id =  K1fadhsink, name = K1fadhsink
	reaction_vfadhsink_K1fadhsink=0.46;
	# Local Parameter:   id =  Ksfadhsink, name = Ksfadhsink
	reaction_vfadhsink_Ksfadhsink=6000000.0;

	reaction_vfadhsink=function_RES(reaction_vfadhsink_Ksfadhsink, x(44), reaction_vfadhsink_K1fadhsink);
# Reaction: id = vnadhsink

	# Local Parameter:   id =  K1nadhsink, name = K1nadhsink
	reaction_vnadhsink_K1nadhsink=16.0;
	# Local Parameter:   id =  Ksnadhsink, name = Ksnadhsink
	reaction_vnadhsink_Ksnadhsink=6000000.0;

	reaction_vnadhsink=function_RES(reaction_vnadhsink_Ksnadhsink, x(45), reaction_vnadhsink_K1nadhsink);
# Species:   id = C16AcylCoACYT, name = C16AcylCoACYT, constant
	const_species_C16AcylCoACYT=25.0;
# Species:   id = CarCYT, name = CarCYT, constant
	const_species_CarCYT=200.0;
