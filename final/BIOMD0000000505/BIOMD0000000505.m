...
%
% Model name = vanEunen2013 - Network dynamics of fatty acid β-oxidation (steady-state model)
%
% is http://identifiers.org/biomodels.db/MODEL1312040000
% is http://identifiers.org/biomodels.db/BIOMD0000000505
...
% Reaction: id = vcpt1C16	% Local Parameter:   id =  Keqcpt1, name = Keqcpt1
	...
	reaction_vcpt1C16_Kmcpt1CarCYT=250.0;
...
% Reaction: id = vacesink	% Local Parameter:   id =  K1acesink, name = K1acesink
	reaction_vacesink_K1acesink=70.0;
...
% Species:   id = C16AcylCoACYT, name = C16AcylCoACYT, constant	const_species_C16AcylCoACYT=25.0;

% Species:   id = CarCYT, name = CarCYT, constant	const_species_CarCYT=200.0;
