...
%
% Model name = Radosavljevic2009_BioterroristAttack_PanicProtection_1
%
% isDescribedBy http://identifiers.org/pubmed/19423234
% is http://identifiers.org/biomodels.db/MODEL1203070000
% is http://identifiers.org/biomodels.db/BIOMD0000000836
%
...
% Species:   id = S, name = panic_intensity, involved in a rule 	xdot(1) = x(1);
	
% Species:   id = P, name = protection+prevention_intensity, involved in a rule 	xdot(2) = x(2);
end
