...
#
# is urn:miriam:biomodels.db:MODEL3897771820
# isDescribedBy urn:miriam:pubmed:16581849
#
...
function z=function_BB(A1,A2,A3,A4), z=(A2-A1+A3*A2+A4*A1);endfunction

function z=function_GK(A1,A2,A3,A4), z=(2*A4*A1/(A2-A1+A3*A2+A4*A1+((A2-A1+A3*A2+A4*A1)^2-4*(A2-A1)*A4*A1)^(0.5)));endfunction

function z=function_MichaelisMenten(M1,J1,k1,S1), z=(k1*S1*M1/(J1+S1));endfunction

function z=function_Mass_Action_2(k1,S1,S2), z=(k1*S1*S2);endfunction

function z=function_Mass_Action_1(k1,S1), z=(k1*S1);endfunction

function z=function_Mass_Action_0(k1), z=(k1);endfunction
...
# assignmentRule: variable = Wee1
	x(30)=function_GK(global_par_kaweea+global_par_kaweeb*x(4), global_par_kiweea+global_par_kiweeb*x(15), global_par_Jawee, global_par_Jiwee);
# assignmentRule: variable = Vwee
	global_par_Vwee=global_par_kweea+global_par_kweeb*x(30);
# assignmentRule: variable = Cdc25P
	x(8)=function_GK(global_par_ka25a+global_par_ka25b*x(15), global_par_ki25a+global_par_ki25b*x(4), global_par_Ja25, global_par_Ji25);
# assignmentRule: variable = V25
	global_par_V25=global_par_k25a+global_par_k25b*x(8);
# assignmentRule: variable = TFB
	x(24)=function_GK(global_par_kafb*x(15), global_par_kifb, global_par_Jafb, global_par_Jifb);
...
# assignmentRule: variable = TFE
	x(25)=function_GK(global_par_Vatf, global_par_Vitf, global_par_Jatf, global_par_Jitf);
...
# assignmentRule: variable = TFI
	x(26)=function_GK(global_par_kafi*x(4), global_par_kifi+global_par_kifib*x(15), global_par_Jafi, global_par_Jifi);
...
# Reaction: id = Mass_accumulation, name = Mass accumulation
	...
	reaction_Mass_accumulation=function_Mass_Action_0(global_par_mu*x(20)*(1-x(20)/global_par_MaxMass));
...
# Reaction: id = Deg_of_MPF, name = Deg. of MPF
	...
	reaction_Deg_of_MPF=function_Mass_Action_1(global_par_Vdb, x(15));
# Reaction: id = activation_of_MPF_from_pB_by_Cdc25, name = activation of MPF from pB by Cdc25


	reaction_activation_of_MPF_from_pB_by_Cdc25=function_Mass_Action_1(global_par_V25, x(21));
# Reaction: id = inactivation_of_MPFby_Wee1, name = inactivation of MPFby Wee1


	reaction_inactivation_of_MPFby_Wee1=function_Mass_Action_1(global_par_Vwee, x(15));
# Reaction: id = assoc_of_MPF_with_CKI, name = assoc. of MPF with CKI


	reaction_assoc_of_MPF_with_CKI=function_Mass_Action_2(global_par_kassb, x(15), x(11));
# Reaction: id = dissoc_1, name = dissoc1


	reaction_dissoc_1=function_Mass_Action_1(global_par_kdissb, x(3));
# Reaction: id = deg_of_pB, name = deg. of pB


	reaction_deg_of_pB=function_Mass_Action_1(global_par_Vdb, x(21));
# Reaction: id = assoc_of_pB_with_CKI, name = assoc. of pB with CKI


	reaction_assoc_of_pB_with_CKI=function_Mass_Action_2(global_par_kassb, x(21), x(11));
# Reaction: id = dissoc_2, name = dissoc2


	reaction_dissoc_2=function_Mass_Action_1(global_par_kdissb, x(22));
# Reaction: id = Cdc25_action, name = Cdc25 action


	reaction_Cdc25_action=function_Mass_Action_1(global_par_V25, x(22));
# Reaction: id = Wee1_action, name = Wee1 action


	reaction_Wee1_action=function_Mass_Action_1(global_par_Vwee, x(3));
# Reaction: id = Deg_of_CycB_moeity__in_BCKI, name = Deg. of CycB moeity  in BCKI


	reaction_Deg_of_CycB_moeity__in_BCKI=function_Mass_Action_1(global_par_Vdb, x(3));
# Reaction: id = Deg_of_CKI_moeity_in_BCKI, name = Deg. of CKI moeity in BCKI


	reaction_Deg_of_CKI_moeity_in_BCKI=function_Mass_Action_1(global_par_Vdi, x(3));
# Reaction: id = Deg_of_pB_moeity_in_pBCKI, name = Deg. of pB moeity in pBCKI


	reaction_Deg_of_pB_moeity_in_pBCKI=function_Mass_Action_1(global_par_Vdb, x(22));
# Reaction: id = Deg_of_CKI_moeity_in_pBCKI, name = Deg. of CKI moeity in pBCKI


	reaction_Deg_of_CKI_moeity_in_pBCKI=function_Mass_Action_1(global_par_Vdi, x(22));
...
# Reaction: id = Deg_of_CKI, name = Deg. of CKI
	...
	reaction_Deg_of_CKI=function_Mass_Action_1(global_par_Vdi, x(11));
# Reaction: id = Assoc_of_CKI_with_CycA, name = Assoc. of CKI with CycA


	reaction_Assoc_of_CKI_with_CycA=function_Mass_Action_2(global_par_kassa, x(11), x(13));
# Reaction: id = dissoc_3, name = dissoc3


	reaction_dissoc_3=function_Mass_Action_1(global_par_kdissa, x(27));
# Reaction: id = Deg_of_CKI_moeity_in_TriA, name = Deg. of CKI moeity in TriA


	reaction_Deg_of_CKI_moeity_in_TriA=function_Mass_Action_1(global_par_Vdi, x(27));
# Reaction: id = Deg_of_CycA_moeity_in_TriA, name = Deg. of CycA moeity in TriA


	reaction_Deg_of_CycA_moeity_in_TriA=function_Mass_Action_1(global_par_Vda, x(27));
# Reaction: id = Assoc_of_CKI_with_CycE, name = Assoc. of CKI with CycE


	reaction_Assoc_of_CKI_with_CycE=function_Mass_Action_2(global_par_kasse, x(11), x(18));
# Reaction: id = dissoc_4, name = dissoc4


	reaction_dissoc_4=function_Mass_Action_1(global_par_kdisse, x(29));
# Reaction: id = Deg_of_CKI_moeity_in_TriE, name = Deg. of CKI moeity in TriE


	reaction_Deg_of_CKI_moeity_in_TriE=function_Mass_Action_1(global_par_Vdi, x(29));
# Reaction: id = Deg_of_CycE_moeity_in_TriE, name = Deg. of CycE moeity in TriE


	reaction_Deg_of_CycE_moeity_in_TriE=function_Mass_Action_1(global_par_Vde, x(29));
...
# Reaction: id = Deg_of_CycA, name = Deg. of CycA
	...
	reaction_Deg_of_CycA=function_Mass_Action_1(global_par_Vda, x(13));
...
# Reaction: id = Deg_of_CycE, name = Deg. of CycE
	...
	reaction_Deg_of_CycE=function_Mass_Action_1(global_par_Vde, x(18));
# Reaction: id = activation_of_APCP, name = activation of APCP


	reaction_activation_of_APCP=function_MichaelisMenten(x(15), global_par_Jaie, global_par_kaie, x(1));
# Reaction: id = inactivation_1, name = inactivation1


	reaction_inactivation_1=function_MichaelisMenten(1, global_par_Jiie, global_par_kiie, x(2));
# Reaction: id = Synthesis_of_Cdc20i, name = Synthesis of Cdc20i


	reaction_Synthesis_of_Cdc20i=function_Mass_Action_0(global_par_ks20a+global_par_ks20b*x(15)^global_par_n20/(global_par_J20^global_par_n20+x(15)^global_par_n20));
# Reaction: id = Deg_of_Cdc20i, name = Deg. of Cdc20i


	reaction_Deg_of_Cdc20i=function_Mass_Action_1(global_par_kd20, x(6));
# Reaction: id = activation_of_Cdc20i, name = activation of Cdc20i


	reaction_activation_of_Cdc20i=function_MichaelisMenten(x(2), global_par_Ja20, global_par_ka20, x(6));
# Reaction: id = inactivation_2, name = inactivation2


	reaction_inactivation_2=function_MichaelisMenten(1, global_par_Ji20, global_par_ki20, x(5));
# Reaction: id = degradation, name = degradation


	reaction_degradation=function_Mass_Action_1(global_par_kd20, x(5));
# Reaction: id = activation_of_Cdh1, name = activation of Cdh1


	reaction_activation_of_Cdh1=function_MichaelisMenten(global_par_Vah1, global_par_Jah1, 1, x(10));
# Reaction: id = inactivation__of_Cdh1, name = inactivation  of Cdh1


	reaction_inactivation__of_Cdh1=function_MichaelisMenten(global_par_Vih1, global_par_Jih1, 1, x(9));
...
#Event: id=
	...
	xdot=zeros(30,1);
	# Species:   id = APC, name = APC, involved in a rule 
	xdot(1) = x(1);
	...
	# Species:   id = Cdc14, name = Cdc14, defined in a rule 
	xdot(4) = x(4);
	...
	# Species:   id = Cdc20T, name = Cdc20T, defined in a rule 
	xdot(7) = x(7);

	# Species:   id = Cdc25P, name = Cdc25P, defined in a rule 
	xdot(8) = x(8);
	...
	# Species:   id = Cdh1i, name = Cdh1i, involved in a rule 
	xdot(10) = x(10);
	...
	# Species:   id = CycAT, name = CycAT, defined in a rule 
	xdot(14) = x(14);
	...
	# Species:   id = CycBT, name = CycBT, defined in a rule 
	xdot(16) = x(16);

	# Species:   id = CycD, name = CycD, defined in a rule 
	xdot(17) = x(17);
	...
	# Species:   id = CycET, name = CycET, defined in a rule 
	xdot(19) = x(19);
	...
	# Species:   id = preMPF, name = preMPF, defined in a rule 
	xdot(23) = x(23);

	# Species:   id = TFB, name = TFB, defined in a rule 
	xdot(24) = x(24);

	# Species:   id = TFE, name = TFE, defined in a rule 
	xdot(25) = x(25);

	# Species:   id = TFI, name = TFI, defined in a rule 
	xdot(26) = x(26);
	...
	# Species:   id = TriB, name = TriB, defined in a rule 
	xdot(28) = x(28);
	...
	# Species:   id = Wee1, name = Wee1, defined in a rule 
	xdot(30) = x(30);
