...
% Reaction: id = J8
	reaction_J8=(global_par_g1*x(11)+global_par_eta7)/(1+global_par_eta7/global_par_f+global_par_h1*x(11)+global_par_h2*x(11)*x(10));
