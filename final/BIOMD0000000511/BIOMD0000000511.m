...
# Reaction: id = TPI_g, name = TPI_g
	...
	reaction_TPI_g=function_v1sub1prod(reaction_TPI_g_TPI_g_Vmax, reaction_TPI_g_TPI_g_Keq, x(5), reaction_TPI_g_TPI_g_KmDHAP, x(26), reaction_TPI_g_TPI_g_KmGA3P);
...
# Reaction: id = G6PDH_g, name = G6PDH_g
	...
	reaction_G6PDH_g=function_v2sub2prod(reaction_G6PDH_g_G6PDH_g_Vmax, reaction_G6PDH_g_G6PDH_g_Keq, x(7), reaction_G6PDH_g_G6PDH_g_KmGlc6P, x(12), reaction_G6PDH_g_G6PDH_g_KmNADP, x(32), reaction_G6PDH_g_G6PDH_g_Km6PGL, x(21), reaction_G6PDH_g_G6PDH_g_KmNADPH);
# Reaction: id = PGAM_c, name = PGAM_c
	...
	reaction_PGAM_c=function_v1sub1prod(reaction_PGAM_c_PGAM_c_Vmax, reaction_PGAM_c_PGAM_c_Keq, x(9), reaction_PGAM_c_PGAM_c_Km3PGA, x(1), reaction_PGAM_c_PGAM_c_Km2PGA);
# Reaction: id = PyrT_c, name = PyrT_c
	...
	reaction_PyrT_c=function_v1sub(reaction_PyrT_c_PyrT_c_Vmax, x(23), reaction_PyrT_c_PyrT_c_KmPyr);
# Reaction: id = G6PDH_c, name = G6PDH_c
	...
	reaction_G6PDH_c=function_v2sub2prod(reaction_G6PDH_c_G6PDH_c_Vmax, reaction_G6PDH_c_G6PDH_c_Keq, x(17), reaction_G6PDH_c_G6PDH_c_KmGlc6P, x(11), reaction_G6PDH_c_G6PDH_c_KmNADP, x(30), reaction_G6PDH_c_G6PDH_c_Km6PGL, x(22), reaction_G6PDH_c_G6PDH_c_KmNADPH);
# Reaction: id = ENO_c, name = ENO_c
	...
	reaction_ENO_c=function_v1sub1prod(reaction_ENO_c_ENO_c_Vmax, reaction_ENO_c_ENO_c_Keq, x(1), reaction_ENO_c_ENO_c_Km2PGA, x(33), reaction_ENO_c_ENO_c_KmPEP);
# Reaction: id = HXK_g, name = HXK_g
	...
	reaction_HXK_g=function_v2sub2prod(reaction_HXK_g_HXK_g_Vmax, reaction_HXK_g_HXK_g_Keq, x(20), reaction_HXK_g_HXK_g_KmGlc, x(4), reaction_HXK_g_HXK_g_KmATP, x(7), reaction_HXK_g_HXK_g_KmGlc6P, x(6), reaction_HXK_g_HXK_g_KmADP);
# Reaction: id = _3PGAT_g, name = _3PGAT_g

	# Local Parameter:   id =  _3PGAT_g_k, name = _3PGAT_g_k
	reaction__3PGAT_g__3PGAT_g_k=250.0;

	reaction__3PGAT_g=function_mass_action_rev(reaction__3PGAT_g__3PGAT_g_k, x(35), reaction__3PGAT_g__3PGAT_g_k, x(9));
# Reaction: id = NADPHu_c, name = NADPHu_c

	# Local Parameter:   id =  NADPHu_c_k, name = NADPHu_c_k
	reaction_NADPHu_c_NADPHu_c_k=2.0;

	reaction_NADPHu_c=function_mass_action_irrev(reaction_NADPHu_c_NADPHu_c_k, x(22));
# Reaction: id = HXK_c, name = HXK_c
	...
	reaction_HXK_c=function_v2sub2prod(reaction_HXK_c_HXK_c_Vmax, reaction_HXK_c_HXK_c_Keq, x(19), reaction_HXK_c_HXK_c_KmGlc, x(2), reaction_HXK_c_HXK_c_KmATP, x(17), reaction_HXK_c_HXK_c_KmGlc6P, x(8), reaction_HXK_c_HXK_c_KmADP);
# Reaction: id = NADPHu_g, name = NADPHu_g

	# Local Parameter:   id =  NADPHu_g_k, name = NADPHu_g_k
	reaction_NADPHu_g_NADPHu_g_k=2.0;

	reaction_NADPHu_g=function_mass_action_irrev(reaction_NADPHu_g_NADPHu_g_k, x(21));
# Reaction: id = AK_c, name = AK_c
	...
	reaction_AK_c=function_vAK(x(8), x(36), x(2), reaction_AK_c_AK_c_k1, reaction_AK_c_AK_c_k2);
# Reaction: id = G6PP_c, name = G6PP_c
	...
	reaction_G6PP_c=function_v1sub1prod(reaction_G6PP_c_G6PP_c_Vmax, reaction_G6PP_c_G6PP_c_Keq, x(17), reaction_G6PP_c_G6PP_c_KmGlc6P, x(19), reaction_G6PP_c_G6PP_c_KmGlc);
# Reaction: id = _6PGDH_g, name = _6PGDH_g
	...
	reaction__6PGDH_g=function_v2sub2prod(reaction__6PGDH_g__6PGDH_g_Vmax, reaction__6PGDH_g__6PGDH_g_Keq, x(13), reaction__6PGDH_g__6PGDH_g_Km6PG, x(12), reaction__6PGDH_g__6PGDH_g_KmNADP, x(16), reaction__6PGDH_g__6PGDH_g_KmRul5P, x(21), reaction__6PGDH_g__6PGDH_g_KmNADPH);
...
# Reaction: id = AK_g, name = AK_g
	...
	reaction_AK_g=function_vAK(x(6), x(34), x(4), reaction_AK_g_AK_g_k1, reaction_AK_g_AK_g_k2);
# Reaction: id = TOX_c, name = TOX_c

	# Local Parameter:   id =  TOX_c_k, name = TOX_c_k
	reaction_TOX_c_TOX_c_k=2.0;

	reaction_TOX_c=function_mass_action_irrev(reaction_TOX_c_TOX_c_k, x(27));
...
# Reaction: id = ATPT_g, name = ATPT_g

	# Local Parameter:   id =  ATPT_g_Vmax, name = ATPT_g_Vmax
	...
	reaction_ATPT_g=function_v2sub2prod(reaction_ATPT_g_ATPT_g_Vmax, reaction_ATPT_g_ATPT_g_Keq, x(6), reaction_ATPT_g_ATPT_g_KmADP, x(2), reaction_ATPT_g_ATPT_g_KmATP, x(8), reaction_ATPT_g_ATPT_g_KmADP, x(4), reaction_ATPT_g_ATPT_g_KmATP);
# Reaction: id = PGL_c, name = PGL_c
	...
	reaction_PGL_c=reaction_PGL_c_PGL_c_k*compartment_cytosol*(x(30)-x(15)/reaction_PGL_c_PGL_c_Keq)+function_v1sub1prod(reaction_PGL_c_PGL_c_Vmax, reaction_PGL_c_PGL_c_Keq, x(30), reaction_PGL_c_PGL_c_Km6PGL, x(15), reaction_PGL_c_PGL_c_Km6PG);
# Reaction: id = _6PGDH_c, name = _6PGDH_c
	...
	reaction__6PGDH_c=function_v2sub2prod(reaction__6PGDH_c__6PGDH_c_Vmax, reaction__6PGDH_c__6PGDH_c_Keq, x(15), reaction__6PGDH_c__6PGDH_c_Km6PG, x(11), reaction__6PGDH_c__6PGDH_c_KmNADP, x(14), reaction__6PGDH_c__6PGDH_c_KmRul5P, x(22), reaction__6PGDH_c__6PGDH_c_KmNADPH);
# Reaction: id = PPI_c, name = PPI_c
	...
	reaction_PPI_c=function_v1sub1prod(reaction_PPI_c_PPI_c_Vmax, reaction_PPI_c_PPI_c_Keq, x(14), reaction_PPI_c_PPI_c_KmRul5P, const_species_Rib5P_c, reaction_PPI_c_PPI_c_KmRib5P);
# Reaction: id = PPI_g, name = PPI_g
	...
	reaction_PPI_g=function_v1sub1prod(reaction_PPI_g_PPI_g_Vmax, reaction_PPI_g_PPI_g_Keq, x(16), reaction_PPI_g_PPI_g_KmRul5P, const_species_Rib5P_g, reaction_PPI_g_PPI_g_KmRib5P);
# Reaction: id = GlcT_g, name = GlcT_g
	...
	reaction_GlcT_g=function_mass_action_rev(reaction_GlcT_g_GlcT_g_k1, x(19), reaction_GlcT_g_GlcT_g_k2, x(20));
...
# Reaction: id = PGL_g, name = PGL_g
	...
	reaction_PGL_g=compartment_glycosome*reaction_PGL_g_PGL_g_k*(x(32)-x(13)/reaction_PGL_g_PGL_g_Keq)+function_v1sub1prod(reaction_PGL_g_PGL_g_Vmax, reaction_PGL_g_PGL_g_Keq, x(32), reaction_PGL_g_PGL_g_Km6PGL, x(13), reaction_PGL_g_PGL_g_Km6PG);
# Reaction: id = TR_c, name = TR_c
	...
	reaction_TR_c=function_v2sub2prod(reaction_TR_c_TR_c_Vmax, reaction_TR_c_TR_c_Keq, x(31), reaction_TR_c_TR_c_KmTS2, x(22), reaction_TR_c_TR_c_KmNADPH, x(27), reaction_TR_c_TR_c_KmTSH2, x(11), reaction_TR_c_TR_c_KmNADP);
# Reaction: id = PGK_g, name = PGK_g
	...
	reaction_PGK_g=function_v2sub2prod(reaction_PGK_g_PGK_g_Vmax, reaction_PGK_g_PGK_g_Keq, x(18), reaction_PGK_g_PGK_g_Km13BPGA, x(6), reaction_PGK_g_PGK_g_KmADP, x(35), reaction_PGK_g_PGK_g_Km3PGA, x(4), reaction_PGK_g_PGK_g_KmATP);
# Reaction: id = G3PDH_g, name = G3PDH_g
	...
	reaction_G3PDH_g=function_v2sub2prod(reaction_G3PDH_g_G3PDH_g_Vmax, reaction_G3PDH_g_G3PDH_g_Keq, x(5), reaction_G3PDH_g_G3PDH_g_KmDHAP, x(37), reaction_G3PDH_g_G3PDH_g_KmNADH, x(29), reaction_G3PDH_g_G3PDH_g_KmGly3P, x(24), reaction_G3PDH_g_G3PDH_g_KmNAD);
...
# Reaction: id = GK_g, name = GK_g
	...
	reaction_GK_g=function_v2sub2prod(reaction_GK_g_GK_g_Vmax, reaction_GK_g_GK_g_Keq, x(29), reaction_GK_g_GK_g_KmGly3P, x(6), reaction_GK_g_GK_g_KmADP, const_species_Gly_e, reaction_GK_g_GK_g_KmGly, x(4), reaction_GK_g_GK_g_KmATP);
...
# Reaction: id = GAPDH_g, name = GAPDH_g
	...
	reaction_GAPDH_g=function_v2sub2prod(reaction_GAPDH_g_GAPDH_g_Vmax, reaction_GAPDH_g_GAPDH_g_Keq, x(26), reaction_GAPDH_g_GAPDH_g_KmGA3P, x(24), reaction_GAPDH_g_GAPDH_g_KmNAD, x(18), reaction_GAPDH_g_GAPDH_g_Km13BPGA, x(37), reaction_GAPDH_g_GAPDH_g_KmNADH);
# Reaction: id = GPO_c, name = GPO_c
	...
	reaction_GPO_c=function_v1sub(reaction_GPO_c_GPO_c_Vmax, x(28), reaction_GPO_c_GPO_c_KmGly3P);
...
# Species:   id = Rib5P_g, name = Rib5P_g, constant
	const_species_Rib5P_g=0.01;
