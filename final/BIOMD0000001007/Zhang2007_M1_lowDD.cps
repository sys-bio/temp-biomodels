...
<!-- generated with COPASI 4.31 (Build 243) (http://www.copasi.org) at 2021-06-23T11:55:48Z -->
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  ...
  <Model key="Model_1" name="Zhang2007 - Mechanism of DNA damage response (Model1)" simulationType="time" timeUnit="s" volumeUnit="l" areaUnit="m²" lengthUnit="m" quantityUnit="mol" type="deterministic" avogadroConstant="6.0221408570000002e+23">
    <MiriamAnnotation>
<rdf:RDF
...
<rdf:Description rdf:about="#ModelParameterSet_1">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=Zhang2007 - Mechanism of DNA damage response (Model1),Vector=Values[xyz]" value="6" type="ModelValue" simulationType="assignment"/>
          ...
          <ModelParameter cn="CN=Root,Model=Zhang2007 - Mechanism of DNA damage response (Model1),Vector=Values[Dam0]" value="2" type="ModelValue" simulationType="fixed"/>
    ...
    <InitialState type="initialState">
      0 9.5149825540599996e+22 1.1201181994019999e+23 3.8963251344790117e+23 0 0.050000000000000003 3.4343797815046568 0.64700000000000191 0.53763440860215062 0.82999999999999996 0.53763440860215062 0.38356118563692809 6 0 -50 1 1 0.59999999999999998 0.45000000000000001 0.27000000000000002 4 0.40999999999999998 0.050000000000000003 0.050000000000000003 0.14999999999999999 0.92000000000000004 4 0.82999999999999996 0.10000000000000001 0.10000000000000001 0.080000000000000002 2.5600000000000001 8.25 4.2300000000000004 0.79000000000000004 2 50 2 
    </InitialState>
  </Model>
  <ListOfTasks>
  ...
  <SBMLReference file="Zhang2007_M1_lowDD.xml">
    <SBMLMap SBMLid="DNAdamage" COPASIkey="Metabolite_3"/>
    <SBMLMap SBMLid="Dam0" COPASIkey="ModelValue_28"/>
    <SBMLMap SBMLid="G_u_v_q_r" COPASIkey="ModelValue_20"/>
    <SBMLMap SBMLid="J1" COPASIkey="ModelValue_13"/>
    <SBMLMap SBMLid="J2" COPASIkey="ModelValue_14"/>
    <SBMLMap SBMLid="Js2" COPASIkey="ModelValue_9"/>
    <SBMLMap SBMLid="Js53" COPASIkey="ModelValue_1"/>
    <SBMLMap SBMLid="MDM2cyt" COPASIkey="Metabolite_1"/>
    <SBMLMap SBMLid="MDM2cyt_degradation" COPASIkey="Reaction_4"/>
    <SBMLMap SBMLid="MDM2cyt_production" COPASIkey="Reaction_2"/>
    <SBMLMap SBMLid="MDM2cyt_translocation" COPASIkey="Reaction_3"/>
    <SBMLMap SBMLid="MDM2nuc" COPASIkey="Metabolite_2"/>
    <SBMLMap SBMLid="MDM2nuc_degradation" COPASIkey="Reaction_5"/>
    <SBMLMap SBMLid="Q" COPASIkey="ModelValue_12"/>
    <SBMLMap SBMLid="Tdam" COPASIkey="ModelValue_27"/>
    <SBMLMap SBMLid="cyt" COPASIkey="Compartment_0"/>
    <SBMLMap SBMLid="dd" COPASIkey="ModelValue_25"/>
    <SBMLMap SBMLid="heav_x" COPASIkey="ModelValue_29"/>
    <SBMLMap SBMLid="kd2" COPASIkey="ModelValue_6"/>
    <SBMLMap SBMLid="kd2_" COPASIkey="ModelValue_24"/>
    <SBMLMap SBMLid="kd2_0" COPASIkey="ModelValue_7"/>
    <SBMLMap SBMLid="kd53" COPASIkey="ModelValue_2"/>
    <SBMLMap SBMLid="kd53_" COPASIkey="ModelValue_22"/>
    <SBMLMap SBMLid="kd53_0" COPASIkey="ModelValue_11"/>
    <SBMLMap SBMLid="kin" COPASIkey="ModelValue_4"/>
    <SBMLMap SBMLid="kout" COPASIkey="ModelValue_5"/>
    <SBMLMap SBMLid="krepair" COPASIkey="ModelValue_15"/>
    <SBMLMap SBMLid="ks2" COPASIkey="ModelValue_8"/>
    <SBMLMap SBMLid="ks2_" COPASIkey="ModelValue_23"/>
    <SBMLMap SBMLid="ks53" COPASIkey="ModelValue_0"/>
    <SBMLMap SBMLid="ks53_" COPASIkey="ModelValue_21"/>
    <SBMLMap SBMLid="m" COPASIkey="ModelValue_10"/>
    <SBMLMap SBMLid="mdm2_production" COPASIkey="Function_41"/>
    <SBMLMap SBMLid="n" COPASIkey="ModelValue_3"/>
    <SBMLMap SBMLid="nuc" COPASIkey="Compartment_1"/>
    <SBMLMap SBMLid="p53" COPASIkey="Metabolite_0"/>
    <SBMLMap SBMLid="p53_degradation" COPASIkey="Reaction_1"/>
    <SBMLMap SBMLid="p53_production" COPASIkey="Reaction_0"/>
    <SBMLMap SBMLid="p53_production_0" COPASIkey="Function_40"/>
    <SBMLMap SBMLid="q" COPASIkey="ModelValue_19"/>
    <SBMLMap SBMLid="r" COPASIkey="ModelValue_17"/>
    <SBMLMap SBMLid="u" COPASIkey="ModelValue_16"/>
    <SBMLMap SBMLid="v" COPASIkey="ModelValue_18"/>
    <SBMLMap SBMLid="x" COPASIkey="ModelValue_30"/>
    <SBMLMap SBMLid="xyz" COPASIkey="ModelValue_26"/>
  </SBMLReference>
