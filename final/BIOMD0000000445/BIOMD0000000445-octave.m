...
%
% Model name = Pokhilko2013 - TOC1 signalling in Arabidopsis circadian clock
%
% is http://identifiers.org/biomodels.db/MODEL1209110002
% is http://identifiers.org/biomodels.db/BIOMD0000000445
% isDescribedBy http://identifiers.org/pubmed/23506153
...
%Initial conditions vector
	x0=zeros(32,1);
	x0(1) = 0.999999951844376;
	x0(2) = 0.999999951844376;
	x0(3) = 0.999999951844376;
	x0(4) = 0.999999951844376;
	x0(5) = 0.326899984257926;
	x0(6) = 0.256599987643267;
	x0(7) = 0.649999968698844;
	x0(8) = 0.15029999276221;
	x0(9) = 0.299099985596653;
	x0(10) = 0.0285999986227492;
	x0(11) = 0.206999990031786;
	x0(12) = 0.101199995126651;
	x0(13) = 0.0708999965857662;
	x0(14) = 0.00409999980256194;
	x0(15) = 0.0195999990561498;
	x0(16) = 0.101699995102573;
	x0(17) = 0.505999975633254;
	x0(18) = 0.575999972262361;
	x0(19) = 0.101199995126651;
	x0(20) = 1.01509995111723;
	x0(21) = 0.0787999962053368;
	x0(22) = 0.069699996643553;
	x0(23) = 0.0730999964798238;
	x0(24) = 0.955999953963223;
	x0(25) = 0.116699994380239;
	x0(26) = 0.401599980660701;
	x0(27) = 0.0237999988538961;
	x0(28) = 0.0657999968313599;
	x0(29) = 0.0434999979052303;
	x0(30) = 0.0976999952951955;
	x0(31) = 0.0754999963642504;
	x0(32) = 0.250499987937016;
...
% assignmentRule: variable = L
	global_par_L=global_par_lightOffset+0.5*global_par_lightAmplitude*(1+tanh(global_par_cyclePeriod*((time+global_par_phase)/global_par_cyclePeriod-floor(floor(time+global_par_phase)/global_par_cyclePeriod))/global_par_twilightPeriod))-0.5*global_par_lightAmplitude*(1+tanh((global_par_cyclePeriod*((time+global_par_phase)/global_par_cyclePeriod-floor(floor(time+global_par_phase)/global_par_cyclePeriod))-global_par_photoPeriod)/global_par_twilightPeriod))+0.5*global_par_lightAmplitude*(1+tanh((global_par_cyclePeriod*((time+global_par_phase)/global_par_cyclePeriod-floor(floor(time+global_par_phase)/global_par_cyclePeriod))-global_par_cyclePeriod)/global_par_twilightPeriod));
% assignmentRule: variable = D
	global_par_D=1-global_par_L;

% Reaction: id = cL_m_trscr, name = cL_m_trscr
	reaction_cL_m_trscr=compartment_def*function_4_cL_m_trscr(global_par_L, global_par_a, x(22), x(24), x(25), x(27), x(29), global_par_g1, global_par_n1, global_par_q1);
...
% Reaction: id = cP7_m_trscr, name = cP7_m_trscr
	reaction_cP7_m_trscr=compartment_def*function_4_cP7_m_trscr_1(x(17), x(21), x(27), x(29), compartment_def, global_par_e, global_par_f, global_par_g10, global_par_g11, global_par_n8, global_par_n9, global_par_parameter_6, global_par_parameter_7);
...
% Reaction: id = cT_m_trscr, name = cT_m_trscr
	reaction_cT_m_trscr=compartment_def*function_4_cT_m_trscr(x(13), x(17), compartment_def, global_par_e, global_par_g4, global_par_g5, global_par_n2, global_par_parameter_11, global_par_parameter_14, x(3));
...
function z=function_4_cL_m_trscr(L,a,cNI,cP,cP7,cP9,cT,g1,n1,q1), z=(L*q1*cP+n1*g1^a/((cP9+cP7+cNI+cT)^a+g1^a));end
...
function z=function_4_cP7_m_trscr_1(cL,cLm,cP9,cT,def,e,f,g10,g11,n8,n9,parameter_6,parameter_7), z=(parameter_6^parameter_7/(parameter_6^parameter_7+cT^parameter_7)*(n8*(cLm+cL)^e/((cLm+cL)^e+g10^e)+n9*cP9^f/(cP9^f+g11^f))/def);end
...
function z=function_4_cT_m_trscr(cEC,cL,def,e,g4,g5,n2,parameter_11,parameter_14,species_3), z=(n2/(1+(cL/(g5*(1+(species_3/parameter_14)^parameter_11)))^e)*g4/(cEC+g4)/def);end
