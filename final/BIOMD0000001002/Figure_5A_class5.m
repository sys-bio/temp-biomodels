...
%
% Model name = Strasen2018 – TGFβ SMAD Signalling Class 5
%
%
...
%Initial conditions vector
	x0=zeros(23,1);
	x0(1) = 43.0322317779353;
	x0(2) = 12.2483900146123;
	x0(3) = 26.7136238297454;
	x0(4) = 42.101174023717;
	x0(5) = 100.0;
	x0(6) = 0.0;
	x0(7) = 0.0;
	x0(8) = 0.0;
	...
	x0(10) = 0.0;
	x0(11) = 0.0;
	x0(12) = 349.010042545924;
	x0(13) = 270.374765181883;
	x0(14) = 0.0;
	x0(15) = 0.0;
	x0(16) = 0.0302530110695863;
	x0(17) = 0.196832614743574;
	x0(18) = 3.22452342477777;
	x0(19) = 0.0;
	x0(20) = 0.0;
	x0(21) = 0.0;
	x0(22) = 88.9884765796576;
	x0(23) = 44.5969227407424;
...
% Parameter:   id =  R1_total_C5, name = R1_total_C5
	global_par_R1_total_C5=69.7458556076807;
% Parameter:   id =  R2_total_C5, name = R2_total_C5
	global_par_R2_total_C5=54.3495640383293;
% Parameter:   id =  S2_export_from_nuc_C5, name = S2_export_from_nuc_C5
	global_par_S2_export_from_nuc_C5=3.7363363993623;
% Parameter:   id =  S2_import_to_nuc_C5, name = S2_import_to_nuc_C5
	global_par_S2_import_to_nuc_C5=0.476399803993742;
% Parameter:   id =  S2_total_C5, name = S2_total_C5
	global_par_S2_total_C5=437.998519125582;
% Parameter:   id =  S4_export_from_nuc_C5, name = S4_export_from_nuc_C5
	global_par_S4_export_from_nuc_C5=0.393125479133945;
% Parameter:   id =  S4_import_to_nuc_C5, name = S4_import_to_nuc_C5
	global_par_S4_import_to_nuc_C5=0.0328180446781866;
% Parameter:   id =  S4_total_C5, name = S4_total_C5
	global_par_S4_total_C5=314.971687922625;
...
% Parameter:   id =  index_active_Rec_internalize_C5, name = index_active_Rec_internalize_C5
	global_par_index_active_Rec_internalize_C5=0.605233070925726;
...
% Parameter:   id =  index_k_out_1_relative_speed_C5, name = index_k_out_1_relative_speed_C5
	global_par_index_k_out_1_relative_speed_C5=1.13328586042914;
% Parameter:   id =  index_k_out_2_relative_speed_C5, name = index_k_out_2_relative_speed_C5
	global_par_index_k_out_2_relative_speed_C5=0.289478285991122;
...
% Parameter:   id =  k_Dephos_C5, name = k_Dephos_C5
	global_par_k_Dephos_C5=0.195326548276397;
% Parameter:   id =  k_S7_protein_C5, name = k_S7_protein_C5
	global_par_k_S7_protein_C5=0.109145201434479;
% Parameter:   id =  k_disso_Active_Rec, name = k_disso_Active_Rec
	global_par_k_disso_Active_Rec=0.00103940411358367;
% Parameter:   id =  k_in_R1_C5, name = k_in_R1_C5
	global_par_k_in_R1_C5=0.122822733556779;
% Parameter:   id =  k_in_R2_C5, name = k_in_R2_C5
	global_par_k_in_R2_C5=0.690292883004163;
% Parameter:   id =  k_induced_S7_production_C5, name = k_induced_S7_production_C5
	global_par_k_induced_S7_production_C5=2.4999911030393;
...
% Parameter:   id =  mRNA_prod_C5, name = mRNA_prod_C5
	global_par_mRNA_prod_C5=0.00702084429115441;
...
% Reaction: id = reaction18, name = reaction18
	reaction_reaction18=compartment_cyt*global_par_k_in_R1_C5*x(1);

% Reaction: id = reaction19, name = reaction19
	reaction_reaction19=compartment_cyt*global_par_k_in_R2_C5*x(2);

% Reaction: id = reaction20, name = reaction20
	reaction_reaction20=compartment_cyt*Function_for_reaction20(x(3), global_par_index_k_out_1_relative_speed_C5, global_par_k_in_R1_C5);

% Reaction: id = reaction21, name = reaction21
	reaction_reaction21=compartment_cyt*Function_for_reaction21(x(4), global_par_index_k_out_2_relative_speed_C5, global_par_k_in_R2_C5);

% Reaction: id = reaction22, name = reaction22
	reaction_reaction22=compartment_cyt*Function_for_reaction22(x(8), global_par_index_active_Rec_internalize_C5, global_par_k_in_R1_C5);
...
% Reaction: id = reaction35, name = reaction35
	reaction_reaction35=Function_for_reaction35(x(12), global_par_S2_import_to_nuc_C5, compartment_cyt);

% Reaction: id = reaction36, name = reaction36
	reaction_reaction36=Function_for_reaction36(global_par_S2_export_from_nuc_C5, x(22), compartment_nuc);

% Reaction: id = reaction37, name = reaction37
	reaction_reaction37=Function_for_reaction37(x(13), global_par_S4_import_to_nuc_C5, compartment_cyt);

% Reaction: id = reaction38, name = reaction38
	reaction_reaction38=Function_for_reaction38(global_par_S4_export_from_nuc_C5, x(23), compartment_nuc);

% Reaction: id = reaction39, name = reaction39
	reaction_reaction39=Function_for_reaction39(global_par_S2_import_to_nuc_C5, compartment_cyt, x(11));

% Reaction: id = reaction40, name = reaction40
	reaction_reaction40=Function_for_reaction40(global_par_S2_export_from_nuc_C5, compartment_nuc, x(19));
...
% Reaction: id = reaction43, name = reaction43
	reaction_reaction43=compartment_nuc*global_par_k_Dephos_C5*x(19);

% Reaction: id = reaction44, name = reaction44
	reaction_reaction44=compartment_nuc*Function_for_reaction44(global_par_index_trimer_dephos, global_par_k_Dephos_C5, x(20));

% Reaction: id = reaction45, name = reaction45
	reaction_reaction45=compartment_cyt*Function_for_reaction45(global_par_S2_export_from_nuc_C5, global_par_S2_import_to_nuc_C5, global_par_S2_total_C5, global_par_kdeg_S2);

% Reaction: id = reaction46, name = reaction46
	reaction_reaction46=compartment_cyt*Function_for_reaction46(global_par_S4_export_from_nuc_C5, global_par_S4_import_to_nuc_C5, global_par_S4_total_C5, global_par_kdeg_S4);

% Reaction: id = reaction47, name = reaction47
	reaction_reaction47=compartment_cyt*Function_for_reaction47(global_par_R1_total_C5, global_par_index_k_out_1_relative_speed_C5, global_par_k_in_R1_C5, global_par_kdeg_R1);

% Reaction: id = reaction48, name = reaction48
	reaction_reaction48=compartment_cyt*Function_for_reaction48(global_par_R2_total_C5, global_par_index_k_out_2_relative_speed_C5, global_par_k_in_R2_C5, global_par_kdeg_R2);

% Reaction: id = reaction51, name = reaction51
	reaction_reaction51=compartment_nuc*Function_for_reaction51(global_par_K_mran, global_par_S7KD, global_par_hill_fact1, global_par_k_induced_S7_production_C5, global_par_mRNA_prod_C5, x(20));
...
% Reaction: id = reaction53, name = reaction53
	reaction_reaction53=compartment_cyt*Function_for_reaction53(x(16), global_par_k_S7_protein_C5);
...
function z=Function_for_reaction20(TGFb_R1_endo,index_k_out_1_relative_speed_C5,k_in_R1_C5), z=(TGFb_R1_endo*index_k_out_1_relative_speed_C5*k_in_R1_C5);end

function z=Function_for_reaction39(S2_import_to_nuc_C5,cyt,pS2_c), z=(cyt*S2_import_to_nuc_C5*pS2_c);end
...
function z=Function_for_reaction37(S4_c,S4_import_to_nuc_C5,cyt), z=(cyt*S4_c*S4_import_to_nuc_C5);end

function z=Function_for_reaction48(R2_total_C5,index_k_out_2_relative_speed_C5,k_in_R2_C5,kdeg_R2), z=(R2_total_C5*k_in_R2_C5*kdeg_R2^2/(k_in_R2_C5*kdeg_R2+kdeg_R2^2+index_k_out_2_relative_speed_C5*k_in_R2_C5*kdeg_R2));end

function z=Function_for_reaction38(S4_export_from_nuc_C5,S4_n,nuc), z=(nuc*S4_n*S4_export_from_nuc_C5);end

function z=Function_for_reaction44(index_trimer_dephos,k_Dephos_C5,pS2_pS2_S4_n), z=(index_trimer_dephos*k_Dephos_C5*pS2_pS2_S4_n);end

function z=Function_for_reaction46(S4_export_from_nuc_C5,S4_import_to_nuc_C5,S4_total_C5,kdeg_S4), z=(S4_total_C5*(S4_import_to_nuc_C5*kdeg_S4+S4_export_from_nuc_C5*kdeg_S4+kdeg_S4^2)/(2*S4_import_to_nuc_C5+S4_export_from_nuc_C5+kdeg_S4));end

function z=Function_for_reaction22(Active_Rec,index_active_Rec_internalize_C5,k_in_R1_C5), z=(Active_Rec*index_active_Rec_internalize_C5*k_in_R1_C5);end

function z=Function_for_reaction47(R1_total_C5,index_k_out_1_relative_speed_C5,k_in_R1_C5,kdeg_R1), z=(R1_total_C5*k_in_R1_C5*kdeg_R1^2/(k_in_R1_C5*kdeg_R1+kdeg_R1^2+index_k_out_1_relative_speed_C5*k_in_R1_C5*kdeg_R1));end

function z=Function_for_reaction36(S2_export_from_nuc_C5,S2_n,nuc), z=(nuc*S2_n*S2_export_from_nuc_C5);end

function z=Function_for_reaction45(S2_export_from_nuc_C5,S2_import_to_nuc_C5,S2_total_C5,kdeg_S2), z=(S2_total_C5*(S2_import_to_nuc_C5*kdeg_S2+S2_export_from_nuc_C5*kdeg_S2+kdeg_S2^2)/(2*S2_import_to_nuc_C5+S2_export_from_nuc_C5+kdeg_S2));end

function z=Function_for_reaction21(TGFb_R2_endo,index_k_out_2_relative_speed_C5,k_in_R2_C5), z=(TGFb_R2_endo*index_k_out_2_relative_speed_C5*k_in_R2_C5);end

function z=Function_for_reaction35(S2_c,S2_import_to_nuc_C5,cyt), z=(cyt*S2_c*S2_import_to_nuc_C5);end

function z=Function_for_reaction51(K_mran,S7KD,hill_fact1,k_induced_S7_production_C5,mRNA_prod_C5,pS2_pS2_S4_n), z=(S7KD*(mRNA_prod_C5+k_induced_S7_production_C5*pS2_pS2_S4_n^hill_fact1/(K_mran^hill_fact1+pS2_pS2_S4_n^hill_fact1)));end

function z=Function_for_reaction40(S2_export_from_nuc_C5,nuc,pS2_n), z=(nuc*S2_export_from_nuc_C5*pS2_n);end

function z=Function_for_reaction53(Smad7mRNA,k_S7_protein_C5), z=(Smad7mRNA*k_S7_protein_C5);end
