...
%
% Model name = Ratushny2012_ASSURE_II
%
% is http://identifiers.org/biomodels.db/MODEL1203010002
% is http://identifiers.org/biomodels.db/BIOMD0000000421
...
% assignmentRule: variable = dsp1p2kd
	global_par_dsp1p2kd=global_par_Kd/2*(1+(global_par_dsp1ksp+global_par_P2)/global_par_Kd-((1+(global_par_dsp1ksp+global_par_P2)/global_par_Kd)^2-4*global_par_dsp1ksp*global_par_P2/global_par_Kd^2)^0.5);
