...
%
% Model name = Bertram1995_PancreaticBetaCell_CRAC
%
% is http://identifiers.org/biomodels.db/MODEL1006230051
% is http://identifiers.org/biomodels.db/BIOMD0000000374
% isDescribedBy http://identifiers.org/pubmed/7647236
% isDerivedFrom http://identifiers.org/pubmed/3907728
%
...
% assignmentRule: variable = jm_infinity
	global_par_jm_infinity=1-1/(1+exp((53+x(1))/2));
% assignmentRule: variable = tau_j
	global_par_tau_j=50000/(exp((53+x(1))/4)+exp((-53-x(1))/4))+1500;
% assignmentRule: variable = i_K_Ca
	global_par_i_K_Ca=global_par_g_K_Ca*x(5)^5/(x(5)^5+global_par_kdkca^5)*(x(1)+70);
% assignmentRule: variable = r_infinity
	global_par_r_infinity=1/(1+exp(1*(x(4)-global_par_Ca_er_bar)));
...
% assignmentRule: variable = J_mem_tot
	global_par_J_mem_tot=(-global_par_f)*(global_par_gamma*global_par_i_Ca+global_par_k_Ca*x(5));
