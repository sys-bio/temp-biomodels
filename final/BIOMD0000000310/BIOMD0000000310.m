...
%
% is http://identifiers.org/biomodels.db/MODEL1102100002
% is http://identifiers.org/biomodels.db/BIOMD0000000310
...
% Reaction: id = r0
	reaction_r0=compartment_env*global_par_k0;

% Reaction: id = r1
	reaction_r1=compartment_env*global_par_k1*x(2);

% Reaction: id = r2
	reaction_r2=compartment_env*global_par_k2*x(1);

% Reaction: id = r2_prime
	reaction_r2_prime=compartment_env*global_par_k2_prime*x(1)*x(4);
