...
%
% Model name = Strasen2018 – TGFβ SMAD Signalling - Dose dependent dynamics upon TGFβ stimulation
%
%
...
% Parameter:   id =  TGFb_LIGAND_Dose, name = TGFb_LIGAND_Dose
	global_par_TGFb_LIGAND_Dose=1.0;
...
% Reaction: id = reaction20, name = reaction20
	reaction_reaction20=compartment_cyt*Function_for_reaction20_0(x(3), global_par_index_k_out_1_relative_speed, global_par_k_in_1);

% Reaction: id = reaction21, name = reaction21
	reaction_reaction21=compartment_cyt*Function_for_reaction21_0(x(4), global_par_index_k_out_2_relative_speed, global_par_k_in_2);

% Reaction: id = reaction22, name = reaction22
	reaction_reaction22=compartment_cyt*Function_for_reaction22_0(x(8), global_par_index_active_Rec_internalize, global_par_k_in_1);
...
% Reaction: id = reaction25, name = reaction25
	reaction_reaction25=compartment_cyt*Function_for_reaction25_0(x(9), x(12), global_par_k_phosphorylation);
...
% Reaction: id = reaction32, name = reaction32
	reaction_reaction32=compartment_nuc*Function_for_reaction32_0(global_par_index_kb_homotrimer, global_par_kb_trimmer, x(21));

% Reaction: id = reaction33, name = reaction33
	reaction_reaction33=compartment_cyt*Function_for_reaction33_0(global_par_index_kb_homotrimer, global_par_kb_trimmer, x(15));

% Reaction: id = reaction34, name = reaction34
	reaction_reaction34=Function_for_reaction34_0(x(12), global_par_S2_import_to_nuc, compartment_cyt);

% Reaction: id = reaction35, name = reaction35
	reaction_reaction35=Function_for_reaction35_0(global_par_S2_export_from_nuc, x(22), compartment_nuc);

% Reaction: id = reaction36, name = reaction36
	reaction_reaction36=Function_for_reaction36_0(x(13), global_par_S4_import_to_nuc, compartment_cyt);

% Reaction: id = reaction37, name = reaction37
	reaction_reaction37=Function_for_reaction37_0(global_par_S4_export_from_nuc, x(23), compartment_nuc);

% Reaction: id = reaction38, name = reaction38
	reaction_reaction38=Function_for_reaction38_0(global_par_S2_import_to_nuc, compartment_cyt, x(11));

% Reaction: id = reaction39, name = reaction39
	reaction_reaction39=Function_for_reaction39_0(global_par_S2_export_from_nuc, compartment_nuc, x(19));

% Reaction: id = reaction40, name = reaction40
	reaction_reaction40=Function_for_reaction40_0(global_par_Trimer_import_to_nuc, compartment_cyt, x(14));

% Reaction: id = reaction41, name = reaction41
	reaction_reaction41=Function_for_reaction41_0(global_par_Trimer_import_to_nuc, compartment_cyt, x(15));
...
% Reaction: id = reaction50, name = reaction50
	reaction_reaction50=compartment_nuc*Function_for_reaction50(global_par_K_mran, global_par_hill_fact1, global_par_k_induced_S7_production, global_par_mRNA_prod, x(20));

% Reaction: id = reaction51, name = reaction51
	reaction_reaction51=Function_for_reaction51_0(x(18), global_par_export_cytoplasm, compartment_nuc);

% Reaction: id = reaction52, name = reaction52
	reaction_reaction52=compartment_cyt*Function_for_reaction52_0(x(16), global_par_k_S7_protein);
...
function z=Function_for_reaction22_0(Active_Rec,index_active_Rec_internalize,k_in_1), z=(Active_Rec*index_active_Rec_internalize*k_in_1);end
...
function z=Function_for_reaction20_0(TGFb_R1_endo,index_k_out_1_relative_speed,k_in_1), z=(TGFb_R1_endo*index_k_out_1_relative_speed*k_in_1);end

function z=Function_for_reaction35_0(S2_export_from_nuc,S2_n,nuc), z=(nuc*S2_n*S2_export_from_nuc);end

function z=Function_for_reaction51_0(Smad7mRNA1,export_cytoplasm,nuc), z=(nuc*Smad7mRNA1*export_cytoplasm);end
...
function z=Function_for_reaction38_0(S2_import_to_nuc,cyt,pS2_c), z=(cyt*S2_import_to_nuc*pS2_c);end

function z=Function_for_reaction34_0(S2_c,S2_import_to_nuc,cyt), z=(cyt*S2_c*S2_import_to_nuc);end

function z=Function_for_reaction21_0(TGFb_R2_endo,index_k_out_2_relative_speed,k_in_2), z=(TGFb_R2_endo*index_k_out_2_relative_speed*k_in_2);end

function z=Function_for_reaction31_0(index_kf_homotrimer,kf_trimmer,pS2_n), z=(index_kf_homotrimer*kf_trimmer*pS2_n^3);end

function z=Function_for_reaction32_0(index_kb_homotrimer,kb_trimmer,pS2_pS2_pS2_n), z=(index_kb_homotrimer*kb_trimmer*pS2_pS2_pS2_n);end
...
function z=Function_for_reaction39_0(S2_export_from_nuc,nuc,pS2_n), z=(nuc*S2_export_from_nuc*pS2_n);end

function z=Function_for_reaction33_0(index_kb_homotrimer,kb_trimmer,pS2_pS2_pS2_c), z=(index_kb_homotrimer*kb_trimmer*pS2_pS2_pS2_c);end

function z=Function_for_reaction41_0(Trimer_import_to_nuc,cyt,pS2_pS2_pS2_c), z=(cyt*Trimer_import_to_nuc*pS2_pS2_pS2_c);end
...
function z=Function_for_reaction40_0(Trimer_import_to_nuc,cyt,pS2_pS2_S4_c), z=(cyt*Trimer_import_to_nuc*pS2_pS2_S4_c);end

function z=Function_for_reaction37_0(S4_export_from_nuc,S4_n,nuc), z=(nuc*S4_n*S4_export_from_nuc);end

function z=Function_for_reaction36_0(S4_c,S4_import_to_nuc,cyt), z=(cyt*S4_c*S4_import_to_nuc);end

function z=Function_for_reaction52_0(Smad7mRNA,k_S7_protein), z=(Smad7mRNA*k_S7_protein);end

function z=Function_for_reaction25_0(Active_Rec_endo,S2_c,k_phosphorylation), z=(Active_Rec_endo*S2_c*k_phosphorylation);end

function z=Function_for_reaction50(K_mran,hill_fact1,k_induced_S7_production,mRNA_prod,pS2_pS2_S4_n), z=(mRNA_prod+k_induced_S7_production*pS2_pS2_S4_n^hill_fact1/(K_mran^hill_fact1+pS2_pS2_S4_n^hill_fact1));end
