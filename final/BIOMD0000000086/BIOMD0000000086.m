...
%
% Model name = Bornheimer2004_GTPaseCycle
%
% is http://identifiers.org/biomodels.db/MODEL4822989369
% is http://identifiers.org/biomodels.db/BIOMD0000000086
% isDescribedBy http://identifiers.org/pubmed/15520372
%
...
% assignmentRule: variable = parameter_1
	global_par_parameter_1=(25*x(16)+25*x(12)+0.013*x(11)+0.013*x(6))/1E-8;

% Reaction: id = reaction_0, name = G protein binding GAP	% Local Parameter:   id =  k1, name = k1
	reaction_reaction_0_k1=8780000.0;
	% Local Parameter:   id =  k2, name = k2
	reaction_reaction_0_k2=8.0;

	reaction_reaction_0=compartment_compartment_0*(reaction_reaction_0_k1*x(2)*x(1)-reaction_reaction_0_k2*x(3));
...
% Reaction: id = reaction_2, name = G binding Receptor	% Local Parameter:   id =  k1, name = k1
	reaction_reaction_2_k1=6.36E8;
	% Local Parameter:   id =  k2, name = k2
	reaction_reaction_2_k2=0.0179;

	reaction_reaction_2=compartment_compartment_0*(reaction_reaction_2_k1*x(2)*x(5)-reaction_reaction_2_k2*x(10));
...
% Reaction: id = reaction_12, name = GA binding GTP	% Local Parameter:   id =  k1, name = k1
	reaction_reaction_12_k1=44700.0;
	% Local Parameter:   id =  k2, name = k2
	reaction_reaction_12_k2=8.32E-8;

	reaction_reaction_12=compartment_compartment_0*(reaction_reaction_12_k1*x(3)*x(4)-reaction_reaction_12_k2*x(12));
...
% Reaction: id = reaction_15, name = RG binding  GAP	% Local Parameter:   id =  k1, name = k1
	reaction_reaction_15_k1=74300.0;
	% Local Parameter:   id =  k2, name = k2
	reaction_reaction_15_k2=0.00572;

	reaction_reaction_15=compartment_compartment_0*(reaction_reaction_15_k1*x(10)*x(1)-reaction_reaction_15_k2*x(15));

% Reaction: id = reaction_16, name = GA binding Receptor	% Local Parameter:   id =  k1, name = k1
	reaction_reaction_16_k1=2.28E7;
	% Local Parameter:   id =  k2, name = k2
...
% Reaction: id = reaction_18, name = G*AT binding Receptor	% Local Parameter:   id =  k1, name = k1
	reaction_reaction_18_k1=6200000.0;
	% Local Parameter:   id =  k2, name = k2
	reaction_reaction_18_k2=0.0433;

	reaction_reaction_18=compartment_compartment_0*(reaction_reaction_18_k1*x(12)*x(5)-reaction_reaction_18_k2*x(16));
...
% Reaction: id = reaction_21, name = RGD binding GAP	% Local Parameter:   id =  k1, name = k1
	reaction_reaction_21_k1=13000.0;
	% Local Parameter:   id =  k2, name = k2
	reaction_reaction_21_k2=0.685;

	reaction_reaction_21=compartment_compartment_0*(reaction_reaction_21_k1*x(14)*x(1)-reaction_reaction_21_k2*x(17));

% Reaction: id = reaction_22, name = GAD binding Receptor	% Local Parameter:   id =  k1, name = k1
	reaction_reaction_22_k1=4.94E7;
	% Local Parameter:   id =  k2, name = k2
	reaction_reaction_22_k2=0.00421;

	reaction_reaction_22=compartment_compartment_0*(reaction_reaction_22_k1*x(13)*x(5)-reaction_reaction_22_k2*x(17));
...
% Species:   id = species_0, name = A, affected by kineticLaw
	xdot(1) = (1/(compartment_compartment_0))*((-1.0 * reaction_reaction_0) + (-1.0 * reaction_reaction_7) + (-1.0 * reaction_reaction_8) + (-1.0 * reaction_reaction_15) + (-1.0 * reaction_reaction_19) + (-1.0 * reaction_reaction_21));
	
% Species:   id = species_1, name = G, affected by kineticLaw
	xdot(2) = (1/(compartment_compartment_0))*((-1.0 * reaction_reaction_0) + (-1.0 * reaction_reaction_1) + (-1.0 * reaction_reaction_2) + ( 1.0 * reaction_reaction_4));
	
% Species:   id = species_2, name = GA, affected by kineticLaw
	xdot(3) = (1/(compartment_compartment_0))*(( 1.0 * reaction_reaction_0) + (-1.0 * reaction_reaction_12) + ( 1.0 * reaction_reaction_14) + (-1.0 * reaction_reaction_16));
	
% Species:   id = species_3, name = T, affected by kineticLaw
	xdot(4) = (1/(compartment_compartment_0))*((-1.0 * reaction_reaction_1) + (-1.0 * reaction_reaction_5) + (-1.0 * reaction_reaction_12) + (-1.0 * reaction_reaction_17));
	
% Species:   id = species_4, name = R, affected by kineticLaw
	xdot(5) = (1/(compartment_compartment_0))*((-1.0 * reaction_reaction_2) + (-1.0 * reaction_reaction_6) + (-1.0 * reaction_reaction_9) + (-1.0 * reaction_reaction_16) + (-1.0 * reaction_reaction_18) + (-1.0 * reaction_reaction_22));
...
% Species:   id = species_9, name = RG, affected by kineticLaw
	xdot(10) = (1/(compartment_compartment_0))*(( 1.0 * reaction_reaction_2) + (-1.0 * reaction_reaction_5) + ( 1.0 * reaction_reaction_11) + (-1.0 * reaction_reaction_15));
...
% Species:   id = species_11, name = G*AT, affected by kineticLaw
	xdot(12) = (1/(compartment_compartment_0))*(( 1.0 * reaction_reaction_7) + ( 1.0 * reaction_reaction_12) + (-1.0 * reaction_reaction_13) + (-1.0 * reaction_reaction_18));
	
% Species:   id = species_12, name = GAD, affected by kineticLaw
	xdot(13) = (1/(compartment_compartment_0))*(( 1.0 * reaction_reaction_8) + ( 1.0 * reaction_reaction_13) + (-1.0 * reaction_reaction_14) + (-1.0 * reaction_reaction_22));
	
% Species:   id = species_13, name = RGD, affected by kineticLaw
	xdot(14) = (1/(compartment_compartment_0))*(( 1.0 * reaction_reaction_9) + ( 1.0 * reaction_reaction_10) + (-1.0 * reaction_reaction_11) + (-1.0 * reaction_reaction_21));
	
% Species:   id = species_14, name = RGA, affected by kineticLaw
	xdot(15) = (1/(compartment_compartment_0))*(( 1.0 * reaction_reaction_15) + ( 1.0 * reaction_reaction_16) + (-1.0 * reaction_reaction_17) + ( 1.0 * reaction_reaction_23));
	
% Species:   id = species_15, name = RG*AT, affected by kineticLaw
	xdot(16) = (1/(compartment_compartment_0))*(( 1.0 * reaction_reaction_17) + ( 1.0 * reaction_reaction_18) + ( 1.0 * reaction_reaction_19) + (-1.0 * reaction_reaction_20));
	
% Species:   id = species_16, name = RGAD, affected by kineticLaw
	xdot(17) = (1/(compartment_compartment_0))*(( 1.0 * reaction_reaction_20) + ( 1.0 * reaction_reaction_21) + ( 1.0 * reaction_reaction_22) + (-1.0 * reaction_reaction_23));
end
