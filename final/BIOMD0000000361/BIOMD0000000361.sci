...
//x(4)   ID: VIIa_TF_Xa  initialValue: 0
	(1/compartment_compartment)*( (-1)*(1)* (compartment_compartment*((k1_reaction_3* x(4) )-(k2_reaction_3* x(5) * x(1) ))) + (1)*(1)* (compartment_compartment*k1_reaction_2* x(3) ) );
...
//x(6)   ID: TFPI  initialValue: 2.399999
	(1/compartment_compartment)*( (-1)*(1)* (compartment_compartment*((k1_reaction_4* x(5) * x(6) )-(k2_reaction_4* x(7) ))) );
	
//x(7)   ID: Xa_TFPI  initialValue: 0
	(1/compartment_compartment)*( (-1)*(1)* (compartment_compartment*((k1_reaction_5* x(1) * x(7) )-(k2_reaction_5* x(8) ))) + (1)*(1)* (compartment_compartment*((k1_reaction_4* x(5) * x(6) )-(k2_reaction_4* x(7) ))) );
	
//x(8)   ID: Xa_TFPI_VIIa_TF  initialValue: 0
	(1/compartment_compartment)*( (1)*(1)* (compartment_compartment*((k1_reaction_5* x(1) * x(7) )-(k2_reaction_5* x(8) ))) )
	];


	
endfunction
        x0=[0.9999997;169.9999;0;0;0;2.399999;0;0];
