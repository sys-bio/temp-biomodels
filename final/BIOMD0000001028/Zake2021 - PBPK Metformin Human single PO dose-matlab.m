...
%
% Model name = PBPK model of metformin in humans, single PO dose
%
%
...
% Parameter:   id =  Compartment_31, name = Initial for Adipose
	global_par_Compartment_31=15050.0;
% Parameter:   id =  Compartment_30, name = Initial for Brain
	global_par_Compartment_30=1400.0;
% Parameter:   id =  Compartment_36, name = Initial for Enterocytes
	global_par_Compartment_36=84.0;
% Parameter:   id =  Compartment_27, name = Initial for Feces
	global_par_Compartment_27=1000.0;
% Parameter:   id =  Compartment_28, name = Initial for Heart
	global_par_Compartment_28=350.0;
% Parameter:   id =  Compartment_21, name = Initial for IntestineLumen
	global_par_Compartment_21=500.0;
% Parameter:   id =  Compartment_38, name = Initial for IntestineVascular
	global_par_Compartment_38=630.0;
% Parameter:   id =  Compartment_23, name = Initial for KidneyPlasma
	global_par_Compartment_23=102.2;
% Parameter:   id =  Compartment_37, name = Initial for KidneyTissue
	global_par_Compartment_37=102.2;
% Parameter:   id =  Compartment_41, name = Initial for KidneyTubular
	global_par_Compartment_41=102.2;
% Parameter:   id =  Compartment_22, name = Initial for Liver
	global_par_Compartment_22=1799.0;
% Parameter:   id =  Compartment_33, name = Initial for Lung
	global_par_Compartment_33=532.0;
% Parameter:   id =  Compartment_29, name = Initial for Muscle
	global_par_Compartment_29=28000.0;
% Parameter:   id =  Compartment_32, name = Initial for PlasmaArterial
	global_par_Compartment_32=749.0;
% Parameter:   id =  Compartment_25, name = Initial for PlasmaVenous
	global_par_Compartment_25=2247.0;
% Parameter:   id =  Compartment_34, name = Initial for PortalVein
	global_par_Compartment_34=196.0;
% Parameter:   id =  Compartment_40, name = Initial for RBC
	global_par_Compartment_40=2198.0;
% Parameter:   id =  Compartment_24, name = Initial for Remainder
	global_par_Compartment_24=16310.0;
% Parameter:   id =  Compartment_39, name = Initial for StomachLumen
	global_par_Compartment_39=350.0;
% Parameter:   id =  Compartment_35, name = Initial for Stomach
	global_par_Compartment_35=147.0;
% Parameter:   id =  Compartment_26, name = Initial for Urine
	global_par_Compartment_26=1000.0;
% Parameter:   id =  ModelValue_63, name = Initial for Body Weight
	global_par_ModelValue_63=70000.0;
% Parameter:   id =  ModelValue_64, name = Initial for Cardiac Output
	global_par_ModelValue_64=312000.0;
% Parameter:   id =  ModelValue_117, name = Initial for Intestine Coefficient
	global_par_ModelValue_117=0.7;
% Parameter:   id =  ModelValue_123, name = Initial for IntestineSurffaceCoefficient
	global_par_ModelValue_123=2187.5;
% Parameter:   id =  ModelValue_118, name = Initial for Kidney Coefficient
	global_par_ModelValue_118=320.0;
% Parameter:   id =  ModelValue_61, name = Initial for Metformin Dose in Lumen in mg
	global_par_ModelValue_61=389.92;
% Parameter:   id =  ModelValue_98, name = Initial for QIntestineVascular
	global_par_ModelValue_98=33072.0;
% Parameter:   id =  ModelValue_95, name = Initial for QLiverArtery
	global_par_ModelValue_95=14352.0;
% Parameter:   id =  ModelValue_108, name = Initial for QPortalVeinOut
	global_par_ModelValue_108=56472.0;
% Parameter:   id =  ModelValue_97, name = Initial for QPortalVein
	global_par_ModelValue_97=19968.0;
% Parameter:   id =  ModelValue_96, name = Initial for QStomach
	global_par_ModelValue_96=3432.0;
% assignmentRule: variable = Stomach
	compartment_Stomach=global_par_ModelValue_63*0.0021;
% assignmentRule: variable = Liver
	compartment_Liver=global_par_ModelValue_63*0.0257;
% assignmentRule: variable = PlasmaVenous
	compartment_PlasmaVenous=global_par_ModelValue_63*0.0321;
% assignmentRule: variable = QAdipose
	global_par_QAdipose=global_par_ModelValue_64*0.052;
% assignmentRule: variable = QKidney
	global_par_QKidney=global_par_ModelValue_64*0.175;
% assignmentRule: variable = QMuscle
	global_par_QMuscle=global_par_ModelValue_64*0.191;
% assignmentRule: variable = QRemainder
	global_par_QRemainder=global_par_ModelValue_64*0.201;
% assignmentRule: variable = mgLiver
	global_par_mgLiver=129.16*x(1)/compartment_Liver*global_par_Compartment_22/1000000;
% assignmentRule: variable = mgIntestineLumen
	global_par_mgIntestineLumen=129.16*x(11)/compartment_IntestineLumen*global_par_Compartment_21/1000000;
% assignmentRule: variable = QLiverArtery
	global_par_QLiverArtery=global_par_ModelValue_64*0.046;
% assignmentRule: variable = QStomach
	global_par_QStomach=global_par_ModelValue_64*0.011;
% assignmentRule: variable = QPortalVein
	global_par_QPortalVein=global_par_ModelValue_64*0.064;
% assignmentRule: variable = QIntestineVascular
	global_par_QIntestineVascular=global_par_ModelValue_64*0.106;
% assignmentRule: variable = KidneyPlasma
	compartment_KidneyPlasma=global_par_ModelValue_63*0.00146;
% assignmentRule: variable = mgKidneyPlasma
	global_par_mgKidneyPlasma=129.16*x(2)/compartment_KidneyPlasma*global_par_Compartment_23/1000000;
% assignmentRule: variable = Remainder
	compartment_Remainder=global_par_ModelValue_63*0.233;
% assignmentRule: variable = Heart
	compartment_Heart=global_par_ModelValue_63*0.005;
% assignmentRule: variable = mgHeart
	global_par_mgHeart=129.16*x(5)/compartment_Heart*global_par_Compartment_28/1000000;
...
% assignmentRule: variable = _03_4__IntestineLumen____IntestineVascular__Saturable
	global_par__03_4__IntestineLumen____IntestineVascular__Saturable=global_par_ModelValue_117*global_par_ModelValue_123*19.2;
% assignmentRule: variable = _03_6__IntestineLumen____Enterocytes__Diffusion__Coefficient
	global_par__03_6__IntestineLumen____Enterocytes__Diffusion__Coefficient=global_par_ModelValue_117*global_par_ModelValue_123*0.14;
% assignmentRule: variable = _13_5__KidneyTissue____KidneyTubular
	global_par__13_5__KidneyTissue____KidneyTubular=global_par_ModelValue_118*3000;
...
% assignmentRule: variable = _13_4__KidneyPlasma____KidneyTissue
	global_par__13_4__KidneyPlasma____KidneyTissue=global_par_ModelValue_118*87339;
% assignmentRule: variable = QPortalVeinOut
	global_par_QPortalVeinOut=global_par_ModelValue_96+global_par_ModelValue_97+global_par_ModelValue_98;
% assignmentRule: variable = QLiverOut
	global_par_QLiverOut=global_par_ModelValue_108+global_par_ModelValue_95;
% assignmentRule: variable = mgStomachLumen
	global_par_mgStomachLumen=129.16*x(19)/compartment_StomachLumen*global_par_Compartment_39/1000000;
% assignmentRule: variable = mgVenousPlasma
	global_par_mgVenousPlasma=129.16*x(4)/compartment_PlasmaVenous*global_par_Compartment_25/1000000;
% assignmentRule: variable = mgStomach
	global_par_mgStomach=129.16*x(15)/compartment_Stomach*global_par_Compartment_35/1000000;
% assignmentRule: variable = _03_7__IntestineLumen____IntestineVascular__Diffusion__Coefficient
	global_par__03_7__IntestineLumen____IntestineVascular__Diffusion__Coefficient=global_par_ModelValue_117*global_par_ModelValue_123*0.26;
% assignmentRule: variable = mgUrineSum
	global_par_mgUrineSum=129.16*x(10)/compartment_Urine*global_par_Compartment_26/1000000;
% assignmentRule: variable = mgFeces
	global_par_mgFeces=129.16*x(9)/compartment_Feces*global_par_Compartment_27/1000000;
% assignmentRule: variable = Muscle
	compartment_Muscle=global_par_ModelValue_63*0.4;
% assignmentRule: variable = mgMuscle
	global_par_mgMuscle=129.16*x(6)/compartment_Muscle*global_par_Compartment_29/1000000;
% assignmentRule: variable = Brain
	compartment_Brain=global_par_ModelValue_63*0.02;
% assignmentRule: variable = mgBrain
	global_par_mgBrain=129.16*x(8)/compartment_Brain*global_par_Compartment_30/1000000;
% assignmentRule: variable = Adipose
	compartment_Adipose=global_par_ModelValue_63*0.215;
% assignmentRule: variable = mgAdipose
	global_par_mgAdipose=129.16*x(7)/compartment_Adipose*global_par_Compartment_31/1000000;
% assignmentRule: variable = PlasmaArterial
	compartment_PlasmaArterial=global_par_ModelValue_63*0.0107;
% assignmentRule: variable = mgArterialPlasma
	global_par_mgArterialPlasma=129.16*x(12)/compartment_PlasmaArterial*global_par_Compartment_32/1000000;
% assignmentRule: variable = Lung
	compartment_Lung=global_par_ModelValue_63*0.0076;
% assignmentRule: variable = mgLung
	global_par_mgLung=129.16*x(13)/compartment_Lung*global_par_Compartment_33/1000000;
% assignmentRule: variable = PortalVein
	compartment_PortalVein=global_par_ModelValue_63*0.0028;
% assignmentRule: variable = mgPortalVein
	global_par_mgPortalVein=129.16*x(14)/compartment_PortalVein*global_par_Compartment_34/1000000;
% assignmentRule: variable = Enterocytes
	compartment_Enterocytes=global_par_ModelValue_63*0.0012;
% assignmentRule: variable = mgEnterocytes
	global_par_mgEnterocytes=129.16*x(16)/compartment_Enterocytes*global_par_Compartment_36/1000000;
% assignmentRule: variable = KidneyTissue
	compartment_KidneyTissue=global_par_ModelValue_63*0.00146;
% assignmentRule: variable = mgKidneyTissues
	global_par_mgKidneyTissues=129.16*global_par_Compartment_37*x(17)/compartment_KidneyTissue/1000000;
% assignmentRule: variable = IntestineVascular
	compartment_IntestineVascular=global_par_ModelValue_63*0.009;
% assignmentRule: variable = mIntestineTotal
	global_par_mIntestineTotal=(x(16)/compartment_Enterocytes*global_par_Compartment_36+global_par_Compartment_38*x(18)/compartment_IntestineVascular)/(global_par_Compartment_36+global_par_Compartment_38);
% assignmentRule: variable = RBC
	compartment_RBC=global_par_ModelValue_63*0.0314;
% assignmentRule: variable = mgRBC
	global_par_mgRBC=129.16*x(20)/compartment_RBC*global_par_Compartment_40/1000000;
% assignmentRule: variable = KidneyTubular
	compartment_KidneyTubular=global_par_ModelValue_63*0.00146;
% assignmentRule: variable = mgKidneyTubular
	global_par_mgKidneyTubular=129.16*global_par_Compartment_41*x(21)/compartment_KidneyTubular/1000000;
...
% assignmentRule: variable = mKidneyTotal
	global_par_mKidneyTotal=(global_par_Compartment_23*x(2)/compartment_KidneyPlasma+global_par_Compartment_37*x(17)/compartment_KidneyTissue+global_par_Compartment_41*x(21)/compartment_KidneyTubular)/(global_par_Compartment_23+global_par_Compartment_37+global_par_Compartment_41);
% assignmentRule: variable = QBrain
	global_par_QBrain=global_par_ModelValue_64*0.114;
% assignmentRule: variable = QHeart
	global_par_QHeart=global_par_ModelValue_64*0.04;
% assignmentRule: variable = mgRemainder
	global_par_mgRemainder=129.16*x(3)/compartment_Remainder*global_par_Compartment_24/1000000;
% assignmentRule: variable = mgIntestineVascular
	global_par_mgIntestineVascular=129.16*x(18)/compartment_IntestineVascular*global_par_Compartment_38/1000000;
...
% assignmentRule: variable = _03_2__IntestineLumen____Enterocytes__PMAT_OCT3__Vf
	global_par__03_2__IntestineLumen____Enterocytes__PMAT_OCT3__Vf=global_par_ModelValue_117*global_par_ModelValue_123*1271;
% assignmentRule: variable = _03_3__Enterocytes____IntestineVascular__OCT1__Vmax
	global_par__03_3__Enterocytes____IntestineVascular__OCT1__Vmax=global_par_ModelValue_117*global_par_ModelValue_123*495;
...
%Event: id=Dose_0_001h
	...
	if(event_Dose_0_001h) 
		x(19)=(1000000*global_par_ModelValue_61/(129.16*global_par_Compartment_39)+x(19)/compartment_StomachLumen)*compartment_StomachLumen;
	end
