...
%
% Model name = Conant2007_glycolysis_2C
%
% is http://identifiers.org/biomodels.db/MODEL2427135959
% is http://identifiers.org/biomodels.db/BIOMD0000000177
...
% Parameter:   id =  t_m, name = toggle_transport
	global_par_t_m=1.0;
% Parameter:   id =  WGD_E, name = WGD enzyme conc change
	global_par_WGD_E=0.65;
...
% Reaction: id = HXT, name = HXT	% Local Parameter:   id =  Vmax_1, name = Vmax_1
	...
	reaction_HXT=reaction_HXT_Vmax_1*global_par_WGD_E*(x(20)-x(1))/reaction_HXT_Kglc_1/(1+(x(20)+x(1))/reaction_HXT_Kglc_1+reaction_HXT_Ki_1*x(20)*x(1)/reaction_HXT_Kglc_1^2);
...
% Reaction: id = HXK, name = HXK	% Local Parameter:   id =  Vmax_2, name = Vmax_2
	...
	reaction_HXK=compartment_cyto*global_par_WGD_E*reaction_HXK_Vmax_2*(x(1)*x(2)/(reaction_HXK_Kglc_2*reaction_HXK_Katp_2)-x(3)*x(4)/(reaction_HXK_Kglc_2*reaction_HXK_Katp_2*reaction_HXK_Keq_2))/((1+x(1)/reaction_HXK_Kglc_2+x(3)/reaction_HXK_Kg6p_2)*(1+x(2)/reaction_HXK_Katp_2+x(4)/reaction_HXK_Kadp_2));
...
% Reaction: id = PGI, name = PGI	% Local Parameter:   id =  Vmax_3, name = Vmax_3
	...
	reaction_PGI=compartment_cyto*reaction_PGI_Vmax_3*global_par_WGD_E*(x(3)/reaction_PGI_Kg6p_3-x(5)/(reaction_PGI_Kg6p_3*reaction_PGI_Keq_3))/(1+x(3)/reaction_PGI_Kg6p_3+x(5)/reaction_PGI_Kf6p_3);
...
% Reaction: id = PFK, name = PFK	% Local Parameter:   id =  Vmax_4, name = Vmax_4
	...
	reaction_PFK=compartment_cyto*reaction_PFK_Vmax_4*global_par_WGD_E*reaction_PFK_gR_4*x(5)/reaction_PFK_Kf6p_4*x(2)/reaction_PFK_Katp_4*(1+x(5)/reaction_PFK_Kf6p_4+x(2)/reaction_PFK_Katp_4+reaction_PFK_gR_4*x(5)/reaction_PFK_Kf6p_4*x(2)/reaction_PFK_Katp_4)/((1+x(5)/reaction_PFK_Kf6p_4+x(2)/reaction_PFK_Katp_4+reaction_PFK_gR_4*x(5)/reaction_PFK_Kf6p_4*x(2)/reaction_PFK_Katp_4)^2+reaction_PFK_L0_4*((1+reaction_PFK_Ciatp_4*x(2)/reaction_PFK_Kiatp_4)/(1+x(2)/reaction_PFK_Kiatp_4))^2*((1+reaction_PFK_Camp_4*x(8)/reaction_PFK_Kamp_4)/(1+x(8)/reaction_PFK_Kamp_4))^2*((1+reaction_PFK_Cf26_4*x(7)/reaction_PFK_Kf26_4+reaction_PFK_Cf16_4*x(6)/reaction_PFK_Kf16_4)/(1+x(7)/reaction_PFK_Kf26_4+x(6)/reaction_PFK_Kf16_4))^2*(1+reaction_PFK_Catp_4*x(2)/reaction_PFK_Katp_4)^2);
...
% Reaction: id = TDH, name = TDH	% Local Parameter:   id =  C_7, name = C_7
	...
	reaction_TDH=compartment_cyto*reaction_TDH_C_7*(reaction_TDH_Vmaxf_7*global_par_WGD_E*x(10)*x(11)/(reaction_TDH_Kgap_7*reaction_TDH_Knad_7)-reaction_TDH_Vmaxr_7*global_par_WGD_E*x(12)*x(13)/(reaction_TDH_Kbpg_7*reaction_TDH_Knadh_7))/((1+x(10)/reaction_TDH_Kgap_7+x(12)/reaction_TDH_Kbpg_7)*(1+x(11)/reaction_TDH_Knad_7+x(13)/reaction_TDH_Knadh_7));
...
% Reaction: id = PGK, name = PGK	% Local Parameter:   id =  Vmax_8, name = Vmax_8
	...
	reaction_PGK=compartment_cyto*reaction_PGK_Vmax_8*global_par_WGD_E*(reaction_PGK_Keq_8*x(12)*x(4)-x(14)*x(2))/(reaction_PGK_Kp3g_8*reaction_PGK_Katp_8)/((1+x(12)/reaction_PGK_Kbpg_8+x(14)/reaction_PGK_Kp3g_8)*(1+x(4)/reaction_PGK_Kadp_8+x(2)/reaction_PGK_Katp_8));

% Reaction: id = PGM, name = PGM	% Local Parameter:   id =  Vmax_9, name = Vmax_9
	...
	reaction_PGM=compartment_cyto*reaction_PGM_Vmax_9*global_par_WGD_E*(x(14)/reaction_PGM_Kp3g_9-x(15)/(reaction_PGM_Kp3g_9*reaction_PGM_Keq_9))/(1+x(14)/reaction_PGM_Kp3g_9+x(15)/reaction_PGM_Kp2g_9);
...
% Reaction: id = ENO, name = ENO	% Local Parameter:   id =  Vmax_10, name = Vmax_10
	...
	reaction_ENO=compartment_cyto*reaction_ENO_Vmax_10*global_par_WGD_E*(x(15)/reaction_ENO_Kp2g_10-x(16)/(reaction_ENO_Kp2g_10*reaction_ENO_Keq_10))/(1+x(15)/reaction_ENO_Kp2g_10+x(16)/reaction_ENO_Kpep_10);
...
% Reaction: id = PYK, name = PYK	% Local Parameter:   id =  Vmax_11, name = Vmax_11
	...
	reaction_PYK=compartment_cyto*reaction_PYK_Vmax_11*global_par_WGD_E*(x(16)*x(4)/(reaction_PYK_Kpep_11*reaction_PYK_Kadp_11)-x(17)*x(2)/(reaction_PYK_Kpep_11*reaction_PYK_Kadp_11*reaction_PYK_Keq_11))/((1+x(16)/reaction_PYK_Kpep_11+x(17)/reaction_PYK_Kpyr_11)*(1+x(4)/reaction_PYK_Kadp_11+x(2)/reaction_PYK_Katp_11));
...
% Reaction: id = ADH, name = ADH	% Local Parameter:   id =  Vmax_13, name = Vmax_13
	...
	reaction_ADH=compartment_cyto*reaction_ADH_Vmax_13*global_par_WGD_E*(x(22)*x(11)/(reaction_ADH_Ketoh_13*reaction_ADH_Kinad_13)-x(19)*x(13)/(reaction_ADH_Ketoh_13*reaction_ADH_Kinad_13*reaction_ADH_Keq_13))/(1+x(11)/reaction_ADH_Kinad_13+x(22)*reaction_ADH_Knad_13/(reaction_ADH_Kinad_13*reaction_ADH_Ketoh_13)+x(19)*reaction_ADH_Knadh_13/(reaction_ADH_Kinadh_13*reaction_ADH_Kacald_13)+x(13)/reaction_ADH_Kinadh_13+x(22)*x(11)/(reaction_ADH_Kinad_13*reaction_ADH_Ketoh_13)+x(11)*x(19)*reaction_ADH_Knadh_13/(reaction_ADH_Kinad_13*reaction_ADH_Kinadh_13*reaction_ADH_Kacald_13)+x(22)*x(13)*reaction_ADH_Knad_13/(reaction_ADH_Kinad_13*reaction_ADH_Kinadh_13*reaction_ADH_Ketoh_13)+x(19)*x(13)/(reaction_ADH_Kacald_13*reaction_ADH_Kinadh_13)+x(22)*x(11)*x(19)/(reaction_ADH_Kinad_13*reaction_ADH_Kiacald_13*reaction_ADH_Ketoh_13)+x(22)*x(19)*x(13)/(reaction_ADH_Kietoh_13*reaction_ADH_Kinadh_13*reaction_ADH_Kacald_13));
...
% Reaction: id = AK, name = adenylate_kinase	% Local Parameter:   id =  k1_15, name = k1_15
...
% Reaction: id = G3PDH, name = glycerol-3-phosphate_dehydrogenase	% Local Parameter:   id =  Vmax_16, name = Vmax_16
...
% Reaction: id = succinate_syn, name = succinate_synthesis	% Local Parameter:   id =  k_19, name = k_19
	...
	reaction_succinate_syn=compartment_cyto*reaction_succinate_syn_k_19*x(19);

% Reaction: id = PYR_shut, name = pyruvate_shuttling	% Local Parameter:   id =  k1, name = k1
	reaction_PYR_shut_k1=1.0;
	% Local Parameter:   id =  k2, name = k2
	reaction_PYR_shut_k2=1.0;

	reaction_PYR_shut=global_par_t_m*(reaction_PYR_shut_k1*x(17)-reaction_PYR_shut_k2*x(18));

% Reaction: id = PDH, name = pyruvate dehydrogenase	% Local Parameter:   id =  Vmax_PDH, name = Vmax_PDH
	reaction_PDH_Vmax_PDH=379.2;
	% Local Parameter:   id =  NADX_tot, name = tot_NAD_in_mito
	reaction_PDH_NADX_tot=8.01;
	% Local Parameter:   id =  K_PYR, name = K_PYR
	reaction_PDH_K_PYR=70.0;
	% Local Parameter:   id =  K_NAD, name = K_NAD
	reaction_PDH_K_NAD=160.0;
	% Local Parameter:   id =  Ki_NADH, name = Ki_NADH
	reaction_PDH_Ki_NADH=50.0;
	% Local Parameter:   id =  Ki_PYR, name = Ki_PYR
	reaction_PDH_Ki_PYR=20.0;

	reaction_PDH=compartment_mito*global_par_WGD_E*reaction_PDH_Vmax_PDH*x(18)*(reaction_PDH_NADX_tot-reaction_PDH_NADX_tot/(1+x(11)/x(13)))/(reaction_PDH_NADX_tot*reaction_PDH_Ki_PYR*reaction_PDH_K_NAD/reaction_PDH_Ki_NADH/(1+x(11)/x(13))+reaction_PDH_K_PYR*(reaction_PDH_NADX_tot-reaction_PDH_NADX_tot/(1+x(11)/x(13)))+reaction_PDH_K_NAD*x(18)+reaction_PDH_NADX_tot*reaction_PDH_K_NAD/reaction_PDH_Ki_NADH*x(18)/(1+x(11)/x(13))+(reaction_PDH_NADX_tot-reaction_PDH_NADX_tot/(1+x(11)/x(13)))*x(18));
...
% Species:   id = P2G, name = P2G, affected by kineticLaw
	xdot(15) = (1/(compartment_cyto))*(( 1.0 * reaction_PGM) + (-1.0 * reaction_ENO));
...
% Species:   id = PYR, name = PYR, affected by kineticLaw
	xdot(17) = (1/(compartment_cyto))*(( 1.0 * reaction_PYK) + (-1.0 * reaction_PDC) + (-1.0 * reaction_PYR_shut));
	
% Species:   id = PYRmito, name = PYRmito, affected by kineticLaw
	xdot(18) = (1/(compartment_mito))*(( 1.0 * reaction_PYR_shut) + (-1.0 * reaction_PDH));
	
% Species:   id = AcAld, name = AcAld, affected by kineticLaw
	xdot(19) = (1/(compartment_cyto))*(( 1.0 * reaction_PDC) + ( 1.0 * reaction_ADH) + (-2.0 * reaction_succinate_syn));
...
% Species:   id = AcCoA, name = AcCoA
%WARNING speciesID: AcCoA, constant= false  , boundaryCondition = true but is not involved in assignmentRule, rateRule or events !
	xdot(27) = 0.0;
	
% Species:   id = CO2mito, name = CO2mito
%WARNING speciesID: CO2mito, constant= false  , boundaryCondition = true but is not involved in assignmentRule, rateRule or events !
	xdot(28) = 0.0;
end
