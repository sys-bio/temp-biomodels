...
%
% Model name = Markevich2004 - MAPK double phosphorylation,  ordered Michaelis-Menton
%
% is http://identifiers.org/biomodels.db/MODEL6618496308
% is http://identifiers.org/biomodels.db/BIOMD0000000027
...
% Reaction: id = v1, name = phosphorylation of MAPK
	reaction_v1=compartment_uVol*global_par_k1cat*const_species_MAPKK*x(1)/global_par_Km1/(1+x(1)/global_par_Km1+x(2)/global_par_Km2);

% Reaction: id = v2, name = phosphorylation of P-MAPK
	reaction_v2=compartment_uVol*global_par_k2cat*const_species_MAPKK*x(2)/global_par_Km2/(1+x(1)/global_par_Km1+x(2)/global_par_Km2);
...
% Species:   id = MAPKK, name = MAPKK, constant	const_species_MAPKK=50.0;
