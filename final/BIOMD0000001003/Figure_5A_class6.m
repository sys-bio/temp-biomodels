...
%
% Model name = Strasen2018 – TGFβ SMAD Signalling Class 6
%
%
...
%Initial conditions vector
	x0=zeros(23,1);
	x0(1) = 23.9916047141008;
	x0(2) = 7.4593274395769;
	x0(3) = 18.6291708204655;
	x0(4) = 45.26154293223;
	x0(5) = 100.0;
	x0(6) = 0.0;
	x0(7) = 0.0;
	...
	x0(10) = 0.0;
	x0(11) = 0.0;
	x0(12) = 1057.97772977322;
	x0(13) = 424.727670880662;
	x0(14) = 0.0;
	x0(15) = 0.0;
	x0(16) = 0.0392904716849032;
	x0(17) = 0.255632282633267;
	x0(18) = 12.1576492873177;
	x0(19) = 0.0;
	x0(20) = 0.0;
	x0(21) = 0.0;
	x0(22) = 437.496760721504;
	x0(23) = 40.1379080014296;
...
% Parameter:   id =  R1_total_C6, name = R1_total_C6
	global_par_R1_total_C6=42.6207755345663;
% Parameter:   id =  R2_total_C6, name = R2_total_C6
	global_par_R2_total_C6=52.7208703718069;
% Parameter:   id =  S2_export_from_nuc_C6, name = S2_export_from_nuc_C6
	global_par_S2_export_from_nuc_C6=1.98293001092015;
% Parameter:   id =  S2_import_to_nuc_C6, name = S2_import_to_nuc_C6
	global_par_S2_import_to_nuc_C6=0.410098597628844;
% Parameter:   id =  S2_total_C6, name = S2_total_C6
	global_par_S2_total_C6=1495.47449049472;
% Parameter:   id =  S4_export_from_nuc_C6, name = S4_export_from_nuc_C6
	global_par_S4_export_from_nuc_C6=0.390971136785711;
% Parameter:   id =  S4_import_to_nuc_C6, name = S4_import_to_nuc_C6
	global_par_S4_import_to_nuc_C6=0.0187008145763973;
% Parameter:   id =  S4_total_C6, name = S4_total_C6
	global_par_S4_total_C6=464.865578882092;
...
% Parameter:   id =  index_active_Rec_internalize_C6, name = index_active_Rec_internalize_C6
	global_par_index_active_Rec_internalize_C6=1.07550281585544;
...
% Parameter:   id =  index_k_out_1_relative_speed_C6, name = index_k_out_1_relative_speed_C6
	global_par_index_k_out_1_relative_speed_C6=1.12131456860324;
% Parameter:   id =  index_k_out_2_relative_speed_C6, name = index_k_out_2_relative_speed_C6
	global_par_index_k_out_2_relative_speed_C6=0.164002847372207;
...
% Parameter:   id =  k_Dephos_C6, name = k_Dephos_C6
	global_par_k_Dephos_C6=0.130105061976245;
% Parameter:   id =  k_S7_protein_C6, name = k_S7_protein_C6
	global_par_k_S7_protein_C6=0.316861946141984;
% Parameter:   id =  k_disso_Active_Rec, name = k_disso_Active_Rec
	global_par_k_disso_Active_Rec=0.00103940411358367;
% Parameter:   id =  k_in_R1_C6, name = k_in_R1_C6
	global_par_k_in_R1_C6=0.352224972224716;
% Parameter:   id =  k_in_R2_C6, name = k_in_R2_C6
	global_par_k_in_R2_C6=1.24717567326884;
% Parameter:   id =  k_induced_S7_production_C6, name = k_induced_S7_production_C6
	global_par_k_induced_S7_production_C6=7.76909435020809;
...
% Parameter:   id =  mRNA_prod_C6, name = mRNA_prod_C6
	global_par_mRNA_prod_C6=0.00911817614422632;
...
% Reaction: id = reaction1, name = reaction1
	reaction_reaction1=compartment_cyt*Function_for_reaction1_0(x(5), x(2), global_par_k_medium, global_par_kf_R2_activation);

% Reaction: id = reaction2, name = reaction2
	reaction_reaction2=compartment_cyt*Function_for_reaction2_0(x(5), x(2), global_par_kf_R2_activation);

% Reaction: id = reaction3, name = reaction3
	reaction_reaction3=compartment_cyt*Function_for_reaction3_0(x(5), x(2), global_par_kf_R2_activation);

% Reaction: id = reaction4, name = reaction4
	reaction_reaction4=compartment_cyt*Function_for_reaction4_0(x(7), global_par_index_kb_R2, global_par_kf_R2_activation);

% Reaction: id = reaction5, name = reaction5
	reaction_reaction5=compartment_cyt*Function_for_reaction5_0(x(7), global_par_index_kb_R2, global_par_kf_R2_activation);

% Reaction: id = reaction6, name = reaction6
	reaction_reaction6=compartment_cyt*Function_for_reaction6_0(x(7), global_par_index_kb_R2, global_par_k_medium, global_par_kf_R2_activation);
...
% Reaction: id = reaction8, name = reaction8
	reaction_reaction8=compartment_cyt*Function_for_reaction8_0(x(8), global_par_index_kb_R1, global_par_kf_R1_activation);
...
% Reaction: id = reaction15, name = reaction15
	reaction_reaction15=compartment_cyt*Function_for_reaction15_0(x(10), global_par_index_seq_kb, global_par_kf_Seq_S7_Rec);

% Reaction: id = reaction16, name = reaction16
	reaction_reaction16=compartment_cyt*Function_for_reaction16_0(x(10), global_par_index_induced_ligand_deg, global_par_kin_deg_Ligand);

% Reaction: id = reaction17, name = reaction17
	reaction_reaction17=compartment_cyt*Function_for_reaction17_0(x(10), global_par_index_induced_R2_deg, global_par_kdeg_R2);

% Reaction: id = reaction18, name = reaction18
	reaction_reaction18=compartment_cyt*global_par_k_in_R1_C6*x(1);

% Reaction: id = reaction19, name = reaction19
	reaction_reaction19=compartment_cyt*global_par_k_in_R2_C6*x(2);

% Reaction: id = reaction20, name = reaction20
	reaction_reaction20=compartment_cyt*Function_for_reaction20_4_0(x(3), global_par_index_k_out_1_relative_speed_C6, global_par_k_in_R1_C6);

% Reaction: id = reaction21, name = reaction21
	reaction_reaction21=compartment_cyt*Function_for_reaction21_4_0(x(4), global_par_index_k_out_2_relative_speed_C6, global_par_k_in_R2_C6);

% Reaction: id = reaction22, name = reaction22
	reaction_reaction22=compartment_cyt*Function_for_reaction22_4_0(x(8), global_par_index_active_Rec_internalize_C6, global_par_k_in_R1_C6);
...
% Reaction: id = reaction31, name = reaction31
	reaction_reaction31=compartment_cyt*Function_for_reaction31_2(global_par_index_kf_homotrimer, global_par_kf_trimmer, x(11));

% Reaction: id = reaction32, name = reaction32
	reaction_reaction32=compartment_cyt*Function_for_reaction32_3(global_par_index_kb_homotrimer, global_par_kb_trimmer, x(15));

% Reaction: id = reaction33, name = reaction33
	reaction_reaction33=compartment_nuc*Function_for_reaction33_2_0(global_par_index_kf_homotrimer, global_par_kf_trimmer, x(19));

% Reaction: id = reaction34, name = reaction34
	reaction_reaction34=compartment_nuc*Function_for_reaction34_2(global_par_index_kb_homotrimer, global_par_kb_trimmer, x(21));

% Reaction: id = reaction35, name = reaction35
	reaction_reaction35=Function_for_reaction35_5_0(x(12), global_par_S2_import_to_nuc_C6, compartment_cyt);

% Reaction: id = reaction36, name = reaction36
	reaction_reaction36=Function_for_reaction36_5_0(global_par_S2_export_from_nuc_C6, x(22), compartment_nuc);

% Reaction: id = reaction37, name = reaction37
	reaction_reaction37=Function_for_reaction37_5_0(x(13), global_par_S4_import_to_nuc_C6, compartment_cyt);

% Reaction: id = reaction38, name = reaction38
	reaction_reaction38=Function_for_reaction38_5_0(global_par_S4_export_from_nuc_C6, x(23), compartment_nuc);

% Reaction: id = reaction39, name = reaction39
	reaction_reaction39=Function_for_reaction39_5_0(global_par_S2_import_to_nuc_C6, compartment_cyt, x(11));

% Reaction: id = reaction40, name = reaction40
	reaction_reaction40=Function_for_reaction40_5_0(global_par_S2_export_from_nuc_C6, compartment_nuc, x(19));
...
% Reaction: id = reaction43, name = reaction43
	reaction_reaction43=compartment_nuc*global_par_k_Dephos_C6*x(19);

% Reaction: id = reaction44, name = reaction44
	reaction_reaction44=compartment_nuc*Function_for_reaction44_5_0(global_par_index_trimer_dephos, global_par_k_Dephos_C6, x(20));

% Reaction: id = reaction45, name = reaction45
	reaction_reaction45=compartment_cyt*Function_for_reaction45_5_0(global_par_S2_export_from_nuc_C6, global_par_S2_import_to_nuc_C6, global_par_S2_total_C6, global_par_kdeg_S2);

% Reaction: id = reaction46, name = reaction46
	reaction_reaction46=compartment_cyt*Function_for_reaction46_5_0(global_par_S4_export_from_nuc_C6, global_par_S4_import_to_nuc_C6, global_par_S4_total_C6, global_par_kdeg_S4);

% Reaction: id = reaction47, name = reaction47
	reaction_reaction47=compartment_cyt*Function_for_reaction47_5_0(global_par_R1_total_C6, global_par_index_k_out_1_relative_speed_C6, global_par_k_in_R1_C6, global_par_kdeg_R1);

% Reaction: id = reaction48, name = reaction48
	reaction_reaction48=compartment_cyt*Function_for_reaction48_2_0(global_par_R2_total_C6, global_par_index_k_out_2_relative_speed_C6, global_par_k_in_R2_C6, global_par_kdeg_R2);

% Reaction: id = reaction51, name = reaction51
	reaction_reaction51=compartment_nuc*Function_for_reaction51_4_0(global_par_DRB, global_par_K_mran, global_par_S7KD, global_par_hill_fact1, global_par_k_induced_S7_production_C6, global_par_mRNA_prod_C6, x(20));
...
% Reaction: id = reaction53, name = reaction53
	reaction_reaction53=compartment_cyt*Function_for_reaction53_2_0(x(16), global_par_k_S7_protein_C6);
...
% Species:   id = TGFb_R1_surface, name = TGFb_R1_surface, affected by kineticLaw
...
% Species:   id = TGFb_R2_surface, name = TGFb_R2_surface, affected by kineticLaw
...
% Species:   id = TGFb_R1_endo, name = TGFb_R1_endo, affected by kineticLaw
...
% Species:   id = TGFb_R2_endo, name = TGFb_R2_endo, affected by kineticLaw
...
% Species:   id = Active_R2, name = Active_R2, affected by kineticLaw
...
% Species:   id = pS2_c, name = pS2_c, affected by kineticLaw
...
% Species:   id = S2_c, name = S2_c, affected by kineticLaw
...
% Species:   id = S4_c, name = S4_c, affected by kineticLaw
...
% Species:   id = Smad7mRNA, name = Smad7mRNA, affected by kineticLaw
	xdot(16) = (1/(compartment_cyt))*(( 1.0 * reaction_reaction52) + (-1.0 * reaction_reaction67));
	
% Species:   id = Smad7mRNA1, name = Smad7mRNA1, affected by kineticLaw
...
% Species:   id = pS2_n, name = pS2_n, affected by kineticLaw
...
% Species:   id = S2_n, name = S2_n, affected by kineticLaw
...
% Species:   id = S4_n, name = S4_n, affected by kineticLaw
...
function z=Function_for_reaction1_0(TGFb,TGFb_R2_surface,k_medium,kf_R2_activation), z=(TGFb*TGFb_R2_surface*kf_R2_activation/k_medium);end

function z=Function_for_reaction15_0(Inactive_Rec,index_seq_kb,kf_Seq_S7_Rec), z=(Inactive_Rec*index_seq_kb*kf_Seq_S7_Rec);end

function z=Function_for_reaction8_0(Active_Rec,index_kb_R1,kf_R1_activation), z=(Active_Rec*index_kb_R1*kf_R1_activation);end

function z=Function_for_reaction16_0(Inactive_Rec,index_induced_ligand_deg,kin_deg_Ligand), z=(Inactive_Rec*index_induced_ligand_deg*kin_deg_Ligand);end

function z=Function_for_reaction4_0(Active_R2,index_kb_R2,kf_R2_activation), z=(Active_R2*index_kb_R2*kf_R2_activation);end

function z=Function_for_reaction3_0(TGFb,TGFb_R2_surface,kf_R2_activation), z=(TGFb*TGFb_R2_surface*kf_R2_activation);end

function z=Function_for_reaction5_0(Active_R2,index_kb_R2,kf_R2_activation), z=(Active_R2*index_kb_R2*kf_R2_activation);end

function z=Function_for_reaction6_0(Active_R2,index_kb_R2,k_medium,kf_R2_activation), z=(Active_R2*index_kb_R2*kf_R2_activation/k_medium);end
...
function z=Function_for_reaction31_2(index_kf_homotrimer,kf_trimmer,pS2_c), z=(index_kf_homotrimer*kf_trimmer*pS2_c^3);end

function z=Function_for_reaction2_0(TGFb,TGFb_R2_surface,kf_R2_activation), z=(TGFb*TGFb_R2_surface*kf_R2_activation);end

function z=Function_for_reaction17_0(Inactive_Rec,index_induced_R2_deg,kdeg_R2), z=(Inactive_Rec*index_induced_R2_deg*kdeg_R2);end

function z=Function_for_reaction42_0(Trimer_import_to_nuc,cyt,pS2_pS2_pS2_c), z=(cyt*Trimer_import_to_nuc*pS2_pS2_pS2_c);end

function z=Function_for_reaction45_5_0(S2_export_from_nuc_C6,S2_import_to_nuc_C6,S2_total_C6,kdeg_S2), z=(S2_total_C6*(S2_import_to_nuc_C6*kdeg_S2+S2_export_from_nuc_C6*kdeg_S2+kdeg_S2^2)/(2*S2_import_to_nuc_C6+S2_export_from_nuc_C6+kdeg_S2));end

function z=Function_for_reaction46_5_0(S4_export_from_nuc_C6,S4_import_to_nuc_C6,S4_total_C6,kdeg_S4), z=(S4_total_C6*(S4_import_to_nuc_C6*kdeg_S4+S4_export_from_nuc_C6*kdeg_S4+kdeg_S4^2)/(2*S4_import_to_nuc_C6+S4_export_from_nuc_C6+kdeg_S4));end

function z=Function_for_reaction21_4_0(TGFb_R2_endo,index_k_out_2_relative_speed_C6,k_in_R2_C6), z=(TGFb_R2_endo*index_k_out_2_relative_speed_C6*k_in_R2_C6);end

function z=Function_for_reaction20_4_0(TGFb_R1_endo,index_k_out_1_relative_speed_C6,k_in_R1_C6), z=(TGFb_R1_endo*index_k_out_1_relative_speed_C6*k_in_R1_C6);end

function z=Function_for_reaction35_5_0(S2_c,S2_import_to_nuc_C6,cyt), z=(cyt*S2_c*S2_import_to_nuc_C6);end

function z=Function_for_reaction32_3(index_kb_homotrimer,kb_trimmer,pS2_pS2_pS2_c), z=(index_kb_homotrimer*kb_trimmer*pS2_pS2_pS2_c);end

function z=Function_for_reaction48_2_0(R2_total_C6,index_k_out_2_relative_speed_C6,k_in_R2_C6,kdeg_R2), z=(R2_total_C6*k_in_R2_C6*kdeg_R2^2/(k_in_R2_C6*kdeg_R2+kdeg_R2^2+index_k_out_2_relative_speed_C6*k_in_R2_C6*kdeg_R2));end

function z=Function_for_reaction40_5_0(S2_export_from_nuc_C6,nuc,pS2_n), z=(nuc*S2_export_from_nuc_C6*pS2_n);end

function z=Function_for_reaction38_5_0(S4_export_from_nuc_C6,S4_n,nuc), z=(nuc*S4_n*S4_export_from_nuc_C6);end

function z=Function_for_reaction36_5_0(S2_export_from_nuc_C6,S2_n,nuc), z=(nuc*S2_n*S2_export_from_nuc_C6);end

function z=Function_for_reaction34_2(index_kb_homotrimer,kb_trimmer,pS2_pS2_pS2_n), z=(index_kb_homotrimer*kb_trimmer*pS2_pS2_pS2_n);end

function z=Function_for_reaction53_2_0(Smad7mRNA,k_S7_protein_C6), z=(Smad7mRNA*k_S7_protein_C6);end

function z=Function_for_reaction39_5_0(S2_import_to_nuc_C6,cyt,pS2_c), z=(cyt*S2_import_to_nuc_C6*pS2_c);end

function z=Function_for_reaction47_5_0(R1_total_C6,index_k_out_1_relative_speed_C6,k_in_R1_C6,kdeg_R1), z=(R1_total_C6*k_in_R1_C6*kdeg_R1^2/(k_in_R1_C6*kdeg_R1+kdeg_R1^2+index_k_out_1_relative_speed_C6*k_in_R1_C6*kdeg_R1));end

function z=Function_for_reaction37_5_0(S4_c,S4_import_to_nuc_C6,cyt), z=(cyt*S4_c*S4_import_to_nuc_C6);end

function z=Function_for_reaction44_5_0(index_trimer_dephos,k_Dephos_C6,pS2_pS2_S4_n), z=(index_trimer_dephos*k_Dephos_C6*pS2_pS2_S4_n);end

function z=Function_for_reaction51_4_0(DRB,K_mran,S7KD,hill_fact1,k_induced_S7_production_C6,mRNA_prod_C6,pS2_pS2_S4_n), z=(DRB*S7KD*(mRNA_prod_C6+k_induced_S7_production_C6*pS2_pS2_S4_n^hill_fact1/(K_mran^hill_fact1+pS2_pS2_S4_n^hill_fact1)));end

function z=Function_for_reaction33_2_0(index_kf_homotrimer,kf_trimmer,pS2_n), z=(index_kf_homotrimer*kf_trimmer*pS2_n^3);end

function z=Function_for_reaction22_4_0(Active_Rec,index_active_Rec_internalize_C6,k_in_R1_C6), z=(Active_Rec*index_active_Rec_internalize_C6*k_in_R1_C6);end
