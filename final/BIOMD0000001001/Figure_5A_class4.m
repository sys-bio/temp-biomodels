...
%
% Model name = Strasen2018 – TGFβ SMAD Signalling Class 4
%
%
...
%Initial conditions vector
	x0=zeros(23,1);
	x0(1) = 7.37484720979563;
	x0(2) = 2.84857903492582;
	x0(3) = 17.1317314809658;
	x0(4) = 21.6328902735663;
	x0(5) = 100.0;
	x0(6) = 0.0;
	x0(7) = 0.0;
	x0(8) = 0.0;
	...
	x0(10) = 0.0;
	x0(11) = 0.0;
	x0(12) = 983.876779683219;
	x0(13) = 321.754946048929;
	x0(14) = 0.0;
	x0(15) = 0.0;
	x0(16) = 0.0299844546468797;
	x0(17) = 0.195085328737367;
	x0(18) = 5.60247038333809;
	x0(19) = 0.0;
	x0(20) = 0.0;
	x0(21) = 0.0;
	x0(22) = 331.255227077521;
	x0(23) = 67.7833709361971;
...
% Parameter:   id =  R1_total_C4, name = R1_total_C4
	global_par_R1_total_C4=24.5065786907614;
% Parameter:   id =  R2_total_C4, name = R2_total_C4
	global_par_R2_total_C4=24.4814693084921;
% Parameter:   id =  S2_export_from_nuc_C4, name = S2_export_from_nuc_C4
	global_par_S2_export_from_nuc_C4=3.1018054766891;
% Parameter:   id =  S2_import_to_nuc_C4, name = S2_import_to_nuc_C4
	global_par_S2_import_to_nuc_C4=0.522250139330463;
% Parameter:   id =  S2_total_C4, name = S2_total_C4
	global_par_S2_total_C4=1315.13200676074;
% Parameter:   id =  S4_export_from_nuc_C4, name = S4_export_from_nuc_C4
	global_par_S4_export_from_nuc_C4=0.23373067315266;
% Parameter:   id =  S4_import_to_nuc_C4, name = S4_import_to_nuc_C4
	global_par_S4_import_to_nuc_C4=0.0251255663556574;
% Parameter:   id =  S4_total_C4, name = S4_total_C4
	global_par_S4_total_C4=389.538316985126;
...
% Parameter:   id =  index_active_Rec_internalize_C4, name = index_active_Rec_internalize_C4
	global_par_index_active_Rec_internalize_C4=0.922503805466932;
...
% Parameter:   id =  index_k_out_1_relative_speed_C4, name = index_k_out_1_relative_speed_C4
	global_par_index_k_out_1_relative_speed_C4=0.28410342378491;
% Parameter:   id =  index_k_out_2_relative_speed_C4, name = index_k_out_2_relative_speed_C4
	global_par_index_k_out_2_relative_speed_C4=0.13081029215514;
...
% Parameter:   id =  k_Dephos_C4, name = k_Dephos_C4
	global_par_k_Dephos_C4=0.0704492217625347;
% Parameter:   id =  k_S7_protein_C4, name = k_S7_protein_C4
	global_par_k_S7_protein_C4=0.191333551016171;
% Parameter:   id =  k_disso_Active_Rec, name = k_disso_Active_Rec
	global_par_k_disso_Active_Rec=0.00103940411358367;
% Parameter:   id =  k_in_R1_C4, name = k_in_R1_C4
	global_par_k_in_R1_C4=0.40073987230226;
% Parameter:   id =  k_in_R2_C4, name = k_in_R2_C4
	global_par_k_in_R2_C4=1.1527121689746;
% Parameter:   id =  k_induced_S7_production_C4, name = k_induced_S7_production_C4
	global_par_k_induced_S7_production_C4=9.74383528364265;
...
% Parameter:   id =  mRNA_prod_C4, name = mRNA_prod_C4
	global_par_mRNA_prod_C4=0.00695852015347187;
...
% Reaction: id = reaction18, name = reaction18
	reaction_reaction18=compartment_cyt*global_par_k_in_R1_C4*x(1);

% Reaction: id = reaction19, name = reaction19
	reaction_reaction19=compartment_cyt*global_par_k_in_R2_C4*x(2);

% Reaction: id = reaction20, name = reaction20
	reaction_reaction20=compartment_cyt*Function_for_reaction20_1(x(3), global_par_index_k_out_1_relative_speed_C4, global_par_k_in_R1_C4);

% Reaction: id = reaction21, name = reaction21
	reaction_reaction21=compartment_cyt*Function_for_reaction21_1(x(4), global_par_index_k_out_2_relative_speed_C4, global_par_k_in_R2_C4);

% Reaction: id = reaction22, name = reaction22
	reaction_reaction22=compartment_cyt*Function_for_reaction22_1(x(8), global_par_index_active_Rec_internalize_C4, global_par_k_in_R1_C4);
...
% Reaction: id = reaction33, name = reaction33
	reaction_reaction33=compartment_nuc*Function_for_reaction33_2(global_par_index_kf_homotrimer, global_par_kf_trimmer, x(19));
...
% Reaction: id = reaction35, name = reaction35
	reaction_reaction35=Function_for_reaction35_2(x(12), global_par_S2_import_to_nuc_C4, compartment_cyt);

% Reaction: id = reaction36, name = reaction36
	reaction_reaction36=Function_for_reaction36_2(global_par_S2_export_from_nuc_C4, x(22), compartment_nuc);

% Reaction: id = reaction37, name = reaction37
	reaction_reaction37=Function_for_reaction37_2(x(13), global_par_S4_import_to_nuc_C4, compartment_cyt);

% Reaction: id = reaction38, name = reaction38
	reaction_reaction38=Function_for_reaction38_2(global_par_S4_export_from_nuc_C4, x(23), compartment_nuc);

% Reaction: id = reaction39, name = reaction39
	reaction_reaction39=Function_for_reaction39_2(global_par_S2_import_to_nuc_C4, compartment_cyt, x(11));

% Reaction: id = reaction40, name = reaction40
	reaction_reaction40=Function_for_reaction40_2(global_par_S2_export_from_nuc_C4, compartment_nuc, x(19));
...
% Reaction: id = reaction43, name = reaction43
	reaction_reaction43=compartment_nuc*global_par_k_Dephos_C4*x(19);

% Reaction: id = reaction44, name = reaction44
	reaction_reaction44=compartment_nuc*Function_for_reaction44_2(global_par_index_trimer_dephos, global_par_k_Dephos_C4, x(20));

% Reaction: id = reaction45, name = reaction45
	reaction_reaction45=compartment_cyt*Function_for_reaction45_2(global_par_S2_export_from_nuc_C4, global_par_S2_import_to_nuc_C4, global_par_S2_total_C4, global_par_kdeg_S2);

% Reaction: id = reaction46, name = reaction46
	reaction_reaction46=compartment_cyt*Function_for_reaction46_2(global_par_S4_export_from_nuc_C4, global_par_S4_import_to_nuc_C4, global_par_S4_total_C4, global_par_kdeg_S4);

% Reaction: id = reaction47, name = reaction47
	reaction_reaction47=compartment_cyt*Function_for_reaction47_2(global_par_R1_total_C4, global_par_index_k_out_1_relative_speed_C4, global_par_k_in_R1_C4, global_par_kdeg_R1);

% Reaction: id = reaction48, name = reaction48
	reaction_reaction48=compartment_cyt*Function_for_reaction48_0(global_par_R2_total_C4, global_par_index_k_out_2_relative_speed_C4, global_par_k_in_R2_C4, global_par_kdeg_R2);

% Reaction: id = reaction51, name = reaction51
	reaction_reaction51=compartment_nuc*Function_for_reaction51_2(global_par_DRB, global_par_K_mran, global_par_S7KD, global_par_hill_fact1, global_par_k_induced_S7_production_C4, global_par_mRNA_prod_C4, x(20));
...
% Reaction: id = reaction53, name = reaction53
	reaction_reaction53=compartment_cyt*Function_for_reaction53_0(x(16), global_par_k_S7_protein_C4);
...
function z=Function_for_reaction21_1(TGFb_R2_endo,index_k_out_2_relative_speed_C4,k_in_R2_C4), z=(TGFb_R2_endo*index_k_out_2_relative_speed_C4*k_in_R2_C4);end

function z=Function_for_reaction20_1(TGFb_R1_endo,index_k_out_1_relative_speed_C4,k_in_R1_C4), z=(TGFb_R1_endo*index_k_out_1_relative_speed_C4*k_in_R1_C4);end

function z=Function_for_reaction31_2(index_kf_homotrimer,kf_trimmer,pS2_c), z=(index_kf_homotrimer*kf_trimmer*pS2_c^3);end

function z=Function_for_reaction22_1(Active_Rec,index_active_Rec_internalize_C4,k_in_R1_C4), z=(Active_Rec*index_active_Rec_internalize_C4*k_in_R1_C4);end
...
function z=Function_for_reaction53_0(Smad7mRNA,k_S7_protein_C4), z=(Smad7mRNA*k_S7_protein_C4);end
...
function z=Function_for_reaction40_2(S2_export_from_nuc_C4,nuc,pS2_n), z=(nuc*S2_export_from_nuc_C4*pS2_n);end

function z=Function_for_reaction37_2(S4_c,S4_import_to_nuc_C4,cyt), z=(cyt*S4_c*S4_import_to_nuc_C4);end

function z=Function_for_reaction46_2(S4_export_from_nuc_C4,S4_import_to_nuc_C4,S4_total_C4,kdeg_S4), z=(S4_total_C4*(S4_import_to_nuc_C4*kdeg_S4+S4_export_from_nuc_C4*kdeg_S4+kdeg_S4^2)/(2*S4_import_to_nuc_C4+S4_export_from_nuc_C4+kdeg_S4));end
...
function z=Function_for_reaction38_2(S4_export_from_nuc_C4,S4_n,nuc), z=(nuc*S4_n*S4_export_from_nuc_C4);end

function z=Function_for_reaction36_2(S2_export_from_nuc_C4,S2_n,nuc), z=(nuc*S2_n*S2_export_from_nuc_C4);end

function z=Function_for_reaction42_0(Trimer_import_to_nuc,cyt,pS2_pS2_pS2_c), z=(cyt*Trimer_import_to_nuc*pS2_pS2_pS2_c);end

function z=Function_for_reaction33_2(index_kf_homotrimer,kf_trimmer,pS2_n), z=(index_kf_homotrimer*kf_trimmer*pS2_n^3);end

function z=Function_for_reaction35_2(S2_c,S2_import_to_nuc_C4,cyt), z=(cyt*S2_c*S2_import_to_nuc_C4);end

function z=Function_for_reaction39_2(S2_import_to_nuc_C4,cyt,pS2_c), z=(cyt*S2_import_to_nuc_C4*pS2_c);end

function z=Function_for_reaction47_2(R1_total_C4,index_k_out_1_relative_speed_C4,k_in_R1_C4,kdeg_R1), z=(R1_total_C4*k_in_R1_C4*kdeg_R1^2/(k_in_R1_C4*kdeg_R1+kdeg_R1^2+index_k_out_1_relative_speed_C4*k_in_R1_C4*kdeg_R1));end

function z=Function_for_reaction45_2(S2_export_from_nuc_C4,S2_import_to_nuc_C4,S2_total_C4,kdeg_S2), z=(S2_total_C4*(S2_import_to_nuc_C4*kdeg_S2+S2_export_from_nuc_C4*kdeg_S2+kdeg_S2^2)/(2*S2_import_to_nuc_C4+S2_export_from_nuc_C4+kdeg_S2));end

function z=Function_for_reaction41_2(Trimer_import_to_nuc,cyt,pS2_pS2_S4_c), z=(cyt*Trimer_import_to_nuc*pS2_pS2_S4_c);end

function z=Function_for_reaction51_2(DRB,K_mran,S7KD,hill_fact1,k_induced_S7_production_C4,mRNA_prod_C4,pS2_pS2_S4_n), z=(DRB*S7KD*(mRNA_prod_C4+k_induced_S7_production_C4*pS2_pS2_S4_n^hill_fact1/(K_mran^hill_fact1+pS2_pS2_S4_n^hill_fact1)));end

function z=Function_for_reaction44_2(index_trimer_dephos,k_Dephos_C4,pS2_pS2_S4_n), z=(index_trimer_dephos*k_Dephos_C4*pS2_pS2_S4_n);end

function z=Function_for_reaction48_0(R2_total_C4,index_k_out_2_relative_speed_C4,k_in_R2_C4,kdeg_R2), z=(R2_total_C4*k_in_R2_C4*kdeg_R2^2/(k_in_R2_C4*kdeg_R2+kdeg_R2^2+index_k_out_2_relative_speed_C4*k_in_R2_C4*kdeg_R2));end
