...
function z=function_BB_218(A1,A2,A3,A4), z=(A2-A1+A3*A2+A4*A1);endfunction

function z=function_GK_219(A1,A2,A3,A4), z=(2*A4*A1/(A2-A1+A3*A2+A4*A1+((A2-A1+A3*A2+A4*A1)^2-4*(A2-A1)*A4*A1)^(0.5)));endfunction

function z=function_MichaelisMenten_220(M1,J1,k1,S1), z=(k1*S1*M1/(J1+S1));endfunction

function z=function_Mass_Action_2_221(k1,S1,S2), z=(k1*S1*S2);endfunction

function z=function_Mass_Action_1_222(k1,S1), z=(k1*S1);endfunction
...
# Warning parameter bub2l is not constant, it should be controled by a Rule and/or events
	global_par_bub2l=0.2;
# Parameter:   id =  C0, name = C0
	global_par_C0=0.4;
# Parameter:   id =  CDC15T, name = CDC15T
# Warning parameter CDC15T is not constant, it should be controled by a Rule and/or events
...
# Warning parameter ESP1T is not constant, it should be controled by a Rule and/or events
	global_par_ESP1T=1.0;
# Parameter:   id =  IET, name = IET
# Warning parameter IET is not constant, it should be controled by a Rule and/or events
	global_par_IET=1.0;
...
# Warning parameter KEZ is not constant, it should be controled by a Rule and/or events
	global_par_KEZ=0.3;
# Parameter:   id =  KEZ2, name = KEZ2
# Warning parameter KEZ2 is not constant, it should be controled by a Rule and/or events
	global_par_KEZ2=0.2;
# Parameter:   id =  ki15, name = ki15
	global_par_ki15=0.5;
# Parameter:   id =  kicdh_p, name = kicdh'
	global_par_kicdh_p=0.0010;
...
# Parameter:   id =  ksswi_p, name = ksswi'
	global_par_ksswi_p=0.0050;
# Parameter:   id =  ksswi_p_p, name = ksswi''
	global_par_ksswi_p_p=0.08;
# Parameter:   id =  lte1h, name = lte1h
# Warning parameter lte1h is not constant, it should be controled by a Rule and/or events
	global_par_lte1h=1.0;
# Parameter:   id =  lte1l, name = lte1l
# Warning parameter lte1l is not constant, it should be controled by a Rule and/or events
	global_par_lte1l=0.1;
# Parameter:   id =  mad2h, name = mad2h
	global_par_mad2h=8.0;
# Parameter:   id =  mad2l, name = mad2l
# Warning parameter mad2l is not constant, it should be controled by a Rule and/or events
	global_par_mad2l=0.01;
# Parameter:   id =  mdt, name = mdt
	global_par_mdt=90.0;
# Parameter:   id =  TEM1T, name = TEM1T
# Warning parameter TEM1T is not constant, it should be controled by a Rule and/or events
...
# assignmentRule: variable = SBF
	x(46)=function_GK_219(global_par_Vasbf, global_par_Visbf, global_par_Jasbf, global_par_Jisbf);
# assignmentRule: variable = MCM1
	x(36)=function_GK_219(global_par_kamcm*x(20), global_par_kimcm, global_par_Jamcm, global_par_Jimcm);
...
# Reaction: id = Degradation_of_CLN2, name = Degradation of CLN2
	...
	reaction_Degradation_of_CLN2=function_Mass_Action_1_222(global_par_kdn2, x(24));
...
# Reaction: id = Degradation_of_CLB2, name = Degradation of CLB2
	...
	reaction_Degradation_of_CLB2=function_Mass_Action_1_222(global_par_Vdb2, x(20));
...
# Reaction: id = Degradation_of_CLB5, name = Degradation of CLB5
	...
	reaction_Degradation_of_CLB5=function_Mass_Action_1_222(global_par_Vdb5, x(22));
...
# Reaction: id = Phosphorylation_of_SIC1, name = Phosphorylation of SIC1
	...
	reaction_Phosphorylation_of_SIC1=function_Mass_Action_1_222(global_par_Vkpc1, x(47));
# Reaction: id = Dephosphorylation_of_SIC1, name = Dephosphorylation of SIC1


	reaction_Dephosphorylation_of_SIC1=function_Mass_Action_1_222(global_par_Vppc1, x(48));
# Reaction: id = Fast_Degradation_of_SIC1P, name = Fast Degradation of SIC1P


	reaction_Fast_Degradation_of_SIC1P=function_Mass_Action_1_222(global_par_kd3c1, x(48));
# Reaction: id = Assoc_of_CLB2_and_SIC1, name = Assoc. of CLB2 and SIC1


	reaction_Assoc_of_CLB2_and_SIC1=function_Mass_Action_2_221(global_par_kasb2, x(20), x(47));
# Reaction: id = Dissoc_of_CLB2SIC1_complex, name = Dissoc. of CLB2/SIC1 complex


	reaction_Dissoc_of_CLB2SIC1_complex=function_Mass_Action_1_222(global_par_kdib2, x(4));
# Reaction: id = Assoc_of_CLB5_and_SIC1, name = Assoc. of CLB5 and SIC1


	reaction_Assoc_of_CLB5_and_SIC1=function_Mass_Action_2_221(global_par_kasb5, x(22), x(47));
# Reaction: id = Dissoc_of_CLB5SIC1, name = Dissoc. of CLB5/SIC1


	reaction_Dissoc_of_CLB5SIC1=function_Mass_Action_1_222(global_par_kdib5, x(6));
# Reaction: id = Phosphorylation_of_C2, name = Phosphorylation of C2


	reaction_Phosphorylation_of_C2=function_Mass_Action_1_222(global_par_Vkpc1, x(4));
# Reaction: id = Dephosphorylation_of_C2P, name = Dephosphorylation of C2P


	reaction_Dephosphorylation_of_C2P=function_Mass_Action_1_222(global_par_Vppc1, x(5));
# Reaction: id = Phosphorylation_of_C5, name = Phosphorylation of C5


	reaction_Phosphorylation_of_C5=function_Mass_Action_1_222(global_par_Vkpc1, x(6));
# Reaction: id = Dephosphorylation_of_C5P, name = Dephosphorylation of C5P


	reaction_Dephosphorylation_of_C5P=function_Mass_Action_1_222(global_par_Vppc1, x(7));
# Reaction: id = Degradation_of_CLB2_in_C2, name = Degradation of CLB2 in C2


	reaction_Degradation_of_CLB2_in_C2=function_Mass_Action_1_222(global_par_Vdb2, x(4));
# Reaction: id = Degradation_of_CLB5_in_C5, name = Degradation of CLB5 in C5


	reaction_Degradation_of_CLB5_in_C5=function_Mass_Action_1_222(global_par_Vdb5, x(6));
# Reaction: id = Degradation_of_SIC1_in_C2P, name = Degradation of SIC1 in C2P


	reaction_Degradation_of_SIC1_in_C2P=function_Mass_Action_1_222(global_par_kd3c1, x(5));
# Reaction: id = Degradation_of_SIC1P_in_C5P_, name = Degradation of SIC1P in C5P


	reaction_Degradation_of_SIC1P_in_C5P_=function_Mass_Action_1_222(global_par_kd3c1, x(7));
# Reaction: id = Degradation_of_CLB2_in_C2P, name = Degradation of CLB2 in C2P


	reaction_Degradation_of_CLB2_in_C2P=function_Mass_Action_1_222(global_par_Vdb2, x(5));
# Reaction: id = Degradation_of_CLB5_in_C5P, name = Degradation of CLB5 in C5P


	reaction_Degradation_of_CLB5_in_C5P=function_Mass_Action_1_222(global_par_Vdb5, x(7));
...
# Reaction: id = Phosphorylation_of_CDC6, name = Phosphorylation of CDC6
	...
	reaction_Phosphorylation_of_CDC6=function_Mass_Action_1_222(global_par_Vkpf6, x(14));
# Reaction: id = Dephosphorylation_of_CDC6, name = Dephosphorylation of CDC6


	reaction_Dephosphorylation_of_CDC6=function_Mass_Action_1_222(global_par_Vppf6, x(15));
# Reaction: id = Degradation_of_CDC6P, name = Degradation of CDC6P


	reaction_Degradation_of_CDC6P=function_Mass_Action_1_222(global_par_kd3f6, x(15));
# Reaction: id = CLB2CDC6_complex_formation, name = CLB2/CDC6 complex formation


	reaction_CLB2CDC6_complex_formation=function_Mass_Action_2_221(global_par_kasf2, x(20), x(14));
# Reaction: id = CLB2CDC6_dissociation, name = CLB2/CDC6 dissociation


	reaction_CLB2CDC6_dissociation=function_Mass_Action_1_222(global_par_kdif2, x(27));
# Reaction: id = CLB5CDC6_complex_formation, name = CLB5/CDC6 complex formation


	reaction_CLB5CDC6_complex_formation=function_Mass_Action_2_221(global_par_kasf5, x(22), x(14));
# Reaction: id = CLB5CDC6_dissociation, name = CLB5/CDC6 dissociation


	reaction_CLB5CDC6_dissociation=function_Mass_Action_1_222(global_par_kdif5, x(29));
# Reaction: id = F2_phosphorylation, name = F2 phosphorylation


	reaction_F2_phosphorylation=function_Mass_Action_1_222(global_par_Vkpf6, x(27));
# Reaction: id = F2P_dephosphorylation, name = F2P dephosphorylation


	reaction_F2P_dephosphorylation=function_Mass_Action_1_222(global_par_Vppf6, x(28));
# Reaction: id = F5_phosphorylation, name = F5 phosphorylation


	reaction_F5_phosphorylation=function_Mass_Action_1_222(global_par_Vkpf6, x(29));
# Reaction: id = F5P_dephosphorylation, name = F5P dephosphorylation


	reaction_F5P_dephosphorylation=function_Mass_Action_1_222(global_par_Vppf6, x(30));
# Reaction: id = CLB2_degradation_in_F2, name = CLB2 degradation in F2


	reaction_CLB2_degradation_in_F2=function_Mass_Action_1_222(global_par_Vdb2, x(27));
# Reaction: id = CLB5_degradation_in_F5, name = CLB5 degradation in F5


	reaction_CLB5_degradation_in_F5=function_Mass_Action_1_222(global_par_Vdb5, x(29));
# Reaction: id = CDC6_degradation_in_F2P, name = CDC6 degradation in F2P


	reaction_CDC6_degradation_in_F2P=function_Mass_Action_1_222(global_par_kd3f6, x(28));
# Reaction: id = CDC6_degradation_in_F5P, name = CDC6 degradation in F5P


	reaction_CDC6_degradation_in_F5P=function_Mass_Action_1_222(global_par_kd3f6, x(30));
# Reaction: id = CLB2_degradation_in_F2P, name = CLB2 degradation in F2P


	reaction_CLB2_degradation_in_F2P=function_Mass_Action_1_222(global_par_Vdb2, x(28));
# Reaction: id = CLB5_degradation_in_F5P, name = CLB5 degradation in F5P


	reaction_CLB5_degradation_in_F5P=function_Mass_Action_1_222(global_par_Vdb5, x(30));
...
# Reaction: id = Degradation_of_SWI5, name = Degradation of SWI5
	...
	reaction_Degradation_of_SWI5=function_Mass_Action_1_222(global_par_kdswi, x(51));
# Reaction: id = Degradation_of_SWI5P, name = Degradation of SWI5P


	reaction_Degradation_of_SWI5P=function_Mass_Action_1_222(global_par_kdswi, x(52));
# Reaction: id = Activation_of_SWI5, name = Activation of SWI5


	reaction_Activation_of_SWI5=function_Mass_Action_1_222(global_par_kaswi*x(8), x(52));
# Reaction: id = Inactivation_of_SWI5, name = Inactivation of SWI5


	reaction_Inactivation_of_SWI5=function_Mass_Action_1_222(global_par_kiswi*x(20), x(51));
# Reaction: id = Activation_of_IEP, name = Activation of IEP


	reaction_Activation_of_IEP=function_MichaelisMenten_220(global_par_Vaiep, global_par_Jaiep, 1, x(31));
# Reaction: id = Inactivation_1, name = Inactivation


	reaction_Inactivation_1=function_MichaelisMenten_220(1, global_par_Jiiep, global_par_kiiep, x(32));
...
# Reaction: id = Degradation_of_inactiveCDC20, name = Degradation of inactiveCDC20
	...
	reaction_Degradation_of_inactiveCDC20=function_Mass_Action_1_222(global_par_kd20, x(13));
# Reaction: id = Degradation_of_active_CDC20, name = Degradation of active CDC20


	reaction_Degradation_of_active_CDC20=function_Mass_Action_1_222(global_par_kd20, x(12));
# Reaction: id = Activation_of_CDC20, name = Activation of CDC20


	reaction_Activation_of_CDC20=function_Mass_Action_1_222(global_par_ka20_p+global_par_ka20_p_p*x(32), x(13));
# Reaction: id = Inactivation_2, name = Inactivation

	# Local Parameter:   id =  k, name = k
	reaction_Inactivation_2_k=1.0;

	reaction_Inactivation_2=reaction_Inactivation_2_k*function_Mass_Action_1_222(x(34), x(12));
...
# Reaction: id = CDH1_degradation, name = CDH1 degradation
	...
	reaction_CDH1_degradation=function_Mass_Action_1_222(global_par_kdcdh, x(17));
# Reaction: id = CDH1i_degradation, name = CDH1i degradation


	reaction_CDH1i_degradation=function_Mass_Action_1_222(global_par_kdcdh, x(18));
# Reaction: id = CDH1i_activation, name = CDH1i activation


	reaction_CDH1i_activation=function_MichaelisMenten_220(global_par_Vacdh, global_par_Jacdh, 1, x(18));
# Reaction: id = Inactivation_3, name = Inactivation


	reaction_Inactivation_3=function_MichaelisMenten_220(global_par_Vicdh, global_par_Jicdh, 1, x(17));
...
# Reaction: id = CDC14_degradation, name = CDC14 degradation
	...
	reaction_CDC14_degradation=function_Mass_Action_1_222(global_par_kd14, x(8));
# Reaction: id = Assoc_with_NET1_to_form_RENT, name = Assoc. with NET1 to form RENT


	reaction_Assoc_with_NET1_to_form_RENT=function_Mass_Action_2_221(global_par_kasrent, x(8), x(37));
# Reaction: id = Dissoc_from_RENT, name = Dissoc. from RENT


	reaction_Dissoc_from_RENT=function_Mass_Action_1_222(global_par_kdirent, x(44));
# Reaction: id = Assoc_with_NET1P_to_form_RENTP, name = Assoc with NET1P to form RENTP


	reaction_Assoc_with_NET1P_to_form_RENTP=function_Mass_Action_2_221(global_par_kasrentp, x(8), x(38));
# Reaction: id = Dissoc_from_RENP, name = Dissoc. from RENP


	reaction_Dissoc_from_RENP=function_Mass_Action_1_222(global_par_kdirentp, x(45));
...
# Reaction: id = Net1_degradation, name = Net1 degradation
	...
	reaction_Net1_degradation=function_Mass_Action_1_222(global_par_kdnet, x(37));
# Reaction: id = Net1P_degradation, name = Net1P degradation


	reaction_Net1P_degradation=function_Mass_Action_1_222(global_par_kdnet, x(38));
# Reaction: id = NET1_phosphorylation, name = NET1 phosphorylation


	reaction_NET1_phosphorylation=function_Mass_Action_1_222(global_par_Vkpnet, x(37));
# Reaction: id = dephosphorylation_1, name = dephosphorylation


	reaction_dephosphorylation_1=function_Mass_Action_1_222(global_par_Vppnet, x(38));
# Reaction: id = RENT_phosphorylation, name = RENT phosphorylation


	reaction_RENT_phosphorylation=function_Mass_Action_1_222(global_par_Vkpnet, x(44));
# Reaction: id = dephosphorylation_2, name = dephosphorylation


	reaction_dephosphorylation_2=function_Mass_Action_1_222(global_par_Vppnet, x(45));
# Reaction: id = Degradation_of_NET1_in_RENT, name = Degradation of NET1 in RENT


	reaction_Degradation_of_NET1_in_RENT=function_Mass_Action_1_222(global_par_kdnet, x(44));
# Reaction: id = Degradation_of_NET1P_in_RENTP, name = Degradation of NET1P in RENTP


	reaction_Degradation_of_NET1P_in_RENTP=function_Mass_Action_1_222(global_par_kdnet, x(45));
# Reaction: id = Degradation_of_CDC14_in_RENT, name = Degradation of CDC14 in RENT


	reaction_Degradation_of_CDC14_in_RENT=function_Mass_Action_1_222(global_par_kd14, x(44));
# Reaction: id = Degradation_of_CDC14_in_RENTP, name = Degradation of CDC14 in RENTP


	reaction_Degradation_of_CDC14_in_RENTP=function_Mass_Action_1_222(global_par_kd14, x(45));
# Reaction: id = TEM1_activation, name = TEM1 activation


	reaction_TEM1_activation=function_MichaelisMenten_220(x(33), global_par_Jatem, 1, x(53));
# Reaction: id = inactivation_1, name = inactivation


	reaction_inactivation_1=function_MichaelisMenten_220(x(2), global_par_Jitem, 1, x(54));
# Reaction: id = CDC15_activation, name = CDC15 activation


	reaction_CDC15_activation=function_Mass_Action_1_222(global_par_ka15_p*x(53)+global_par_ka15_p_p*x(54)+global_par_ka15p*x(8), x(11));
# Reaction: id = inactivation_2, name = inactivation


	reaction_inactivation_2=function_Mass_Action_1_222(global_par_ki15, x(10));
...
# Reaction: id = degradation_1, name = degradation
	...
	reaction_degradation_1=function_Mass_Action_1_222(global_par_Vdppx, x(43));
...
# Reaction: id = degradation_2, name = degradation
	...
	reaction_degradation_2=function_Mass_Action_1_222(global_par_Vdpds, x(41));
# Reaction: id = Degradation_of_PDS1_in_PE, name = Degradation of PDS1 in PE


	reaction_Degradation_of_PDS1_in_PE=function_Mass_Action_1_222(global_par_Vdpds, x(42));
# Reaction: id = Assoc_with_ESP1_to_form_PE, name = Assoc. with ESP1 to form PE


	reaction_Assoc_with_ESP1_to_form_PE=function_Mass_Action_2_221(global_par_kasesp, x(41), x(26));
# Reaction: id = Disso_from_PE, name = Disso. from PE


	reaction_Disso_from_PE=function_Mass_Action_1_222(global_par_kdiesp, x(42));
...
# Reaction: id = Negative_regulation_of_DNA_synthesis, name = Negative regulation of DNA synthesis
	...
	reaction_Negative_regulation_of_DNA_synthesis=function_Mass_Action_1_222(global_par_kdori, x(40));
...
# Reaction: id = Negative_regulation_of_Cell_budding, name = Negative regulation of Cell budding
	...
	reaction_Negative_regulation_of_Cell_budding=function_Mass_Action_1_222(global_par_kdbud, x(3));
...
# Reaction: id = Spindle_disassembly, name = Spindle disassembly
	...
	reaction_Spindle_disassembly=function_Mass_Action_1_222(global_par_kdspn, x(50));
...
#Event: id=cell_division
	...
	xdot=zeros(54,1);
	# Species:   id = BCK2, name = BCK2, defined in a rule 
	xdot(1) = x(1);
...
# Warning species is not changed by either rules or reactions
	...
	# Species:   id = CDC14T, name = CDC14T, defined in a rule 
	xdot(9) = x(9);
	...
	# Species:   id = CDC15i, name = CDC15i, involved in a rule 
	xdot(11) = x(11);
	...
	# Species:   id = CDC6T, name = CDC6T, defined in a rule 
	xdot(16) = x(16);
	...
	# Species:   id = CKIT, name = CKIT, defined in a rule 
	xdot(19) = x(19);
	...
	# Species:   id = CLB2T, name = CLB2T, defined in a rule 
	xdot(21) = x(21);
	...
	# Species:   id = CLB5T, name = CLB5T, defined in a rule 
	xdot(23) = x(23);
	...
	# Species:   id = CLN3, name = CLN3, defined in a rule 
	xdot(25) = x(25);
...
# Warning species is not changed by either rules or reactions
	...
	# Species:   id = MCM1, name = MCM1, defined in a rule 
	xdot(36) = x(36);
	...
	# Species:   id = NET1T, name = NET1T, defined in a rule 
	xdot(39) = x(39);
	...
	# Species:   id = PE, name = PE, involved in a rule 
	xdot(42) = x(42);
	...
	# Species:   id = SBF, name = SBF, defined in a rule 
	xdot(46) = x(46);
	...
	# Species:   id = SIC1T, name = SIC1T, defined in a rule 
	xdot(49) = x(49);
	...
	# Species:   id = TEM1GDP, name = TEM1GDP, involved in a rule 
	xdot(53) = x(53);
