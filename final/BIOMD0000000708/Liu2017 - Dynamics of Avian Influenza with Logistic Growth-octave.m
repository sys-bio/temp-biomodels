...
% Reaction: id = reaction_1, name = Logistic growth of Susceptible Avian
	reaction_reaction_1=compartment_Avian_population*Function_for_Reaction_1__1__1(global_par_K_a, x(1), global_par_r_a);

% Reaction: id = reaction_2, name = Infection of Susceptible Avian
	reaction_reaction_2=compartment_Avian_population*Function_for_Reaction_2_1(x(2), x(1), global_par_beta_a);
...
% Reaction: id = reaction_6, name = Infection of Suceptible Human
	reaction_reaction_6=Function_for_Reaction_6_1(x(2), x(3), global_par_beta_h);
...
function z=Function_for_Reaction_1__1__1(K_a,S_a,r_a), z=(r_a*S_a*(1-S_a/K_a));end

function z=Function_for_Reaction_2_1(I_a,S_a,beta_a), z=(beta_a*S_a*I_a);end

function z=Function_for_Reaction_6_1(I_a,S_h,beta_h), z=(beta_h*I_a*S_h);end
