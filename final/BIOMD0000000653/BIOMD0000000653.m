...
%
% Model name = Padala2017- ERK, PI3K/Akt and Wnt signalling network (bRaf mutated)
%
% is http://identifiers.org/biomodels.db/BIOMD0000000653
% is http://identifiers.org/biomodels.db/MODEL1708290000
...
% Species:   id = BRaf, name = bRaf, affected by kineticLaw
	xdot(8) = (1/(compartment_Cell))*((-1.0 * reaction_v16a) + (-1.0 * reaction_v16b));
...
% Species:   id = RafPPtase, name = RafPPtase, affected by kineticLaw
	xdot(25) = (1/(compartment_Cell))*((-1.0 * reaction_v10a) + ( 1.0 * reaction_v10a));
...
% Species:   id = pAkt, name = pAkt, affected by kineticLaw
	xdot(39) = (1/(compartment_Cell))*((-1.0 * reaction_v10b) + ( 1.0 * reaction_v10b) + ( 1.0 * reaction_v22a) + (-1.0 * reaction_v22b) + (-1.0 * reaction_v27b) + ( 1.0 * reaction_v27b));
...
% Species:   id = pBRaf, name = pbRaf, affected by kineticLaw
	xdot(41) = (1/(compartment_Cell))*((-1.0 * reaction_v11a) + ( 1.0 * reaction_v11a) + ( 1.0 * reaction_v16a) + ( 1.0 * reaction_v16b));
