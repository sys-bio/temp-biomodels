...
% Parameter:   id =  k_mal, name = k_mal
	global_par_k_mal=3.267973856;
% Parameter:   id =  k_akg, name = k_akg
	global_par_k_akg=-4.336349925;
% Parameter:   id =  k_pep, name = k_pep
	global_par_k_pep=26.64655606;
% Parameter:   id =  k_icit, name = k_icit
	global_par_k_icit=-0.2413273;
% Parameter:   id =  k_f26bp, name = k_f26bp
	global_par_k_f26bp=-0.075557736;
% Parameter:   id =  k_cit, name = k_cit
	global_par_k_cit=-1.935646053;
% Parameter:   id =  k_f6p, name = k_f6p
	global_par_k_f6p=0.050276521;
...
%Event: id=ev2min
	...
	if(event_ev2min) 
		global_par_k_akg=-1.131221719;
		global_par_k_cit=1.860231272;
		global_par_k_f6p=-0.703871292;
		global_par_k_icit=-0.01256913;
		global_par_k_f26bp=0.124220778;
		global_par_k_mal=-3.016591252;
		global_par_k_pep=18.09954751;
	end
...
%Event: id=ev5min
	...
	if(event_ev5min) 
		global_par_k_akg=0.316742081;
		global_par_k_cit=-0.301659125;
		global_par_k_f6p=0.301659125;
		global_par_k_icit=-0.01256913;
		global_par_k_f26bp=0.095229112;
		global_par_k_mal=0.904977376;
		global_par_k_pep=-6.636500754;
	end
...
%Event: id=ev10min
	...
	if(event_ev10min) 
		...
		global_par_k_cit=0.814479638;
		global_par_k_f6p=-0.4826546;
		global_par_k_icit=-0.01256913;
		global_par_k_f26bp=-0.052409266;
		global_par_k_mal=3.016591252;
		global_par_k_pep=12.36802413;
	end
...
%Event: id=ev15min
	...
	if(event_ev15min) 
		global_par_k_akg=0.452488688;
		global_par_k_cit=0.814479638;
		global_par_k_f6p=0.090497738;
		global_par_k_icit=-0.01256913;
		global_par_k_f26bp=0.062662112;
		global_par_k_mal=-0.60331825;
		global_par_k_pep=-1.809954751;
	end
...
%Event: id=ev20min
	...
	if(event_ev20min) 
		global_par_k_akg=0.339366516;
		global_par_k_cit=0.618401207;
		global_par_k_f6p=-0.331825038;
		global_par_k_icit=0.012443439;
		global_par_k_f26bp=0.003116153;
		global_par_k_mal=2.564102564;
		global_par_k_pep=-3.921568627;
	end
...
%Event: id=ev30min
	...
	if(event_ev30min) 
		global_par_k_akg=0.716440422;
		global_par_k_cit=0.2413273;
		global_par_k_f6p=0.191050779;
		global_par_k_icit=0.012443439;
		global_par_k_f26bp=-0.014023035;
		global_par_k_mal=0.301659125;
		global_par_k_pep=-0.854700855;
	end
