...
%
% Model name = Padala2017- ERK, PI3K/Akt and Wnt signalling network (EGFR overexpression)
%
% is http://identifiers.org/biomodels.db/MODEL1708290001
% is http://identifiers.org/biomodels.db/BIOMD0000000656
...
% Parameter:   id =  Kcat8b, name = Kcat8b
	global_par_Kcat8b=1509.36;
...
% Parameter:   id =  Km8b, name = Km8b
	global_par_Km8b=1432410.0;
...
% Reaction: id = v8b, name = Ras dephosphorylation (Ras_Gap modifier)
	reaction_v8b=compartment_Cell*Function_for_Ras_dephosphorylation__Ras_Gap_modifier(global_par_Kcat8b, global_par_Km8b, x(29), compartment_Cell, x(51));
...
% Species:   id = Ras, name = Ras, affected by kineticLaw
	xdot(28) = (1/(compartment_Cell))*((-1.0 * reaction_v7) + ( 1.0 * reaction_v8a) + ( 1.0 * reaction_v8b));
	
% Species:   id = RasGap, name = Ras_Gap, affected by kineticLaw
	xdot(29) = (1/(compartment_Cell))*((-1.0 * reaction_v8b) + ( 1.0 * reaction_v8b));
...
% Species:   id = bEGFR, name = boundEGFR, affected by kineticLaw
	xdot(34) = (1/(compartment_Cell))*((-1.0 * reaction_v19a) + ( 1.0 * reaction_v19a) + ( 1.0 * reaction_v2) + (-1.0 * reaction_v23a) + ( 1.0 * reaction_v23a) + (-1.0 * reaction_v5) + ( 1.0 * reaction_v5));
	
% Species:   id = fEGFR, name = freeEGFR, affected by kineticLaw
	xdot(35) = (1/(compartment_Cell))*(( 1.0 * reaction_v1) + (-1.0 * reaction_v2));
...
% Species:   id = pRas, name = pRas, affected by kineticLaw
	xdot(51) = (1/(compartment_Cell))*((-1.0 * reaction_v16a) + ( 1.0 * reaction_v16a) + ( 1.0 * reaction_v7) + (-1.0 * reaction_v8b) + (-1.0 * reaction_v9a) + ( 1.0 * reaction_v9a));
...
% Species:   id = null, name = null, affected by kineticLaw
	xdot(53) = (1/(compartment_Cell))*(( 1.0 * reaction_v15c) + ( 1.0 * reaction_v26b) + ( 1.0 * reaction_v33b) + (-1.0 * reaction_v37b) + ( 1.0 * reaction_v37c) + ( 1.0 * reaction_v40) + ( 1.0 * reaction_v41) + (-1.0 * reaction_v8a));
end
...
function z=Function_for_Ras_dephosphorylation__Ras_Gap_modifier(Kcat8b,Km8b,RasGap,Cell,pRas), z=(Kcat8b*RasGap*pRas/(pRas+Km8b)/Cell);end
