...
%
% is http://identifiers.org/biomodels.db/MODEL8716051482
% is http://identifiers.org/biomodels.db/BIOMD0000000179
...
% Warning parameter i1 is not constant, it should be controlled by a Rule and/or events
	global_par_i1=0.0;
...
% assignmentRule: variable = i2
	global_par_i2=piecewise(1, (t >= 50) && (t <= 100), 0);
...
% Species:   id = P2_prime, name = P2_prime, affected by kineticLaw
	xdot(6) = ( 1.0 * reaction_React13) + ( 1.0 * reaction_React14) + (-1.0 * reaction_React15);
