...
%
% Model name = Zatorsky2006_p53_Model5
%
% is http://identifiers.org/biomodels.db/MODEL0076384106
% is http://identifiers.org/biomodels.db/BIOMD0000000156
...
% Parameter:   id =  alpha_xy, name = alpha_xy
	global_par_alpha_xy=3.7;
% Parameter:   id =  beta_y, name = beta_y
	global_par_beta_y=1.5;
% Parameter:   id =  alpha_y, name = alpha_y
	global_par_alpha_y=0.9;
% Parameter:   id =  alpha_0, name = alpha_0
	global_par_alpha_0=1.1;
% Parameter:   id =  Theta, name = Theta
	global_par_Theta=2.0;

% Reaction: id = R1, name = p53 production
	reaction_R1=compartment_compartment*global_par_Theta*x(1)*global_par_psi;
