...
%
% Model name = Musante2017 - Switching behaviour of PP2A inhibition by ARPP-16 - mutual inhibitions and PKA inhibits MAST3 and dominant negative effect
%
% is http://identifiers.org/biomodels.db/MODEL1707020002
% is http://identifiers.org/biomodels.db/BIOMD0000000645
...
%Initial conditions vector
	...
	x0(8) = 0.199999999999989;
	x0(9) = 0.0;
	x0(10) = 0.0;
	x0(1) = 9.80000000000001;
	x0(2) = 0.199999999999989;
	x0(3) = 0.0;
	x0(4) = 0.0;
	x0(5) = 11.8484545454546;
	x0(6) = 1.98767182679162;
...
% Parameter:   id =  kpka, name = kpka
	global_par_kpka=0.097;
...
% Parameter:   id =  ModelValue_20, name = Initial for KA
	global_par_ModelValue_20=10.0;
...
% Parameter:   id =  ModelValue_25, name = Initial for a
	global_par_ModelValue_25=0.37526;
% Parameter:   id =  ModelValue_28, name = Initial for b
	global_par_ModelValue_28=2.36;
% Parameter:   id =  ModelValue_22, name = Initial for cAMP
	global_par_ModelValue_22=0.0;
% Parameter:   id =  ModelValue_21, name = Initial for k46
	global_par_ModelValue_21=0.02335;
% Parameter:   id =  ModelValue_17, name = Initial for k88
	global_par_ModelValue_17=0.01865;
% Parameter:   id =  ModelValue_4, name = Initial for kass
	global_par_ModelValue_4=3.3;
% Parameter:   id =  ModelValue_18, name = Initial for kcamp
	global_par_ModelValue_18=0.7;
...
% Parameter:   id =  ModelValue_33, name = Initial for kppx
	global_par_ModelValue_33=0.05;
% Parameter:   id =  ModelValue_19, name = Initial for n
	global_par_ModelValue_19=2.0;
% Parameter:   id =  ModelValue_13, name = Initial for pp1
	global_par_ModelValue_13=5.0;
% Parameter:   id =  ModelValue_29, name = Initial for r
	global_par_ModelValue_29=1.2;
% assignmentRule: variable = kmpp2a
	global_par_kmpp2a=(global_par_ModelValue_5+global_par_ModelValue_6)*(1+global_par_v*x(2)/global_par_ModelValue_0)/global_par_ModelValue_4;
...
x(4) = x(10);
	...
	xdot=zeros(10,1);
	% rateRule: variable = A46
	xdot(7) = global_par_ModelValue_8*x(3)*(global_par_ARPPtot-x(1))/(global_par_ModelValue_9+global_par_ModelValue_25*x(2)/global_par_ModelValue_0+global_par_ModelValue_29*(global_par_ModelValue_2-x(3))/global_par_ModelValue_2+(global_par_ARPPtot-x(1)))-global_par_ModelValue_6*x(6);
	% rateRule: variable = A88
	xdot(8) = global_par_ModelValue_10*x(4)*(global_par_ARPPtot-x(2))/(global_par_ModelValue_11+global_par_ModelValue_28*x(1)/global_par_ModelValue_0+global_par_ARPPtot-x(2))-global_par_ModelValue_12*global_par_ModelValue_13*x(2)/(global_par_ModelValue_14+x(2));
	% rateRule: variable = M
	xdot(9) = global_par_ModelValue_33*(global_par_ModelValue_2-x(3))-global_par_ModelValue_17*x(2)*x(3)-global_par_kpka*x(4)*x(3);
	% rateRule: variable = PKA
	xdot(10) = global_par_ModelValue_18*(global_par_ModelValue_3-x(4))*global_par_ModelValue_22^global_par_ModelValue_19/(global_par_ModelValue_20^global_par_ModelValue_19+global_par_ModelValue_22^global_par_ModelValue_19)-global_par_ModelValue_21*x(1)*x(4);
