...
function z=function_function_3(S,M,k,ko), z=(k*ko*M*S);endfunction

function z=function_function_7(M,k,ko), z=(k*ko*M);endfunction

function z=function_function_6(Substrate,k,Mod1,Mod,k1,kb), z=(Substrate*(k*Mod1+k1*Mod+kb));endfunction

function z=function_function_2(k,ko,sub,sub2), z=(k*ko*sub*sub2);endfunction

function z=function_function_1(V,Mod,k,Ex,In), z=((36*pi)^(1/3)*V^(2/3)*Mod*k*(Ex-In));endfunction

function z=function_function_8(V,k,Sub), z=((36*pi)^(1/3)*V^(2/3)*k*Sub);endfunction

function z=function_function_4(ko,Mod,k,V,Sub), z=(ko*Mod*k*(36*pi)^(1/3)*V^(2/3)*Sub);endfunction

function z=function_function_5(V,Mod,Vmax,Sub,Km), z=((36*pi)^(1/3)*V^(2/3)*Mod*Vmax*Sub/(Km+Sub));endfunction
...
# Reaction: id = reaction_1, name = v1
	...
	reaction_reaction_1=function_function_1(compartment_compartment_3, x(6)/compartment_compartment_3, global_par_parameter_33, x(1)/compartment_compartment_2, x(10)/compartment_compartment_4);
# Reaction: id = reaction_4, name = v4


	reaction_reaction_4=compartment_compartment_3*function_function_3(x(4)/compartment_compartment_3, x(10)/compartment_compartment_4, global_par_parameter_26, global_par_parameter_28);
...
# Reaction: id = reaction_9, name = v8
	...
	reaction_reaction_9=compartment_compartment_4*function_function_2(global_par_parameter_39, global_par_parameter_22, x(10)/compartment_compartment_4, x(12)/compartment_compartment_4);
# Reaction: id = reaction_10, name = v10


	reaction_reaction_10=function_function_4(global_par_parameter_38, x(2)/compartment_compartment_3, global_par_parameter_36, compartment_compartment_1, x(9)/compartment_compartment_4);
# Reaction: id = reaction_13, name = v12


	reaction_reaction_13=compartment_compartment_3*function_function_7(x(10)/compartment_compartment_4, global_par_parameter_2, global_par_parameter_25);
...
# Reaction: id = reaction_15, name = v14
	...
	reaction_reaction_15=function_function_5(compartment_compartment_3, x(7)/compartment_compartment_3, global_par_parameter_34, x(10)/compartment_compartment_4, global_par_parameter_35);
# Reaction: id = reaction_16, name = v6


	reaction_reaction_16=compartment_compartment_3*function_function_6(x(6)/compartment_compartment_3, global_par_parameter_29, x(10)/compartment_compartment_4, x(3)/compartment_compartment_3, global_par_parameter_30, global_par_parameter_31);
...
# Reaction: id = reaction_18, name = v11
	...
	reaction_reaction_18=function_function_8(compartment_compartment_1, global_par_parameter_37, x(8)/compartment_compartment_1);
	xdot=zeros(12,1);
