...
%
% Model name = Izhikevich2004_SpikingNeurons_inhibitionInducedSpiking
%
% is http://identifiers.org/biomodels.db/MODEL5575430623
% is http://identifiers.org/biomodels.db/BIOMD0000000129
...
%Event: id=event_0000002
	event_event_0000002=(time >= 50) && (time <= 250);
