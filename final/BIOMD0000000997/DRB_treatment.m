...
%
% Model name = Strasen2018 – TGFβ SMAD Signalling – DRB treatment
%
%
...
% Parameter:   id =  TGFb_LIGAND_Dose, name = TGFb_LIGAND_Dose
	global_par_TGFb_LIGAND_Dose=100.0;
% Parameter:   id =  NUC_CYT_SMAD2, name = NUC/CYT SMAD2
% Parameter:   id =  DRB, name = DRB
	global_par_DRB=1.0;
% Parameter:   id =  offset_DRB, name = offset_DRB
	global_par_offset_DRB=0.0286195;
% Parameter:   id =  scale_DRB, name = scale_DRB
	global_par_scale_DRB=1.0205;
% assignmentRule: variable = NUC_CYT_SMAD2
	global_par_NUC_CYT_SMAD2=global_par_offset_DRB+global_par_scale_DRB*(2*x(20)+x(22)+x(19)+3*x(21))/(2*x(14)+x(12)+x(11)+3*x(15));
...
% Reaction: id = reaction31, name = reaction31
	reaction_reaction31=compartment_nuc*Function_for_reaction31(global_par_index_kf_homotrimer, global_par_kf_trimmer, x(19));
...
% Reaction: id = reaction44, name = reaction44
	reaction_reaction44=compartment_cyt*Function_for_reaction44(global_par_S2_export_from_nuc, global_par_S2_import_to_nuc, global_par_S2_total, global_par_kdeg_S2);

% Reaction: id = reaction45, name = reaction45
	reaction_reaction45=compartment_cyt*Function_for_reaction45(global_par_S4_export_from_nuc, global_par_S4_import_to_nuc, global_par_S4_total, global_par_kdeg_S4);

% Reaction: id = reaction46, name = reaction46
	reaction_reaction46=compartment_cyt*Function_for_reaction46(global_par_R1_total, global_par_index_k_out_1_relative_speed, global_par_k_in_1, global_par_kdeg_R1);

% Reaction: id = reaction47, name = reaction47
	reaction_reaction47=compartment_cyt*Function_for_reaction47(global_par_R2_total, global_par_index_k_out_2_relative_speed, global_par_k_in_2, global_par_kdeg_R2);

% Reaction: id = reaction50, name = reaction50
	reaction_reaction50=compartment_nuc*Function_for_reaction50_1_0(global_par_DRB, global_par_K_mran, global_par_hill_fact1, global_par_k_induced_S7_production, global_par_mRNA_prod, x(20));
...
function z=Function_for_reaction46(R1_total,index_k_out_1_relative_speed,k_in_1,kdeg_R1), z=(R1_total*k_in_1*kdeg_R1^2/(k_in_1*kdeg_R1+kdeg_R1^2+index_k_out_1_relative_speed*k_in_1*kdeg_R1));end
...
function z=Function_for_reaction44(S2_export_from_nuc,S2_import_to_nuc,S2_total,kdeg_S2), z=(S2_total*(S2_import_to_nuc*kdeg_S2+S2_export_from_nuc*kdeg_S2+kdeg_S2^2)/(2*S2_import_to_nuc+S2_export_from_nuc+kdeg_S2));end
...
function z=Function_for_reaction31(index_kf_homotrimer,kf_trimmer,pS2_n), z=(index_kf_homotrimer*kf_trimmer*pS2_n^3);end
...
function z=Function_for_reaction47(R2_total,index_k_out_2_relative_speed,k_in_2,kdeg_R2), z=(R2_total*k_in_2*kdeg_R2^2/(k_in_2*kdeg_R2+kdeg_R2^2+index_k_out_2_relative_speed*k_in_2*kdeg_R2));end
...
function z=Function_for_reaction45(S4_export_from_nuc,S4_import_to_nuc,S4_total,kdeg_S4), z=(S4_total*(S4_import_to_nuc*kdeg_S4+S4_export_from_nuc*kdeg_S4+kdeg_S4^2)/(2*S4_import_to_nuc+S4_export_from_nuc+kdeg_S4));end
...
function z=Function_for_reaction50_1_0(DRB,K_mran,hill_fact1,k_induced_S7_production,mRNA_prod,pS2_pS2_S4_n), z=(DRB*(mRNA_prod+k_induced_S7_production*pS2_pS2_S4_n^hill_fact1/(K_mran^hill_fact1+pS2_pS2_S4_n^hill_fact1)));end
