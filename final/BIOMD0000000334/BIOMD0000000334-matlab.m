...
%
% Model name = Bungay2003_Thrombin_Generation
%
% is http://identifiers.org/biomodels.db/MODEL9852292468
% is http://identifiers.org/biomodels.db/BIOMD0000000334
% isDescribedBy http://identifiers.org/pubmed/12974500
%
...
% Species:   id = Xa_f, name = Xa_f, affected by kineticLaw
	xdot(23) = (1/(compartment_compartment))*((-1.0 * reaction_LB12) + (-1.0 * reaction_R20) + (-1.0 * reaction_R23));
...
% Species:   id = IIa_f, name = IIa_f, affected by kineticLaw
	xdot(48) = (1/(compartment_compartment))*((-1.0 * reaction_R11) + ( 1.0 * reaction_R11b) + (-1.0 * reaction_R12) + ( 1.0 * reaction_R12b) + ( 1.0 * reaction_R15b) + (-1.0 * reaction_R17) + ( 1.0 * reaction_R17b) + (-1.0 * reaction_R24) + (-1.0 * reaction_R27));
...
% Species:   id = XIa_l, name = XIa_l, affected by kineticLaw
	xdot(55) = (1/(compartment_compartment))*(( 1.0 * reaction_R17b) + (-1.0 * reaction_R31) + ( 1.0 * reaction_R31b));
...
% Species:   id = AT_f, name = AT_f, affected by kineticLaw
	xdot(59) = (1/(compartment_compartment))*((-1.0 * reaction_R22) + (-1.0 * reaction_R23) + (-1.0 * reaction_R24) + (-1.0 * reaction_R29));
