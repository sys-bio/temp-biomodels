...
%
% Model name = Izhikevich2004_SpikingNeurons_Class1Excitable
%
% is http://identifiers.org/biomodels.db/MODEL7210876282
% is http://identifiers.org/biomodels.db/BIOMD0000000141
...
% assignmentRule: variable = i
	global_par_i=piecewise(0, time < 30, 0.075*(time-30));
% rateRule: variable = v
global_par_v = x(1);
% rateRule: variable = u
global_par_u = x(2);
