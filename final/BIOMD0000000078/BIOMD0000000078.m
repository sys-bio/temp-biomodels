...
%
% Model name = Leloup2003_CircClock_LD
%
% is http://identifiers.org/biomodels.db/MODEL4108701438
% is http://identifiers.org/biomodels.db/BIOMD0000000078
...
% Parameter:   id =  parameter_0000081, name = LD
% Parameter:   id =  parameter_0000082, name = vsp
% assignmentRule: variable = parameter_0000082
	global_par_parameter_0000082=1.5+(1.8-1.5)*global_par_parameter_0000081;
...
% Reaction: id = reaction_9, name = Mp synthesis	% Local Parameter:   id =  n, name = n
	...
	reaction_reaction_9=compartment_cell*function_3(global_par_parameter_0000082, x(4), reaction_reaction_9_n, reaction_reaction_9_K);
...
function z=functionDefinition_0000005(length), z=(ceil(sin(pi*time/length+0.001)/2));end
