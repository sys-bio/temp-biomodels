...
%
% Model name = Fridlyand2010_GlucoseSensitivity_A
%
% is http://identifiers.org/biomodels.db/MODEL1108090000
% is http://identifiers.org/biomodels.db/BIOMD0000000348
...
% Parameter:   id =  CaR, name = CaR
	global_par_CaR=0.09;
% Parameter:   id =  Cmit, name = Cmit
	global_par_Cmit=5200.0;
...
% Parameter:   id =  hp, name = hp
	global_par_hp=8.0;
% Parameter:   id =  kACa, name = kACa
	global_par_kACa=0.25;
...
% assignmentRule: variable = Cac
	global_par_Cac=global_par_CaR+global_par_kACa*(x(3)*1/global_par_ADP)^global_par_hCa*1/(global_par_KAD^global_par_hCa+(x(3)*1/global_par_ADP)^global_par_hCa);
...
x(7) = x(14);
% assignmentRule: variable = ID
	global_par_ID=x(3)/global_par_ADP;
	...
	% rateRule: variable = Vm
	xdot(13) = (global_par_Jhres+(-global_par_Jph)+(-global_par_Jhl)+(-2*global_par_Juni)+(-global_par_JNCa))*global_par_F*1/global_par_Cmit;
	% rateRule: variable = Cam
