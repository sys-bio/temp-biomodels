...
% Parameter:   id =  A, name = A
	global_par_A=1242.79795390575;
% Parameter:   id =  B, name = B
% Parameter:   id =  d, name = d
	global_par_d=-0.844820241465918;
% Parameter:   id =  c, name = c
	global_par_c=-0.197523878546384;
% Parameter:   id =  Summary_flux_to_RBC, name = Summary flux to RBC
% Parameter:   id =  K, name = K
	global_par_K=0.0445312568342959;
% Parameter:   id =  ModelValue_1, name = Initial for A
	global_par_ModelValue_1=1242.79795390575;
% Parameter:   id =  ModelValue_2, name = Initial for B
	global_par_ModelValue_2=1242.79795390575;
% Parameter:   id =  ModelValue_4, name = Initial for c
	global_par_ModelValue_4=-0.197523878546384;
% Parameter:   id =  ModelValue_3, name = Initial for d
	global_par_ModelValue_3=-0.844820241465918;
...
% assignmentRule: variable = Mpl
	global_par_Mpl=global_par_ModelValue_1*exp(global_par_ModelValue_4*time)-global_par_ModelValue_2*exp(global_par_ModelValue_3*time);

% Reaction: id = Vout, name = Vout
	reaction_Vout=compartment_RBC*global_par_K*x(1);

% Reaction: id = Vin, name = Vin
	reaction_Vin=compartment_RBC*Diffusion_to_RBC(global_par_K, global_par_Mpl);
