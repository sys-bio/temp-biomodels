...
%
% Model name = PetelenzKuehn_osmoadaptation_fps1D1
%
% is http://identifiers.org/biomodels.db/MODEL1204190005
% is http://identifiers.org/biomodels.db/BIOMD0000000607
...
%Initial conditions vector
	...
	x0(3) = 1.10168;
	x0(4) = 0.142316;
	x0(5) = 7.62872999999999E-4;
	x0(6) = 0.021466;
	x0(7) = 1.78949E-5;
	x0(8) = 0.0130693;
	x0(9) = 0.0574674999999999;
	x0(10) = 0.00299992;
	x0(11) = 7.77094E-14;
	x0(12) = 13.5385;
	x0(13) = 0.411959;
...
% Reaction: id = v16r, name = v16r
	reaction_v16r=compartment_intra*global_par_kv16r_1VARIABLE*x(14);
...
% Species:   id = trehalose, name = trehalose_i, affected by kineticLaw
...
function z=Function_for_v22(), z=(0);end
