...
%
% Model name = Strasen2018 – TGFβ SMAD Signalling – Restimulation with 5pM TGFβ at 3hr
%
%
...
%Event: id=Ligand1_start_wash
	event_Ligand1_start_wash=(time > 179) && (time < 179.5);
...
%Event: id=Ligand2_injection
	event_Ligand2_injection=time == 180.1;
...
%Event: id=Ligand1_stop_wash
	event_Ligand1_stop_wash=time >= 180;
