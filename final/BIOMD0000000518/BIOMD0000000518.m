...
% Parameter:   id =  q03, name = q03
	global_par_q03=0.093515315273862;
% Parameter:   id =  K03, name = K03
	global_par_K03=1.5709821429;
% Parameter:   id =  d3, name = d3
	global_par_d3=0.0379622536021846;
% Parameter:   id =  K0X, name = K0X
	global_par_K0X=1.5709821429;
% Parameter:   id =  K1X, name = K1X
	global_par_K1X=1.5709821429;
% Parameter:   id =  K2X, name = K2X
	global_par_K2X=1.5709821429;
