...
%
% Model name = PetelenzKuehn_osmoadaptation_pfk2627D
%
% is http://identifiers.org/biomodels.db/MODEL1204190001
% is http://identifiers.org/biomodels.db/BIOMD0000000604
...
%Initial conditions vector
	x0=zeros(29,1);
	x0(1) = 0.0964061999999997;
	x0(2) = 0.561972;
	x0(3) = 2.65015;
	x0(4) = 2.45092;
	x0(5) = 0.00516765000000001;
	x0(6) = 0.150231;
	x0(7) = 1.37848E-6;
	x0(8) = 0.101303;
	x0(9) = 0.0470323;
	x0(10) = 0.0140762;
	x0(11) = 0.538047999999998;
	x0(12) = 7.18007;
	x0(13) = 0.446281;
	x0(14) = 0.00876526;
	x0(15) = 0.0;
...
% Reaction: id = v2, name = v2
	reaction_v2=compartment_intra*Henri_Michaelis_Menten__irreversible__2__1(x(3), global_par_kv2_1, global_par_kv2_2);
...
% Reaction: id = v7, name = v7
	reaction_v7=compartment_intra*Henri_Michaelis_Menten__irreversible__3__1(global_par_kv7_1, global_par_kv7_2, x(8));

% Reaction: id = v8, name = v8
	reaction_v8=compartment_intra*Henri_Michaelis_Menten__irreversible__4__1(global_par_kv8_1, global_par_kv8_2, x(10));

% Reaction: id = v9, name = v9
	reaction_v9=compartment_intra*Henri_Michaelis_Menten__irreversible__5__1(global_par_kv9_1, global_par_kv9_2, x(10));
...
% Species:   id = G6P, name = G6P, affected by kineticLaw
	xdot(4) = (1/(compartment_intra))*((-1.0 * reaction_v14) + ( 1.0 * reaction_v2) + (-2.0 * reaction_v3) + (-1.0 * reaction_v4) + (-1.0 * reaction_vVG6P));
...
% Species:   id = Pfk2627a, name = Pfk2627a, affected by kineticLaw
	xdot(15) = (1/(compartment_intra))*((-1.0 * reaction_vVPfk2627a));
	
% Species:   id = Pfk2627i, name = Pfk2627i, affected by kineticLaw
	xdot(16) = (1/(compartment_intra))*((-1.0 * reaction_vVPfk2627i));
...
function z=Henri_Michaelis_Menten__irreversible__2__1(glucose_i,kv2_1,kv2_2), z=(kv2_1*glucose_i/(kv2_2+glucose_i));end

function z=Henri_Michaelis_Menten__irreversible__3__1(kv7_1,kv7_2,trioseP), z=(kv7_1*trioseP/(kv7_2+trioseP));end

function z=Henri_Michaelis_Menten__irreversible__4__1(kv8_1,kv8_2,pyruvate), z=(kv8_1*pyruvate/(kv8_2+pyruvate));end

function z=Henri_Michaelis_Menten__irreversible__5__1(kv9_1,kv9_2,pyruvate), z=(kv9_1*pyruvate/(kv9_2+pyruvate));end
