...
%
% Model name = Yamada2003_JAK_STAT_SOCS1_knockout
%
% is http://identifiers.org/biomodels.db/MODEL4883413839
% is http://identifiers.org/biomodels.db/BIOMD0000000094
...
% Reaction: id = v32, name = IFNRJ2 dephosphorylation	% Local Parameter:   id =  kf, name = kf
	...
	reaction_v32=compartment_nucleus*reaction_v32_kf*x(27);
...
% Species:   id = mRNAn, name = mRNAn, affected by kineticLaw
	xdot(23) = (1/(compartment_nucleus))*((-1.0 * reaction_v25));
