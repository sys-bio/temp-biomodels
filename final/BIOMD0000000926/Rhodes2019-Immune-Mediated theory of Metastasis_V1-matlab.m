...
%
% Model name = Rhodes2019 - Immune-Mediated theory of Metastasis
%
% isDescribedBy http://identifiers.org/doi/10.1101/565531
% is http://identifiers.org/biomodels.db/MODEL1910020003
% is http://identifiers.org/biomodels.db/BIOMD0000000926
%
...
% assignmentRule: variable = sigma_1
	global_par_sigma_1=((tanh(6*(x(3)-(global_par_upC_1+global_par_lowC_1)/2)/(global_par_upC_1-global_par_lowC_1))-tanh((-3)*(global_par_upC_1+global_par_lowC_1)/(global_par_upC_1-global_par_lowC_1)))*global_par_maxC_1/2+global_par_minC_1)*(1-tanh(6*(x(2)-(global_par_upD_1+global_par_lowD_1)/2)/(global_par_upD_1-global_par_lowD_1)))/(1-tanh((-3)*(global_par_upD_1+global_par_lowD_1)/(global_par_upD_1-global_par_lowD_1)));
...
% assignmentRule: variable = sigma_2
	global_par_sigma_2=((tanh(6*(x(5)-(global_par_upC_2+global_par_lowC_2)/2)/(global_par_upC_2-global_par_lowC_2))-tanh((-3)*(global_par_upC_2+global_par_lowC_2)/(global_par_upC_2-global_par_lowC_2)))*global_par_maxC_2/2+global_par_minC_2)*(1-tanh(6*(x(6)-(global_par_upD_2+global_par_lowD_2)/2)/(global_par_upD_2-global_par_lowD_2)))/(1-tanh((-3)*(global_par_upD_2+global_par_lowD_2)/(global_par_upD_2-global_par_lowD_2)));
