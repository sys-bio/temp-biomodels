...
%
% Model name = Liebal2012 - B.subtilis sigB proteolysis model
%
% is http://identifiers.org/biomodels.db/MODEL1302080000
% is http://identifiers.org/biomodels.db/BIOMD0000000460
...
% Parameter:   id =  kbd, name = kbd
	global_par_kbd=5.8E-9;
% Parameter:   id =  kbs, name = kbs
	global_par_kbs=100.0;
% Parameter:   id =  kbx, name = kbx
	global_par_kbx=8.4E-5;
% Parameter:   id =  kxd, name = kxd
	global_par_kxd=1.2E-13;
% Parameter:   id =  kxs, name = kxs
	global_par_kxs=2.0E-6;
% Parameter:   id =  kzd, name = kzd
	global_par_kzd=0.052;
% Parameter:   id =  kzs, name = kzs
	global_par_kzs=1.7E-6;

% Reaction: id = v1, name = v1
	reaction_v1=const_species_IPTG*global_par_kbs-x(1)*(global_par_kbd+global_par_kbx*x(3));

% Reaction: id = v2, name = v2
	reaction_v2=-global_par_kzd*x(2)+global_par_kzs*x(1);
