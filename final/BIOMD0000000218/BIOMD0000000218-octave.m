...
%
% Model name = Singh2006_TCA_mtu_model2
%
% is http://identifiers.org/biomodels.db/MODEL8584468482
% is http://identifiers.org/biomodels.db/BIOMD0000000218
...
% Species:   id = akg, name = akg, affected by kineticLaw
	xdot(6) = (1/(compartment_cell))*(( 1.0 * reaction_ICD1) + ( 1.0 * reaction_ICD2) + (-1.0 * reaction_KGD) + (-1.0 * reaction_SYN));
...
% Species:   id = sca, name = sca, affected by kineticLaw
	xdot(9) = (1/(compartment_cell))*((-1.0 * reaction_ScAS));
