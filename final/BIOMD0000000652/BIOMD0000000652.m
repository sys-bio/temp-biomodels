...
% Species:   id = PI3K, name = PI3K, affected by kineticLaw
	xdot(17) = (1/(compartment_Cell))*((-1.0 * reaction_v19a) + (-1.0 * reaction_v19b));
...
% Species:   id = pPI3K, name = pPI3K, affected by kineticLaw
	xdot(47) = (1/(compartment_Cell))*(( 1.0 * reaction_v19a) + ( 1.0 * reaction_v19b) + (-1.0 * reaction_v20) + ( 1.0 * reaction_v20));
