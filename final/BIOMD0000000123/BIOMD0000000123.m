...
%
% Model name = Fisher2006_NFAT_Activation
%
% is http://identifiers.org/biomodels.db/MODEL2977131407
% is http://identifiers.org/biomodels.db/BIOMD0000000123
...
% Species:   id = Ca_Nuc, name = Calcium in Nucleus, affected by kineticLaw
	xdot(1) = (1/(compartment_nucleus))*((-3.0 * reaction_R14) + ( 1.0 * reaction_R16));
	
% Species:   id = Ca_Cyt, name = Calcium in Cytosol, affected by kineticLaw
	xdot(2) = (1/(compartment_cytosol))*((-3.0 * reaction_R13) + (-1.0 * reaction_R16));
