...
%
% Model name = Tang2020 - Estimation of transmission risk of COVID-19 and impact of public health interventions
%
% is http://identifiers.org/biomodels.db/MODEL2011020001
% is http://identifiers.org/biomodels.db/BIOMD0000000971
%
...
% Parameter:   id =  q_lockdown, name = q_lockdown
	global_par_q_lockdown=1.8887E-7;
...
%Event: id=Lockdown
	event_Lockdown=time > 9;

	if(event_Lockdown) 
		global_par_c=global_par_c_lockdown;
		global_par_q=global_par_q_lockdown;
	end
