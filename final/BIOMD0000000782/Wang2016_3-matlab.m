...
%
% Model name = Wang2016/3 - oncolytic efficacy of M1 virus-SN model
%
...
% isDerivedFrom http://identifiers.org/biomodels.db/BIOMD0000000781
% isDerivedFrom http://identifiers.org/biomodels.db/BIOMD0000000780
% isDerivedFrom http://identifiers.org/biomodels.db/MODEL1908060002
% isDescribedBy http://identifiers.org/biomodels.db/MODEL1908060001
% isDescribedBy http://identifiers.org/biomodels.db/BIOMD0000000781
% isDescribedBy http://identifiers.org/biomodels.db/BIOMD0000000780
% isDescribedBy http://identifiers.org/biomodels.db/MODEL1908060002
% isDescribedBy http://identifiers.org/pubmed/26976483
% is http://identifiers.org/biomodels.db/MODEL1908060003
% is http://identifiers.org/biomodels.db/BIOMD0000000782
%
...
% Reaction: id = nutrient_consumption_N, name = nutrient consumption
...
% Species:   id = S, name = S, affected by kineticLaw
	xdot(1) = (1/(compartment_tme))*(( 1.0 * reaction_nutrient_supply) + (-1.0 * reaction_nutrient_decay) + (-1.0 * reaction_nutrient_consumption_N));
