...
%
% Model name = Valero2016 - Ascorbate-Glutathione cycle in chloroplasts under light/dark conditions
%
% is http://identifiers.org/biomodels.db/MODEL1503250002
% is http://identifiers.org/biomodels.db/BIOMD0000000589
% isDescribedBy http://identifiers.org/pubmed/26797294
%
...
% Parameter:   id =  k11, name = k11
	global_par_k11=30000.0;
% Parameter:   id =  a1, name = a1
	global_par_a1=4022883.36970378;
...
% Parameter:   id =  a2, name = a2
	global_par_a2=3895707.9713;
% Parameter:   id =  incr, name = incr
	global_par_incr=0.25;
% Parameter:   id =  a3, name = a3
	global_par_a3=4461050.65837037;
% Parameter:   id =  a4, name = a4
	global_par_a4=4143378.61177046;
% Parameter:   id =  a5, name = a5
	global_par_a5=3793894.04866379;
% Parameter:   id =  a6, name = a6
	global_par_a6=4190686.19853351;
% Parameter:   id =  a7, name = a7
	global_par_a7=3699605.44223432;
% Parameter:   id =  a8, name = a8
	global_par_a8=3867960.7991362;
% Parameter:   id =  a9, name = a9
	global_par_a9=4156529.25532777;
% Parameter:   id =  a10, name = a10
	global_par_a10=3632875.10036025;
% Parameter:   id =  a11, name = a11
	global_par_a11=3901158.19650237;
% Parameter:   id =  a12, name = a12
	global_par_a12=3938901.52464155;
% Parameter:   id =  a13, name = a13
	global_par_a13=3614615.74758869;
% Parameter:   id =  a14, name = a14
	global_par_a14=3540932.60352965;
% Parameter:   id =  a0, name = a0
	global_par_a0=4431968.60712487;
...
% Parameter:   id =  a15, name = a15
	global_par_a15=4445756.61385898;
% Parameter:   id =  min, name = min
	global_par_min=3500000.0;
% Parameter:   id =  max, name = max
	global_par_max=4500000.0;
