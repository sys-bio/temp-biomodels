...
% assignmentRule: variable = mG
	global_par_mG=global_par_muG+global_par_v;
% assignmentRule: variable = R0
	global_par_R0=global_par_f*global_par_v*global_par_lambdaE*global_par_gamma/(global_par_mG*global_par_mA*global_par_muE);

% Reaction: id = r1a, name = r1a: self-antigen uptake
	reaction_r1a=global_par_v*x(4);

% Reaction: id = r1b, name = r1b: pAPC maturation
	reaction_r1b=global_par_f*global_par_v*x(4);
