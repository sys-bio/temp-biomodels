...
# Parameter:   id =  kbinSOCS3OSMR, name = kbinSOCS3OSMR
	global_par_kbinSOCS3OSMR=0.0050;
...
# Parameter:   id =  kcyt2nucSTAT3, name = kcyt2nucSTAT3
	global_par_kcyt2nucSTAT3=0.0010;
...
# Parameter:   id =  knuc2cytSTAT3, name = knuc2cytSTAT3
	global_par_knuc2cytSTAT3=0.0010;
...
# Parameter:   id =  ksyncJunmRNAcJun, name = ksyncJunmRNAcJun
	global_par_ksyncJunmRNAcJun=0.0050;
# Parameter:   id =  ksynDUSP16, name = ksynDUSP16
	global_par_ksynDUSP16=0.0050;
...
# Parameter:   id =  ksynMMP1mRNA, name = ksynMMP1mRNA
	global_par_ksynMMP1mRNA=0.0050;
...
# Parameter:   id =  ksynSOCS3, name = ksynSOCS3
	global_par_ksynSOCS3=0.0010;
# Parameter:   id =  ksynSOCS3mRNA, name = ksynSOCS3mRNA
	global_par_ksynSOCS3mRNA=0.0060;
...
# Species:   id = Source, name = Source, constant
	const_species_Source=1.0;
# Species:   id = Sink, name = Sink, constant
	const_species_Sink=1.0;
	xdot=zeros(73,1);
