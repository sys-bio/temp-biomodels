...
%
% Model name = Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_USEQ)
%
% is http://identifiers.org/biomodels.db/MODEL1204280020
% is http://identifiers.org/biomodels.db/BIOMD0000000430
...
% Reaction: id = reaction_9, name = 23	% Local Parameter:   id =  k1, name = k1
	reaction_reaction_9_k1=0.0;
	% Local Parameter:   id =  k2, name = k2
	reaction_reaction_9_k2=0.0;
...
% Reaction: id = reaction_18, name = 14_P2	% Local Parameter:   id =  k1, name = k1
	reaction_reaction_18_k1=0.0;
	% Local Parameter:   id =  k2, name = k2
	reaction_reaction_18_k2=0.0;
...
% Reaction: id = reaction_28, name = 14_P1	% Local Parameter:   id =  k1, name = k1
	reaction_reaction_28_k1=0.0;
	% Local Parameter:   id =  k2, name = k2
	reaction_reaction_28_k2=0.0;
...
% Reaction: id = reaction_24, name = 5	% Local Parameter:   id =  k1, name = k1
	reaction_reaction_24_k1=0.0;
	% Local Parameter:   id =  k2, name = k2
	reaction_reaction_24_k2=0.0;
...
% Species:   id = species_1, name = MK, affected by kineticLaw
	xdot(1) = (1/(compartment_compartment_1))*((-1.0 * reaction_reaction_1) + ( 1.0 * reaction_reaction_8) + ( 1.0 * reaction_reaction_9));
...
% Species:   id = species_7, name = MKK, affected by kineticLaw
	xdot(7) = (1/(compartment_compartment_1))*((-1.0 * reaction_reaction_10) + ( 1.0 * reaction_reaction_17) + ( 1.0 * reaction_reaction_18) + ( 1.0 * reaction_reaction_27) + ( 1.0 * reaction_reaction_28));
...
% Species:   id = species_13, name = P2, affected by kineticLaw
	xdot(13) = (1/(compartment_compartment_1))*((-1.0 * reaction_reaction_5) + ( 1.0 * reaction_reaction_6) + (-1.0 * reaction_reaction_7) + ( 1.0 * reaction_reaction_8) + ( 1.0 * reaction_reaction_9) + (-1.0 * reaction_reaction_14) + ( 1.0 * reaction_reaction_15) + (-1.0 * reaction_reaction_16) + ( 1.0 * reaction_reaction_17) + ( 1.0 * reaction_reaction_18));
...
% Species:   id = species_15, name = MKK_P2, affected by kineticLaw
	xdot(15) = (1/(compartment_compartment_1))*((-1.0 * reaction_reaction_18));
	
% Species:   id = species_16, name = MKKK, affected by kineticLaw
	xdot(16) = (1/(compartment_compartment_1))*((-1.0 * reaction_reaction_19) + ( 1.0 * reaction_reaction_22) + ( 1.0 * reaction_reaction_24));
...
% Species:   id = species_20, name = P1, affected by kineticLaw
	xdot(20) = (1/(compartment_compartment_1))*((-1.0 * reaction_reaction_21) + ( 1.0 * reaction_reaction_22) + (-1.0 * reaction_reaction_23) + ( 1.0 * reaction_reaction_25) + (-1.0 * reaction_reaction_26) + ( 1.0 * reaction_reaction_27) + ( 1.0 * reaction_reaction_28) + ( 1.0 * reaction_reaction_24));
...
% Species:   id = species_23, name = MK_P2, affected by kineticLaw
	xdot(23) = (1/(compartment_compartment_1))*((-1.0 * reaction_reaction_9));
...
% Species:   id = species_26, name = MKK_P1, affected by kineticLaw
	xdot(26) = (1/(compartment_compartment_1))*((-1.0 * reaction_reaction_28));
	
% Species:   id = species_27, name = MKKK_P1, affected by kineticLaw
	xdot(27) = (1/(compartment_compartment_1))*((-1.0 * reaction_reaction_24));
end
