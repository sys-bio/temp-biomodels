...
%
% Model name = Izhikevich2004_SpikingNeurons_thresholdVariability
%
% is http://identifiers.org/biomodels.db/MODEL5574885679
% is http://identifiers.org/biomodels.db/BIOMD0000000136
...
%Event: id=event_0000002
	event_event_0000002=((time > 10) && (time < 15)) || ((time > 80) && (time < 85));
...
%Event: id=event_0000003
	event_event_0000003=(time > 70) && (time < 75);
...
%Event: id=event_0000004
	event_event_0000004=((time >= 15) && (time <= 70)) || ((time >= 75) && (time <= 80)) || (time >= 85);
