...
% Reaction: id = _J0
	reaction__J0=global_par_d_syn;

% Reaction: id = _J1
	reaction__J1=global_par_d_deg*x(1)*(global_par_APC+global_par_delta_d);

% Reaction: id = _J2
	reaction__J2=global_par_b_syn*global_par_E2F;

% Reaction: id = _J3
	reaction__J3=global_par_b_deg*x(2)*(global_par_APC+global_par_delta_b);
