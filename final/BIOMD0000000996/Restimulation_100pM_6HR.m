...
%
% Model name = Strasen2018 – TGFβ SMAD Signalling – Restimulation with 100pM TGFβ at 6hr
%
%
...
% Parameter:   id =  offset_restimulation_2_5pM, name = offset_restimulation_100pM
	global_par_offset_restimulation_2_5pM=0.0807;
% Parameter:   id =  scale_restimulation_2_5pM, name = scale_restimulation_100pM
	global_par_scale_restimulation_2_5pM=0.9826;
...
% assignmentRule: variable = TGFb_Ligand_DOSE
	global_par_TGFb_Ligand_DOSE=100;
...
% Reaction: id = reaction20, name = reaction20
	reaction_reaction20=compartment_cyt*Function_for_reaction20_3(x(3), global_par_index_k_out_1_relative_speed, global_par_k_in_1);

% Reaction: id = reaction21, name = reaction21
	reaction_reaction21=compartment_cyt*Function_for_reaction21_3(x(4), global_par_index_k_out_2_relative_speed, global_par_k_in_2);

% Reaction: id = reaction22, name = reaction22
	reaction_reaction22=compartment_cyt*Function_for_reaction22_3(x(8), global_par_index_active_Rec_internalize, global_par_k_in_1);
...
% Reaction: id = reaction25, name = reaction25
	reaction_reaction25=compartment_cyt*Function_for_reaction25__1(x(9), x(12), global_par_k_phosphorylation);
...
% Reaction: id = reaction30, name = reaction30
	reaction_reaction30=compartment_cyt*Function_for_reaction30(global_par_index_kf_homotrimer, global_par_kf_trimmer, x(11));

% Reaction: id = reaction31, name = reaction31
	reaction_reaction31=compartment_nuc*Function_for_reaction31_1(global_par_index_kf_homotrimer, global_par_kf_trimmer, x(19));

% Reaction: id = reaction32, name = reaction32
	reaction_reaction32=compartment_nuc*Function_for_reaction32_2(global_par_index_kb_homotrimer, global_par_kb_trimmer, x(21));

% Reaction: id = reaction33, name = reaction33
	reaction_reaction33=compartment_cyt*Function_for_reaction33_3(global_par_index_kb_homotrimer, global_par_kb_trimmer, x(15));

% Reaction: id = reaction34, name = reaction34
	reaction_reaction34=Function_for_reaction34_3(x(12), global_par_S2_import_to_nuc, compartment_cyt);

% Reaction: id = reaction35, name = reaction35
	reaction_reaction35=Function_for_reaction35_4(global_par_S2_export_from_nuc, x(22), compartment_nuc);

% Reaction: id = reaction36, name = reaction36
	reaction_reaction36=Function_for_reaction36_4(x(13), global_par_S4_import_to_nuc, compartment_cyt);

% Reaction: id = reaction37, name = reaction37
	reaction_reaction37=Function_for_reaction37_4(global_par_S4_export_from_nuc, x(23), compartment_nuc);

% Reaction: id = reaction38, name = reaction38
	reaction_reaction38=Function_for_reaction38_4(global_par_S2_import_to_nuc, compartment_cyt, x(11));

% Reaction: id = reaction39, name = reaction39
	reaction_reaction39=Function_for_reaction39_4(global_par_S2_export_from_nuc, compartment_nuc, x(19));

% Reaction: id = reaction40, name = reaction40
	reaction_reaction40=Function_for_reaction40_4(global_par_Trimer_import_to_nuc, compartment_cyt, x(14));

% Reaction: id = reaction41, name = reaction41
	reaction_reaction41=Function_for_reaction41_1(global_par_Trimer_import_to_nuc, compartment_cyt, x(15));
...
% Reaction: id = reaction44, name = reaction44
	reaction_reaction44=compartment_cyt*Function_for_reaction44_3(global_par_S2_export_from_nuc, global_par_S2_import_to_nuc, global_par_S2_total, global_par_kdeg_S2);

% Reaction: id = reaction45, name = reaction45
	reaction_reaction45=compartment_cyt*Function_for_reaction45_4(global_par_S4_export_from_nuc, global_par_S4_import_to_nuc, global_par_S4_total, global_par_kdeg_S4);

% Reaction: id = reaction46, name = reaction46
	reaction_reaction46=compartment_cyt*Function_for_reaction46_4(global_par_R1_total, global_par_index_k_out_1_relative_speed, global_par_k_in_1, global_par_kdeg_R1);

% Reaction: id = reaction47, name = reaction47
	reaction_reaction47=compartment_cyt*Function_for_reaction47_4(global_par_R2_total, global_par_index_k_out_2_relative_speed, global_par_k_in_2, global_par_kdeg_R2);

% Reaction: id = reaction50, name = reaction50
	reaction_reaction50=compartment_nuc*Function_for_reaction50__2(global_par_K_mran, global_par_hill_fact1, global_par_k_induced_S7_production, global_par_mRNA_prod, x(20));

% Reaction: id = reaction51, name = reaction51
	reaction_reaction51=Function_for_reaction51_1(x(18), global_par_export_cytoplasm, compartment_nuc);

% Reaction: id = reaction52, name = reaction52
	reaction_reaction52=compartment_cyt*Function_for_reaction52_2(x(16), global_par_k_S7_protein);
...
%Event: id=Ligand1_start_wash
	event_Ligand1_start_wash=(time > 359) && (time < 359.5);
...
%Event: id=Ligand2_injection
	event_Ligand2_injection=time == 360.1;
...
%Event: id=Ligand1_stop_wash
	event_Ligand1_stop_wash=time >= 360;
...
function z=Function_for_reaction30(index_kf_homotrimer,kf_trimmer,pS2_c), z=(index_kf_homotrimer*kf_trimmer*pS2_c^3);end
...
function z=Function_for_reaction52_2(Smad7mRNA,k_S7_protein), z=(Smad7mRNA*k_S7_protein);end

function z=Function_for_reaction36_4(S4_c,S4_import_to_nuc,cyt), z=(cyt*S4_c*S4_import_to_nuc);end

function z=Function_for_reaction35_4(S2_export_from_nuc,S2_n,nuc), z=(nuc*S2_n*S2_export_from_nuc);end

function z=Function_for_reaction44_3(S2_export_from_nuc,S2_import_to_nuc,S2_total,kdeg_S2), z=(S2_total*(S2_import_to_nuc*kdeg_S2+S2_export_from_nuc*kdeg_S2+kdeg_S2^2)/(2*S2_import_to_nuc+S2_export_from_nuc+kdeg_S2));end

function z=Function_for_reaction40_4(Trimer_import_to_nuc,cyt,pS2_pS2_S4_c), z=(cyt*Trimer_import_to_nuc*pS2_pS2_S4_c);end

function z=Function_for_reaction41_1(Trimer_import_to_nuc,cyt,pS2_pS2_pS2_c), z=(cyt*Trimer_import_to_nuc*pS2_pS2_pS2_c);end

function z=Function_for_reaction46_4(R1_total,index_k_out_1_relative_speed,k_in_1,kdeg_R1), z=(R1_total*k_in_1*kdeg_R1^2/(k_in_1*kdeg_R1+kdeg_R1^2+index_k_out_1_relative_speed*k_in_1*kdeg_R1));end

function z=Function_for_reaction21_3(TGFb_R2_endo,index_k_out_2_relative_speed,k_in_2), z=(TGFb_R2_endo*index_k_out_2_relative_speed*k_in_2);end

function z=Function_for_reaction38_4(S2_import_to_nuc,cyt,pS2_c), z=(cyt*S2_import_to_nuc*pS2_c);end

function z=Function_for_reaction37_4(S4_export_from_nuc,S4_n,nuc), z=(nuc*S4_n*S4_export_from_nuc);end

function z=Function_for_reaction22_3(Active_Rec,index_active_Rec_internalize,k_in_1), z=(Active_Rec*index_active_Rec_internalize*k_in_1);end

function z=Function_for_reaction45_4(S4_export_from_nuc,S4_import_to_nuc,S4_total,kdeg_S4), z=(S4_total*(S4_import_to_nuc*kdeg_S4+S4_export_from_nuc*kdeg_S4+kdeg_S4^2)/(2*S4_import_to_nuc+S4_export_from_nuc+kdeg_S4));end

function z=Function_for_reaction32_2(index_kb_homotrimer,kb_trimmer,pS2_pS2_pS2_n), z=(index_kb_homotrimer*kb_trimmer*pS2_pS2_pS2_n);end

function z=Function_for_reaction34_3(S2_c,S2_import_to_nuc,cyt), z=(cyt*S2_c*S2_import_to_nuc);end

function z=Function_for_reaction51_1(Smad7mRNA1,export_cytoplasm,nuc), z=(nuc*Smad7mRNA1*export_cytoplasm);end

function z=Function_for_reaction47_4(R2_total,index_k_out_2_relative_speed,k_in_2,kdeg_R2), z=(R2_total*k_in_2*kdeg_R2^2/(k_in_2*kdeg_R2+kdeg_R2^2+index_k_out_2_relative_speed*k_in_2*kdeg_R2));end

function z=Function_for_reaction33_3(index_kb_homotrimer,kb_trimmer,pS2_pS2_pS2_c), z=(index_kb_homotrimer*kb_trimmer*pS2_pS2_pS2_c);end

function z=Function_for_reaction39_4(S2_export_from_nuc,nuc,pS2_n), z=(nuc*S2_export_from_nuc*pS2_n);end

function z=Function_for_reaction31_1(index_kf_homotrimer,kf_trimmer,pS2_n), z=(index_kf_homotrimer*kf_trimmer*pS2_n^3);end

function z=Function_for_reaction20_3(TGFb_R1_endo,index_k_out_1_relative_speed,k_in_1), z=(TGFb_R1_endo*index_k_out_1_relative_speed*k_in_1);end

function z=Function_for_reaction25__1(Active_Rec_endo,S2_c,k_phosphorylation), z=(k_phosphorylation*Active_Rec_endo*S2_c);end

function z=Function_for_reaction50__2(K_mran,hill_fact1,k_induced_S7_production,mRNA_prod,pS2_pS2_S4_n), z=(mRNA_prod+k_induced_S7_production*pS2_pS2_S4_n^hill_fact1/(K_mran^hill_fact1+pS2_pS2_S4_n^hill_fact1));end
