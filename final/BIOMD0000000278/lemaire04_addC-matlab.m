...
%
% Model name = Lemaire2004_BoneRemodeling_addOsteoclast
%
%
...
% Parameter:   id =  add_Ccells, name = add_Ccells
% assignmentRule: variable = add_Ccells
	global_par_add_Ccells=piecewise(0.0001, (time > 20) && (time <= 80), 0);
...
x(3) = x(6);
	...
	% rateRule: variable = C
	xdot(6) = global_par_D_C*global_par_Phi_L-global_par_D_A*global_par_Phi_C*x(3)+global_par_add_Ccells;
