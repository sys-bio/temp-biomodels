...
%
% Model name = Lemaire2004_BoneRemodeling_OsteoblastOsteoclast
%
%
...
% Parameter:   id =  remove_Ccells, name = remove_Ccells
% assignmentRule: variable = remove_Ccells
	global_par_remove_Ccells=piecewise(0.00029, (time > 20) && (time <= 80), 0);
...
x(3) = x(6);
	...
	% rateRule: variable = C
	xdot(6) = global_par_D_C*global_par_Phi_L-global_par_D_A*global_par_Phi_C*x(3)-global_par_remove_Ccells;
