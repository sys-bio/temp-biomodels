...
%
% Model name = Lemaire2004_BoneRemodeling_addOsteoblast
%
%
...
% Parameter:   id =  add_Bcells, name = add_Bcells
% assignmentRule: variable = add_Bcells
	global_par_add_Bcells=piecewise(0.0001, (time > 20) && (time <= 80), 0);
...
x(3) = x(6);
	...
	% rateRule: variable = B
	xdot(5) = global_par_D_B*x(1)/global_par_Phi_C-global_par_k_B*x(2)+global_par_add_Bcells;
	% rateRule: variable = C
