...
% Parameter:   id =  remove_Rcells, name = remove_Rcells
% assignmentRule: variable = remove_Rcells
	global_par_remove_Rcells=piecewise(0.00012, (time > 20) && (time <= 80), 0);
...
x(3) = x(6);
	...
	xdot=zeros(6,1);
	% rateRule: variable = R
	xdot(4) = global_par_D_R*global_par_Phi_C-global_par_D_B*x(1)/global_par_Phi_C-global_par_remove_Rcells;
	% rateRule: variable = B
