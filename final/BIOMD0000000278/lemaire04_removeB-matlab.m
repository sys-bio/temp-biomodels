...
%
% Model name = Lemaire2004_BoneRemodeling_removeOsteoblast
%
%
...
% Parameter:   id =  remove_Bcells, name = remove_Bcells
% assignmentRule: variable = remove_Bcells
	global_par_remove_Bcells=piecewise(8.3E-5, (time > 20) && (time <= 80), 0);
...
x(3) = x(6);
	...
	% rateRule: variable = B
	xdot(5) = global_par_D_B*x(1)/global_par_Phi_C-global_par_k_B*x(2)-global_par_remove_Bcells;
	% rateRule: variable = C
