...
%
% Model name = Parmar2017 - Mouse Iron Distribution - Adequate iron diet (tracer)
%
...
% Parameter:   id =  ModelValue_13, name = Initial for Avogadro
	global_par_ModelValue_13=6.02214179E23;
...
% assignmentRule: variable = Total_Fe_concentration
	global_par_Total_Fe_concentration=(x(2)*global_par_Avogadro*compartment_Duodenum+x(8)*global_par_Avogadro*compartment_Liver+x(6)*global_par_Avogadro*compartment_Spleen+x(4)*global_par_Avogadro*compartment_RBC+x(20)*global_par_Avogadro*compartment_RestOfBody+2*x(14)*global_par_Avogadro*compartment_Plasma+x(9)*global_par_Avogadro*compartment_Plasma+x(15)*global_par_Avogadro*compartment_Plasma+x(16)*global_par_Avogadro*compartment_Plasma+x(21)*global_par_Avogadro*compartment_BoneMarrow)/(global_par_ModelValue_13*(compartment_Duodenum+compartment_Liver+compartment_Plasma+compartment_RBC+compartment_RestOfBody+compartment_Spleen));
...
% assignmentRule: variable = FePlasma_conc_
	global_par_FePlasma_conc_=global_par_FePlasma/(compartment_Plasma*global_par_ModelValue_13);
...
% assignmentRule: variable = FePlasma_conc
	global_par_FePlasma_conc=global_par_FePlasma_0/(compartment_Plasma*global_par_ModelValue_13);
...
% assignmentRule: variable = Total_Fe__g
	global_par_Total_Fe__g=global_par_Total_Fe*55.845/global_par_ModelValue_13;
...
% assignmentRule: variable = Total_Tf_conc
	global_par_Total_Tf_conc=global_par_Total_Tf/(global_par_ModelValue_13*compartment_Plasma);
...
%Event: id=event_1_0
	event_event_1_0=time >= 5000;

	if(event_event_1_0) 
		x(10)=global_par_Injected/(global_par_ModelValue_13*compartment_Plasma);
	end
