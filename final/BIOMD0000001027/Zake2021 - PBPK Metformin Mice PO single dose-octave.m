...
%
% Model name = PBPK model of metformin in mice: single dose peroral
%
%
...
% Parameter:   id =  Metformin_Dose_in_Lumen_in_mg, name = Metformin Dose in Lumen in mg
	global_par_Metformin_Dose_in_Lumen_in_mg=1.375;
...
% Parameter:   id =  Metformin_Dose_in_Plasma_in_mg, name = Metformin Dose in Plasma in mg
	global_par_Metformin_Dose_in_Plasma_in_mg=0.0;
...
% Parameter:   id =  Compartment_30, name = Initial for Adipose
	global_par_Compartment_30=1.925;
% Parameter:   id =  Compartment_29, name = Initial for Brain
	global_par_Compartment_29=0.45375;
% Parameter:   id =  Compartment_26, name = Initial for Feces
	global_par_Compartment_26=1.0;
% Parameter:   id =  Compartment_27, name = Initial for Heart
	global_par_Compartment_27=0.1375;
% Parameter:   id =  Compartment_35, name = Initial for IntestineEnterocytes
	global_par_Compartment_35=0.06875;
% Parameter:   id =  Compartment_20, name = Initial for IntestineLumen
	global_par_Compartment_20=0.6;
% Parameter:   id =  Compartment_37, name = Initial for IntestineVascular
	global_par_Compartment_37=0.627;
% Parameter:   id =  Compartment_22, name = Initial for KidneyPlasma
	global_par_Compartment_22=0.154;
% Parameter:   id =  Compartment_36, name = Initial for KidneyTissue
	global_par_Compartment_36=0.154;
% Parameter:   id =  Compartment_39, name = Initial for KidneyTubular
	global_par_Compartment_39=0.154;
% Parameter:   id =  Compartment_21, name = Initial for Liver
	global_par_Compartment_21=1.50975;
% Parameter:   id =  Compartment_32, name = Initial for Lung
	global_par_Compartment_32=0.20075;
% Parameter:   id =  Compartment_28, name = Initial for Muscle
	global_par_Compartment_28=10.56;
% Parameter:   id =  Compartment_31, name = Initial for PlasmaArterial
	global_par_Compartment_31=0.34375;
% Parameter:   id =  Compartment_24, name = Initial for PlasmaVenous
	global_par_Compartment_24=1.03125;
% Parameter:   id =  Compartment_33, name = Initial for PortalVein
	global_par_Compartment_33=0.1595;
% Parameter:   id =  Compartment_23, name = Initial for Remainder
	global_par_Compartment_23=9.85875;
% Parameter:   id =  Compartment_38, name = Initial for StomachLumen
	global_par_Compartment_38=0.4;
% Parameter:   id =  Compartment_34, name = Initial for Stomach
	global_par_Compartment_34=0.165;
% Parameter:   id =  Compartment_25, name = Initial for Urine
	global_par_Compartment_25=1.0;
% Parameter:   id =  ModelValue_57, name = Initial for Body Weight
	global_par_ModelValue_57=27.5;
% Parameter:   id =  ModelValue_53, name = Initial for Cardiac Output
	global_par_ModelValue_53=838.8;
% Parameter:   id =  ModelValue_58, name = Initial for Metformin Dose in Lumen in mg
	global_par_ModelValue_58=1.375;
% Parameter:   id =  ModelValue_89, name = Initial for QIntestineVascular
	global_par_ModelValue_89=113.238;
% Parameter:   id =  ModelValue_86, name = Initial for QLiverArtery
	global_par_ModelValue_86=16.776;
% Parameter:   id =  ModelValue_99, name = Initial for QPortalVeinOut
	global_par_ModelValue_99=180.342;
% Parameter:   id =  ModelValue_88, name = Initial for QPortalVein
	global_par_ModelValue_88=50.328;
% Parameter:   id =  ModelValue_87, name = Initial for QStomach
	global_par_ModelValue_87=16.776;
% assignmentRule: variable = QStomach
	global_par_QStomach=global_par_ModelValue_53*0.02;
% assignmentRule: variable = QLiverArtery
	global_par_QLiverArtery=global_par_ModelValue_53*0.02;
% assignmentRule: variable = QPortalVein
	global_par_QPortalVein=global_par_ModelValue_53*0.06;
% assignmentRule: variable = QIntestineVascular
	global_par_QIntestineVascular=global_par_ModelValue_53*0.135;
% assignmentRule: variable = PortalVein
	compartment_PortalVein=global_par_ModelValue_57*0.0058;
% assignmentRule: variable = Stomach
	compartment_Stomach=global_par_ModelValue_57*0.006;
% assignmentRule: variable = mgStomach
	global_par_mgStomach=129.16*x(15)/compartment_Stomach*global_par_Compartment_34/1000000;
% assignmentRule: variable = IntestineEnterocytes
	compartment_IntestineEnterocytes=global_par_ModelValue_57*0.0025;
% assignmentRule: variable = KidneyTissue
	compartment_KidneyTissue=global_par_ModelValue_57*0.0056;
% assignmentRule: variable = IntestineVascular
	compartment_IntestineVascular=global_par_ModelValue_57*0.0228;
% assignmentRule: variable = KidneyTubular
	compartment_KidneyTubular=global_par_ModelValue_57*0.0056;
% assignmentRule: variable = QAdipose
	global_par_QAdipose=global_par_ModelValue_53*0.005;
% assignmentRule: variable = QBrain
	global_par_QBrain=global_par_ModelValue_53*0.033;
% assignmentRule: variable = QHeart
	global_par_QHeart=global_par_ModelValue_53*0.066;
% assignmentRule: variable = QKidney
	global_par_QKidney=global_par_ModelValue_53*0.091;
% assignmentRule: variable = QMuscle
	global_par_QMuscle=global_par_ModelValue_53*0.159;
% assignmentRule: variable = QRemainder
	global_par_QRemainder=global_par_ModelValue_53*0.411;
% assignmentRule: variable = mgIntestineLumen
	global_par_mgIntestineLumen=129.16*x(11)/compartment_IntestineLumen*global_par_Compartment_20/1000000;
% assignmentRule: variable = mgPortalVein
	global_par_mgPortalVein=129.16*x(14)/compartment_PortalVein*global_par_Compartment_33/1000000;
% assignmentRule: variable = mgUrine
	global_par_mgUrine=129.16*x(10)/compartment_Urine*global_par_Compartment_25/1000000;
% assignmentRule: variable = mgFeces
	global_par_mgFeces=129.16*x(9)/compartment_Feces*global_par_Compartment_26/1000000;
% assignmentRule: variable = mgIntestineEnterocytes
	global_par_mgIntestineEnterocytes=129.16*x(16)/compartment_IntestineEnterocytes*global_par_Compartment_35/1000000;
% assignmentRule: variable = Liver
	compartment_Liver=global_par_ModelValue_57*0.0549;
% assignmentRule: variable = mgLiver
	global_par_mgLiver=129.16*x(1)/compartment_Liver*global_par_Compartment_21/1000000;
% assignmentRule: variable = KidneyPlasma
	compartment_KidneyPlasma=global_par_ModelValue_57*0.0056;
% assignmentRule: variable = mgKidneyPlasma
	global_par_mgKidneyPlasma=129.16*x(2)/compartment_KidneyPlasma*global_par_Compartment_22/1000000;
% assignmentRule: variable = Remainder
	compartment_Remainder=global_par_ModelValue_57*0.3585;
% assignmentRule: variable = mgRemainder
	global_par_mgRemainder=129.16*x(3)/compartment_Remainder*global_par_Compartment_23/1000000;
% assignmentRule: variable = PlasmaVenous
	compartment_PlasmaVenous=global_par_ModelValue_57*0.0375;
% assignmentRule: variable = mgPlasmaVenous
	global_par_mgPlasmaVenous=129.16*x(4)/compartment_PlasmaVenous*global_par_Compartment_24/1000000;
% assignmentRule: variable = Heart
	compartment_Heart=global_par_ModelValue_57*0.005;
% assignmentRule: variable = mgHeart
	global_par_mgHeart=129.16*x(5)/compartment_Heart*global_par_Compartment_27/1000000;
% assignmentRule: variable = QPortalVeinOut
	global_par_QPortalVeinOut=global_par_ModelValue_87+global_par_ModelValue_88+global_par_ModelValue_89;
% assignmentRule: variable = QLiverOut
	global_par_QLiverOut=global_par_ModelValue_99+global_par_ModelValue_86;
% assignmentRule: variable = mIntestineSum
	global_par_mIntestineSum=(x(16)/compartment_IntestineEnterocytes*global_par_Compartment_35+global_par_Compartment_37*x(18)/compartment_IntestineVascular)/(global_par_Compartment_35+global_par_Compartment_37);
% assignmentRule: variable = mKidneySum
	global_par_mKidneySum=(global_par_Compartment_22*x(2)/compartment_KidneyPlasma+global_par_Compartment_36*x(17)/compartment_KidneyTissue+global_par_Compartment_39*x(20)/compartment_KidneyTubular)/(global_par_Compartment_22+global_par_Compartment_36+global_par_Compartment_39);
% assignmentRule: variable = mgKidneyTissues
	global_par_mgKidneyTissues=129.16*global_par_Compartment_36*x(17)/compartment_KidneyTissue/1000000;
% assignmentRule: variable = Lung
	compartment_Lung=global_par_ModelValue_57*0.0073;
% assignmentRule: variable = mgLung
	global_par_mgLung=129.16*x(13)/compartment_Lung*global_par_Compartment_32/1000000;
% assignmentRule: variable = mgIntestineVascular
	global_par_mgIntestineVascular=129.16*x(18)/compartment_IntestineVascular*global_par_Compartment_37/1000000;
% assignmentRule: variable = mgStomachLumen
	global_par_mgStomachLumen=129.16*x(19)/compartment_StomachLumen*global_par_Compartment_38/1000000;
...
% assignmentRule: variable = mgKidneyTubular
	global_par_mgKidneyTubular=129.16*global_par_Compartment_39*x(20)/compartment_KidneyTubular/1000000;
...
% assignmentRule: variable = Muscle
	compartment_Muscle=global_par_ModelValue_57*0.384;
% assignmentRule: variable = mgMuscle
	global_par_mgMuscle=129.16*x(6)/compartment_Muscle*global_par_Compartment_28/1000000;
% assignmentRule: variable = Brain
	compartment_Brain=global_par_ModelValue_57*0.0165;
% assignmentRule: variable = mgBrain
	global_par_mgBrain=129.16*x(8)/compartment_Brain*global_par_Compartment_29/1000000;
% assignmentRule: variable = Adipose
	compartment_Adipose=global_par_ModelValue_57*0.07;
% assignmentRule: variable = mgAdipose
	global_par_mgAdipose=129.16*x(7)/compartment_Adipose*global_par_Compartment_30/1000000;
% assignmentRule: variable = PlasmaArterial
	compartment_PlasmaArterial=global_par_ModelValue_57*0.0125;
% assignmentRule: variable = mgPlasmaArterial
	global_par_mgPlasmaArterial=129.16*x(12)/compartment_PlasmaArterial*global_par_Compartment_31/1000000;
...
%Event: id=Oral_at_0_001
	...
	if(event_Oral_at_0_001) 
		x(19)=(1000000*global_par_ModelValue_58/(129.16*global_par_Compartment_38)+x(19)/compartment_StomachLumen)*compartment_StomachLumen;
	end
