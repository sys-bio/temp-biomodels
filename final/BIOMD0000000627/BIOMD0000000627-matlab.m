...
% Species:   id = Na__extracellular_space, name = Na+, constant	const_species_Na__extracellular_space=30.0;

% Species:   id = O2_artery, name = O2, constant	const_species_O2_artery=0.0458700000000001;

% Species:   id = CO2_artery, name = CO2, constant	const_species_CO2_artery=0.00660000000000004;

% Species:   id = GLC_artery, name = GLC, constant	const_species_GLC_artery=0.0264000000000002;

% Species:   id = LAC_artery, name = LAC, constant	const_species_LAC_artery=0.0017215;
