...
//x(2)   ID: M  initialValue: 0.01
	(1/compartment_cell)*( (-1)*(1)* (compartment_cell* x(2) *V2_reaction5*(power((K2_reaction5+ x(2) ),( -1 )))) + (1)*(1)* (compartment_cell*(( 1 )+(( -1 )* x(2) ))* ( ( x(1) *VM1_p*(power(( x(1) +Kc_p),( -1 )))) ) *(power((K1_reaction4+(( -1 )* x(2) )+( 1 )),( -1 )))) );
	
//x(3)   ID: X  initialValue: 0.01
	(1/compartment_cell)*( (-1)*(1)* (compartment_cell*V4_reaction7* x(3) *(power((K4_reaction7+ x(3) ),( -1 )))) + (1)*(1)* (compartment_cell* ( ( x(2) *VM3_p) ) *(( 1 )+(( -1 )* x(3) ))*(power((K3_reaction6+(( -1 )* x(3) )+( 1 )),( -1 )))) )
	];
