...
% Reaction: id = p100_mRNA_Expressions, name = p100 mRNA Expressions	% Local Parameter:   id =  k, name = k
	reaction_p100_mRNA_Expressions_k=1000.0;
	% Local Parameter:   id =  Kd, name = Kd
	reaction_p100_mRNA_Expressions_Kd=50.0;

	reaction_p100_mRNA_Expressions=compartment_compartment*Canonical_pathway_activation(reaction_p100_mRNA_Expressions_k, global_par_canon, reaction_p100_mRNA_Expressions_Kd);
...
% Reaction: id = RelB_Expression, name = RelB Expression	% Local Parameter:   id =  k, name = k
	reaction_RelB_Expression_k=42.0;
	% Local Parameter:   id =  Kd, name = Kd
	reaction_RelB_Expression_Kd=50.0;

	reaction_RelB_Expression=compartment_compartment*Canonical_pathway_activation(reaction_RelB_Expression_k, global_par_canon, reaction_RelB_Expression_Kd);
...
function z=Canonical_pathway_activation(k,canon,Kd), z=(k*canon/(Kd+canon));end
