...
%
% Model name = Izhikevich2004_SpikingNeurons_SpikeLatency
%
% is http://identifiers.org/biomodels.db/MODEL5569742719
% is http://identifiers.org/biomodels.db/BIOMD0000000134
...
%Event: id=event_0000002
	event_event_0000002=(time > 10) && (time < 13);
