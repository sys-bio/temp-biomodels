...
%
% Model name = Mouse Iron Distribution - Adequate iron diet (No Tracer)
%
% is http://identifiers.org/biomodels.db/MODEL1605030003
% is http://identifiers.org/biomodels.db/BIOMD0000000736
%
...
% Parameter:   id =  ModelValue_28, name = Initial for Avogadro
	global_par_ModelValue_28=6.02214179E23;
...
% assignmentRule: variable = Total_Fe__conc
	global_par_Total_Fe__conc=(x(1)*global_par_Avogadro*compartment_Duodenum+x(4)*global_par_Avogadro*compartment_Liver+x(3)*global_par_Avogadro*compartment_Spleen+x(2)*global_par_Avogadro*compartment_RBC+x(10)*global_par_Avogadro*compartment_RestOfBody+2*x(7)*global_par_Avogadro*compartment_Plasma+x(8)*global_par_Avogadro*compartment_Plasma+x(9)*global_par_Avogadro*compartment_Plasma+x(11)*global_par_Avogadro*compartment_BoneMarrow)/(global_par_ModelValue_28*(compartment_Duodenum+compartment_Liver+compartment_Plasma+compartment_RBC+compartment_RestOfBody+compartment_Spleen));
...
% assignmentRule: variable = Total_Fe__g
	global_par_Total_Fe__g=global_par_Total_Fe__particle*55.845/global_par_ModelValue_28;
...
% assignmentRule: variable = Total_Tf__conc
	global_par_Total_Tf__conc=global_par_Total_Tf__particle/(global_par_ModelValue_28*compartment_Plasma);
...
% assignmentRule: variable = FePlasma_conc
	global_par_FePlasma_conc=global_par_FePlasma__particle/(compartment_Plasma*global_par_ModelValue_28);
...
% Species:   id = Hepcidin, name = Hepcidin	xdot(6) = ;
