...
% Parameter:   id =  twilightPeriod, name = twilightPeriod
	global_par_twilightPeriod=0.0416666667;

% Reaction: id = reaction_1, name = cLm transcription
	reaction_reaction_1=compartment_compartment*global_par_g0^global_par_alpha/(global_par_g0^global_par_alpha+x(16)^global_par_alpha)*(LightFunction(t, global_par_lightOffset, global_par_lightAmplitude, global_par_phase, global_par_photoPeriod, global_par_cyclePeriod, global_par_twilightPeriod)*(global_par_q1*x(13)+global_par_n0)+global_par_n1*x(9)^global_par_a/(global_par_g1^global_par_a+x(9)^global_par_a));
...
% Reaction: id = reaction_21, name = light dependent production of protein P
	reaction_reaction_21=(1-LightFunction(t, global_par_lightOffset, global_par_lightAmplitude, global_par_phase, global_par_photoPeriod, global_par_cyclePeriod, global_par_twilightPeriod))*global_par_p5*compartment_compartment;

% Reaction: id = reaction_22, name = light activation protein P degradation
	reaction_reaction_22=LightFunction(t, global_par_lightOffset, global_par_lightAmplitude, global_par_phase, global_par_photoPeriod, global_par_cyclePeriod, global_par_twilightPeriod)*global_par_q3*x(13)*compartment_compartment;
...
% Reaction: id = reaction_25, name = light activation of cAm transcription
	reaction_reaction_25=LightFunction(t, global_par_lightOffset, global_par_lightAmplitude, global_par_phase, global_par_photoPeriod, global_par_cyclePeriod, global_par_twilightPeriod)*global_par_q4*x(13)*compartment_compartment;
...
% Reaction: id = reaction_32, name = light activation degradation of cTc
	reaction_reaction_32=compartment_compartment*(1-LightFunction(t, global_par_lightOffset, global_par_lightAmplitude, global_par_phase, global_par_photoPeriod, global_par_cyclePeriod, global_par_twilightPeriod))*global_par_m5*x(5)/(global_par_k5+x(5));
...
% Reaction: id = reaction_34, name = light activation degradation of cTn
	reaction_reaction_34=compartment_compartment*(1-LightFunction(t, global_par_lightOffset, global_par_lightAmplitude, global_par_phase, global_par_photoPeriod, global_par_cyclePeriod, global_par_twilightPeriod))*global_par_m7*x(6)/(global_par_k6+x(6));
...
% Reaction: id = reaction_39, name = cYm transcription
	reaction_reaction_39=compartment_compartment*(LightFunction(t, global_par_lightOffset, global_par_lightAmplitude, global_par_phase, global_par_photoPeriod, global_par_cyclePeriod, global_par_twilightPeriod)*global_par_q2*x(13)+(LightFunction(t, global_par_lightOffset, global_par_lightAmplitude, global_par_phase, global_par_photoPeriod, global_par_cyclePeriod, global_par_twilightPeriod)*global_par_n4+global_par_n5)*global_par_g5^global_par_e/(global_par_g5^global_par_e+x(6)^global_par_e))*global_par_g6^global_par_f/(global_par_g6^global_par_f+x(3)^global_par_f);
