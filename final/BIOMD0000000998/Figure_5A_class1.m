...
%
% Model name = Strasen2018 – TGFβ SMAD Signalling Class 1
%
%
...
%Initial conditions vector
	x0=zeros(23,1);
	x0(1) = 6.41229761717806;
	x0(2) = 1.95691479296813;
	x0(3) = 11.1056687895974;
	x0(4) = 15.5426986646082;
	x0(5) = 100.0;
	x0(6) = 0.0;
	x0(7) = 0.0;
	x0(8) = 0.0;
	...
	x0(10) = 0.0;
	x0(11) = 0.0;
	x0(12) = 1269.56834116374;
	x0(13) = 632.190878590424;
	x0(14) = 0.0;
	x0(15) = 0.0;
	x0(16) = 0.109505329345456;
	x0(17) = 0.712465289945671;
	x0(18) = 44.3163215783895;
	x0(19) = 0.0;
	x0(20) = 0.0;
	x0(21) = 0.0;
	x0(22) = 482.42521727002;
	x0(23) = 159.993358064461;
...
% Parameter:   id =  R1_total_C1, name = R1_total_C1
	global_par_R1_total_C1=17.5179664067755;
% Parameter:   id =  R2_total_C1, name = R2_total_C1
	global_par_R2_total_C1=17.4996134575763;
% Parameter:   id =  S2_export_from_nuc_C1, name = S2_export_from_nuc_C1
	global_par_S2_export_from_nuc_C1=2.104009010142;
% Parameter:   id =  S2_import_to_nuc_C1, name = S2_import_to_nuc_C1
	global_par_S2_import_to_nuc_C1=0.399850475956441;
% Parameter:   id =  S2_total_C1, name = S2_total_C1
	global_par_S2_total_C1=1751.99355843376;
% Parameter:   id =  S4_export_from_nuc_C1, name = S4_export_from_nuc_C1
	global_par_S4_export_from_nuc_C1=0.258219489840727;
% Parameter:   id =  S4_import_to_nuc_C1, name = S4_import_to_nuc_C1
	global_par_S4_import_to_nuc_C1=0.033282428730513;
% Parameter:   id =  S4_total_C1, name = S4_total_C1
	global_par_S4_total_C1=792.184236654885;
...
% Parameter:   id =  index_active_Rec_internalize_C1, name = index_active_Rec_internalize_C1
	global_par_index_active_Rec_internalize_C1=0.5069458643727;
...
% Parameter:   id =  index_k_out_1_relative_speed_C1, name = index_k_out_1_relative_speed_C1
	global_par_index_k_out_1_relative_speed_C1=0.347249922630908;
% Parameter:   id =  index_k_out_2_relative_speed_C1, name = index_k_out_2_relative_speed_C1
	global_par_index_k_out_2_relative_speed_C1=0.124917902398145;
...
% Parameter:   id =  k_Dephos_C1, name = k_Dephos_C1
	global_par_k_Dephos_C1=0.0876347503049301;
% Parameter:   id =  k_S7_protein_C1, name = k_S7_protein_C1
	global_par_k_S7_protein_C1=0.414415667607617;
% Parameter:   id =  k_disso_Active_Rec, name = k_disso_Active_Rec
	global_par_k_disso_Active_Rec=0.00103940411358367;
% Parameter:   id =  k_in_R1_C1, name = k_in_R1_C1
	global_par_k_in_R1_C1=0.254881953552674;
% Parameter:   id =  k_in_R2_C1, name = k_in_R2_C1
	global_par_k_in_R2_C1=1.01272286568778;
% Parameter:   id =  k_induced_S7_production_C1, name = k_induced_S7_production_C1
	global_par_k_induced_S7_production_C1=9.21283556540176;
...
% Parameter:   id =  mRNA_prod_C1, name = mRNA_prod_C1
	global_par_mRNA_prod_C1=0.0254130031757049;
...
% Reaction: id = reaction18, name = reaction18
	reaction_reaction18=compartment_cyt*global_par_k_in_R1_C1*x(1);

% Reaction: id = reaction19, name = reaction19
	reaction_reaction19=compartment_cyt*global_par_k_in_R2_C1*x(2);

% Reaction: id = reaction20, name = reaction20
	reaction_reaction20=compartment_cyt*Function_for_reaction20_5(x(3), global_par_index_k_out_1_relative_speed_C1, global_par_k_in_R1_C1);

% Reaction: id = reaction21, name = reaction21
	reaction_reaction21=compartment_cyt*Function_for_reaction21_5(x(4), global_par_index_k_out_2_relative_speed_C1, global_par_k_in_R2_C1);

% Reaction: id = reaction22, name = reaction22
	reaction_reaction22=compartment_cyt*Function_for_reaction22_5(x(8), global_par_index_active_Rec_internalize_C1, global_par_k_in_R1_C1);
...
% Reaction: id = reaction33, name = reaction33
	reaction_reaction33=compartment_nuc*Function_for_reaction33_4(global_par_index_kb_homotrimer, global_par_kb_trimmer, x(21));

% Reaction: id = reaction34, name = reaction34
	reaction_reaction34=compartment_cyt*Function_for_reaction34_4(global_par_index_kb_homotrimer, global_par_kb_trimmer, x(15));

% Reaction: id = reaction35, name = reaction35
	reaction_reaction35=Function_for_reaction35_6(x(12), global_par_S2_import_to_nuc_C1, compartment_cyt);

% Reaction: id = reaction36, name = reaction36
	reaction_reaction36=Function_for_reaction36_6(global_par_S2_export_from_nuc_C1, x(22), compartment_nuc);

% Reaction: id = reaction37, name = reaction37
	reaction_reaction37=Function_for_reaction37_6(x(13), global_par_S4_import_to_nuc_C1, compartment_cyt);

% Reaction: id = reaction38, name = reaction38
	reaction_reaction38=Function_for_reaction38_6(global_par_S4_export_from_nuc_C1, x(23), compartment_nuc);

% Reaction: id = reaction39, name = reaction39
	reaction_reaction39=Function_for_reaction39_6(global_par_S2_import_to_nuc_C1, compartment_cyt, x(11));

% Reaction: id = reaction40, name = reaction40
	reaction_reaction40=Function_for_reaction40_6(global_par_S2_export_from_nuc_C1, compartment_nuc, x(19));
...
% Reaction: id = reaction43, name = reaction43
	reaction_reaction43=compartment_nuc*global_par_k_Dephos_C1*x(19);

% Reaction: id = reaction44, name = reaction44
	reaction_reaction44=compartment_nuc*Function_for_reaction44_6(global_par_index_trimer_dephos, global_par_k_Dephos_C1, x(20));

% Reaction: id = reaction45, name = reaction45
	reaction_reaction45=compartment_cyt*Function_for_reaction45_6(global_par_S2_export_from_nuc_C1, global_par_S2_import_to_nuc_C1, global_par_S2_total_C1, global_par_kdeg_S2);

% Reaction: id = reaction46, name = reaction46
	reaction_reaction46=compartment_cyt*Function_for_reaction46_6(global_par_S4_export_from_nuc_C1, global_par_S4_import_to_nuc_C1, global_par_S4_total_C1, global_par_kdeg_S4);

% Reaction: id = reaction47, name = reaction47
	reaction_reaction47=compartment_cyt*Function_for_reaction47_6(global_par_R1_total_C1, global_par_index_k_out_1_relative_speed_C1, global_par_k_in_R1_C1, global_par_kdeg_R1);

% Reaction: id = reaction48, name = reaction48
	reaction_reaction48=compartment_cyt*Function_for_reaction48_3(global_par_R2_total_C1, global_par_index_k_out_2_relative_speed_C1, global_par_k_in_R2_C1, global_par_kdeg_R2);

% Reaction: id = reaction51, name = reaction51
	reaction_reaction51=compartment_nuc*Function_for_reaction51_5(global_par_K_mran, global_par_hill_fact1, global_par_k_induced_S7_production_C1, global_par_mRNA_prod_C1, x(20));
...
% Reaction: id = reaction53, name = reaction53
	reaction_reaction53=compartment_cyt*Function_for_reaction53_3(x(16), global_par_k_S7_protein_C1);
...
function z=Function_for_reaction44_6(index_trimer_dephos,k_Dephos_C1,pS2_pS2_S4_n), z=(index_trimer_dephos*k_Dephos_C1*pS2_pS2_S4_n);end

function z=Function_for_reaction48_3(R2_total_C1,index_k_out_2_relative_speed_C1,k_in_R2_C1,kdeg_R2), z=(R2_total_C1*k_in_R2_C1*kdeg_R2^2/(k_in_R2_C1*kdeg_R2+kdeg_R2^2+index_k_out_2_relative_speed_C1*k_in_R2_C1*kdeg_R2));end

function z=Function_for_reaction33_4(index_kb_homotrimer,kb_trimmer,pS2_pS2_pS2_n), z=(index_kb_homotrimer*kb_trimmer*pS2_pS2_pS2_n);end

function z=Function_for_reaction34_4(index_kb_homotrimer,kb_trimmer,pS2_pS2_pS2_c), z=(index_kb_homotrimer*kb_trimmer*pS2_pS2_pS2_c);end

function z=Function_for_reaction38_6(S4_export_from_nuc_C1,S4_n,nuc), z=(nuc*S4_n*S4_export_from_nuc_C1);end

function z=Function_for_reaction36_6(S2_export_from_nuc_C1,S2_n,nuc), z=(nuc*S2_n*S2_export_from_nuc_C1);end

function z=Function_for_reaction21_5(TGFb_R2_endo,index_k_out_2_relative_speed_C1,k_in_R2_C1), z=(TGFb_R2_endo*index_k_out_2_relative_speed_C1*k_in_R2_C1);end

function z=Function_for_reaction35_6(S2_c,S2_import_to_nuc_C1,cyt), z=(cyt*S2_c*S2_import_to_nuc_C1);end

function z=Function_for_reaction22_5(Active_Rec,index_active_Rec_internalize_C1,k_in_R1_C1), z=(Active_Rec*index_active_Rec_internalize_C1*k_in_R1_C1);end

function z=Function_for_reaction20_5(TGFb_R1_endo,index_k_out_1_relative_speed_C1,k_in_R1_C1), z=(TGFb_R1_endo*index_k_out_1_relative_speed_C1*k_in_R1_C1);end

function z=Function_for_reaction39_6(S2_import_to_nuc_C1,cyt,pS2_c), z=(cyt*S2_import_to_nuc_C1*pS2_c);end

function z=Function_for_reaction46_6(S4_export_from_nuc_C1,S4_import_to_nuc_C1,S4_total_C1,kdeg_S4), z=(S4_total_C1*(S4_import_to_nuc_C1*kdeg_S4+S4_export_from_nuc_C1*kdeg_S4+kdeg_S4^2)/(2*S4_import_to_nuc_C1+S4_export_from_nuc_C1+kdeg_S4));end

function z=Function_for_reaction45_6(S2_export_from_nuc_C1,S2_import_to_nuc_C1,S2_total_C1,kdeg_S2), z=(S2_total_C1*(S2_import_to_nuc_C1*kdeg_S2+S2_export_from_nuc_C1*kdeg_S2+kdeg_S2^2)/(2*S2_import_to_nuc_C1+S2_export_from_nuc_C1+kdeg_S2));end

function z=Function_for_reaction53_3(Smad7mRNA,k_S7_protein_C1), z=(Smad7mRNA*k_S7_protein_C1);end

function z=Function_for_reaction37_6(S4_c,S4_import_to_nuc_C1,cyt), z=(cyt*S4_c*S4_import_to_nuc_C1);end

function z=Function_for_reaction47_6(R1_total_C1,index_k_out_1_relative_speed_C1,k_in_R1_C1,kdeg_R1), z=(R1_total_C1*k_in_R1_C1*kdeg_R1^2/(k_in_R1_C1*kdeg_R1+kdeg_R1^2+index_k_out_1_relative_speed_C1*k_in_R1_C1*kdeg_R1));end

function z=Function_for_reaction40_6(S2_export_from_nuc_C1,nuc,pS2_n), z=(nuc*S2_export_from_nuc_C1*pS2_n);end

function z=Function_for_reaction51_5(K_mran,hill_fact1,k_induced_S7_production_C1,mRNA_prod_C1,pS2_pS2_S4_n), z=(mRNA_prod_C1+k_induced_S7_production_C1*pS2_pS2_S4_n^hill_fact1/(K_mran^hill_fact1+pS2_pS2_S4_n^hill_fact1));end
