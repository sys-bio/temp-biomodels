...
%
% Model name = Simon2019 - NIK-dependent p100 processing into p52 and IkBd degradation, Michaelis-Menten, SBML 2v4
%
% isDescribedBy http://identifiers.org/pubmed/31048505
% is http://identifiers.org/biomodels.db/MODEL1904020002
% is http://identifiers.org/biomodels.db/BIOMD0000000869
%
...
% Parameter:   id =  IkBd_uM, name = IkBd_uM
% assignmentRule: variable = p52_uM
	global_par_p52_uM=x(2)/1000;
% assignmentRule: variable = IkBd_uM
	global_par_IkBd_uM=x(4)/1000;
...
% Reaction: id = IkBd_degradation_by_NIK, name = IkBd degradation by NIK	% Local Parameter:   id =  Km, name = Km
	reaction_IkBd_degradation_by_NIK_Km=10.0;
	% Local Parameter:   id =  kcat, name = kcat
	reaction_IkBd_degradation_by_NIK_kcat=0.05;

	reaction_IkBd_degradation_by_NIK=compartment_compartment*MM_Kcat_2(x(4), reaction_IkBd_degradation_by_NIK_Km, x(3), reaction_IkBd_degradation_by_NIK_kcat);
...
function z=MM_Kcat_2(IkBd,Km,NIK,kcat), z=(NIK*kcat*IkBd/(Km+IkBd));end
