...
% assignmentRule: variable = Vc
	global_par_Vc=global_par_Vcmax*const_species_CO2/((1+const_species_O2/global_par_Ko)*(const_species_CO2+global_par_Kc));
% assignmentRule: variable = Vp
	global_par_Vp=3*global_par_TPU/(1-global_par_Gamma/const_species_CO2);
% assignmentRule: variable = NADP
	x(3)=global_par_Nt-x(2);
% assignmentRule: variable = J
	global_par_J=global_par_Cst*global_par_alpha*0.9*global_par_Q/(1+(global_par_alpha*0.9*global_par_Q/global_par_Jmax)^2)^(0.5)/(65*0.5);
...
% Species:   id = O2, name = O2, constant	const_species_O2=21000.0;

% Species:   id = starch, name = starch, constant	const_species_starch=0.5;
