...
%
% Model name = Proctor2013 - Effect of Aβ immunisation in Alzheimer's disease (stochastic version)
%
% is http://identifiers.org/biomodels.db/MODEL1704060000
% is http://identifiers.org/biomodels.db/BIOMD0000000634
...
% Reaction: id = AbetaAggregation1
	reaction_AbetaAggregation1=global_par_kaggAbeta*x(41)*(x(41)-1)*0.5;

% Reaction: id = AbetaPlaqueFormation1
	reaction_AbetaPlaqueFormation1=global_par_kpf*x(53)*(x(53)-1)*0.5;
