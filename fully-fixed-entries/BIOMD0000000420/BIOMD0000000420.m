...
%
% Model name = Ratushny2012_ASSURE_I
%
% is http://identifiers.org/biomodels.db/MODEL1203010001
% is http://identifiers.org/biomodels.db/BIOMD0000000420
...
% assignmentRule: variable = dsp1ksp
	global_par_dsp1ksp=global_par_Ksp/2*(1+(global_par_s+global_par_P1)/global_par_Ksp-((1+(global_par_s+global_par_P1)/global_par_Ksp)^2-4*global_par_s*global_par_P1/global_par_Ksp^2)^0.5);
% assignmentRule: variable = dsp1p2kd
	global_par_dsp1p2kd=global_par_Kd/2*(1+(global_par_dsp1ksp+x(1)*compartment_univ)/global_par_Kd-((1+(global_par_dsp1ksp+x(1)*compartment_univ)/global_par_Kd)^2-4*global_par_dsp1ksp*x(1)*compartment_univ/global_par_Kd^2)^0.5);
