...
# Reaction: id = TPI_g, name = TPI_g
	...
	reaction_TPI_g=function_v1sub1prod(reaction_TPI_g_TPI_g_Vmax, reaction_TPI_g_TPI_g_Keq, x(4), reaction_TPI_g_TPI_g_KmDHAP, x(17), reaction_TPI_g_TPI_g_KmGA3P);
...
# Reaction: id = GlcT_g, name = GlcT_g
	...
	reaction_GlcT_g=function_mass_action_rev(reaction_GlcT_g_GlcT_g_k1, x(12), reaction_GlcT_g_GlcT_g_k2, x(13));
...
# Reaction: id = PyrT_c, name = PyrT_c
	...
	reaction_PyrT_c=function_v1sub(reaction_PyrT_c_PyrT_c_Vmax, x(14), reaction_PyrT_c_PyrT_c_KmPyr);
...
# Reaction: id = ENO_c, name = ENO_c
	...
	reaction_ENO_c=function_v1sub1prod(reaction_ENO_c_ENO_c_Vmax, reaction_ENO_c_ENO_c_Keq, x(1), reaction_ENO_c_ENO_c_Km2PGA, x(20), reaction_ENO_c_ENO_c_KmPEP);
# Reaction: id = HXK_g, name = HXK_g
	...
	reaction_HXK_g=function_v2sub2prod(reaction_HXK_g_HXK_g_Vmax, reaction_HXK_g_HXK_g_Keq, x(13), reaction_HXK_g_HXK_g_KmGlc, x(3), reaction_HXK_g_HXK_g_KmATP, x(6), reaction_HXK_g_HXK_g_KmGlc6P, x(5), reaction_HXK_g_HXK_g_KmADP);
# Reaction: id = _3PGAT_g, name = _3PGAT_g

	# Local Parameter:   id =  _3PGAT_g_k, name = _3PGAT_g_k
	reaction__3PGAT_g__3PGAT_g_k=250.0;

	reaction__3PGAT_g=function_mass_action_rev(reaction__3PGAT_g__3PGAT_g_k, x(22), reaction__3PGAT_g__3PGAT_g_k, x(8));
# Reaction: id = PGK_g, name = PGK_g
	...
	reaction_PGK_g=function_v2sub2prod(reaction_PGK_g_PGK_g_Vmax, reaction_PGK_g_PGK_g_Keq, x(11), reaction_PGK_g_PGK_g_Km13BPGA, x(5), reaction_PGK_g_PGK_g_KmADP, x(22), reaction_PGK_g_PGK_g_Km3PGA, x(3), reaction_PGK_g_PGK_g_KmATP);
# Reaction: id = G3PDH_g, name = G3PDH_g
	...
	reaction_G3PDH_g=function_v2sub2prod(reaction_G3PDH_g_G3PDH_g_Vmax, reaction_G3PDH_g_G3PDH_g_Keq, x(4), reaction_G3PDH_g_G3PDH_g_KmDHAP, x(24), reaction_G3PDH_g_G3PDH_g_KmNADH, x(19), reaction_G3PDH_g_G3PDH_g_KmGly3P, x(15), reaction_G3PDH_g_G3PDH_g_KmNAD);
# Reaction: id = GPO_c, name = GPO_c
	...
	reaction_GPO_c=function_v1sub(reaction_GPO_c_GPO_c_Vmax, x(18), reaction_GPO_c_GPO_c_KmGly3P);
...
# Reaction: id = GK_g, name = GK_g
	...
	reaction_GK_g=function_v2sub2prod(reaction_GK_g_GK_g_Vmax, reaction_GK_g_GK_g_Keq, x(19), reaction_GK_g_GK_g_KmGly3P, x(5), reaction_GK_g_GK_g_KmADP, const_species_Gly_e, reaction_GK_g_GK_g_KmGly, x(3), reaction_GK_g_GK_g_KmATP);
# Reaction: id = AK_c, name = AK_c
	...
	reaction_AK_c=function_vAK(x(7), x(23), x(10), reaction_AK_c_AK_c_k1, reaction_AK_c_AK_c_k2);
...
# Reaction: id = GAPDH_g, name = GAPDH_g
	...
	reaction_GAPDH_g=function_v2sub2prod(reaction_GAPDH_g_GAPDH_g_Vmax, reaction_GAPDH_g_GAPDH_g_Keq, x(17), reaction_GAPDH_g_GAPDH_g_KmGA3P, x(15), reaction_GAPDH_g_GAPDH_g_KmNAD, x(11), reaction_GAPDH_g_GAPDH_g_Km13BPGA, x(24), reaction_GAPDH_g_GAPDH_g_KmNADH);
# Reaction: id = AK_g, name = AK_g
	...
	reaction_AK_g=function_vAK(x(5), x(21), x(3), reaction_AK_g_AK_g_k1, reaction_AK_g_AK_g_k2);
