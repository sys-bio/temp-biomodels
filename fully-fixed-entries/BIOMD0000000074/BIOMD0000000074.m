...
%
% Model name = Leloup2003_CircClock_DD_REV-ERBalpha
%
% is http://identifiers.org/biomodels.db/MODEL1272626224
% is http://identifiers.org/biomodels.db/BIOMD0000000074
...
% Reaction: id = reaction_0, name = Mb synthesized	% Local Parameter:   id =  vsb, name = vsb
	...
	reaction_reaction_0=compartment_compartment_0*function_0(reaction_reaction_0_vsb, reaction_reaction_0_K, reaction_reaction_0_m, x(19));

% Reaction: id = reaction_1, name = Mb translated into protein	% Local Parameter:   id =  k, name = ksb
	reaction_reaction_1_k=0.32;

	reaction_reaction_1=compartment_compartment_0*function_1(reaction_reaction_1_k, x(1));

% Reaction: id = reaction_2, name = Mb nonspecific degradation	% Local Parameter:   id =  k1, name = kdmb
	reaction_reaction_2_k1=0.02;

	reaction_reaction_2=compartment_compartment_0*reaction_reaction_2_k1*x(1);
...
% Reaction: id = reaction_3, name = Bc phosphorylation	% Local Parameter:   id =  V, name = V1b
	...
	reaction_reaction_3=compartment_compartment_0*function_2(reaction_reaction_3_V, x(2), reaction_reaction_3_Km);
...
% Reaction: id = reaction_4, name = Bc transfered from cytosolic to nuclear	% Local Parameter:   id =  k1, name = k5
	...
	reaction_reaction_4=compartment_compartment_0*(reaction_reaction_4_k1*x(2)-reaction_reaction_4_k2*x(4));

% Reaction: id = reaction_5, name = Mc translated into protein	% Local Parameter:   id =  k, name = ksc
	reaction_reaction_5_k=3.2;

	reaction_reaction_5=compartment_compartment_0*function_1(reaction_reaction_5_k, x(6));

% Reaction: id = reaction_6, name = Mc nonspecific degradation	% Local Parameter:   id =  k1, name = kdmc
	reaction_reaction_6_k1=0.02;

	reaction_reaction_6=compartment_compartment_0*reaction_reaction_6_k1*x(6);
...
% Reaction: id = reaction_7, name = Cc phosphorylation	% Local Parameter:   id =  V, name = V1c
	...
	reaction_reaction_7=compartment_compartment_0*function_2(reaction_reaction_7_V, x(5), reaction_reaction_7_Km);
...
% Reaction: id = reaction_8, name = Ccp specific degradation	% Local Parameter:   id =  V, name = vdcc
	...
	reaction_reaction_8=compartment_compartment_0*function_2(reaction_reaction_8_V, x(7), reaction_reaction_8_Km);

% Reaction: id = reaction_9, name = Mp synthesis	% Local Parameter:   id =  Vs, name = vsp
	reaction_reaction_9_Vs=2.4;
	% Local Parameter:   id =  n, name = n
	reaction_reaction_9_n=2.0;
	% Local Parameter:   id =  K, name = Kap
	reaction_reaction_9_K=0.6;

	reaction_reaction_9=compartment_compartment_0*function_3(reaction_reaction_9_Vs, x(4), reaction_reaction_9_n, reaction_reaction_9_K);

% Reaction: id = reaction_10, name = Mp translated into protein	% Local Parameter:   id =  k, name = ksp
	reaction_reaction_10_k=1.2;

	reaction_reaction_10=compartment_compartment_0*function_1(reaction_reaction_10_k, x(8));
...
% Reaction: id = reaction_11, name = Pcp specific degradation	% Local Parameter:   id =  V, name = vdpc
	...
	reaction_reaction_11=compartment_compartment_0*function_2(reaction_reaction_11_V, x(10), reaction_reaction_11_Km);
...
% Reaction: id = reaction_12, name = Pc phospholation	% Local Parameter:   id =  V, name = V1p
	...
	reaction_reaction_12=compartment_compartment_0*function_2(reaction_reaction_12_V, x(9), reaction_reaction_12_Km);
...
% Reaction: id = reaction_13, name = Cc and Pc produce PCc	% Local Parameter:   id =  k1, name = k3
	...
	reaction_reaction_13=compartment_compartment_0*(reaction_reaction_13_k1*x(5)*x(9)-reaction_reaction_13_k2*x(11));
...
% Reaction: id = reaction_14, name = PCc phospholation	% Local Parameter:   id =  V, name = V1pc
	...
	reaction_reaction_14=compartment_compartment_0*function_2(reaction_reaction_14_V, x(11), reaction_reaction_14_Km);
...
% Reaction: id = reaction_15, name = PCcp specific degradation	% Local Parameter:   id =  V, name = vdpcc
	...
	reaction_reaction_15=compartment_compartment_0*function_2(reaction_reaction_15_V, x(12), reaction_reaction_15_Km);
...
% Reaction: id = reaction_20, name = Mc synthesis	% Local Parameter:   id =  Vs, name = vsc
	...
	reaction_reaction_20=compartment_compartment_0*function_3(reaction_reaction_20_Vs, x(4), reaction_reaction_20_n, reaction_reaction_20_K);
...
% Reaction: id = reaction_21, name = PCn phospholation	% Local Parameter:   id =  V, name = V3pc
	...
	reaction_reaction_21=compartment_compartment_0*function_2(reaction_reaction_21_V, x(13), reaction_reaction_21_Km);

% Reaction: id = reaction_22, name = Mp nonspecific degradation	% Local Parameter:   id =  k1, name = kdmp
	reaction_reaction_22_k1=0.02;

	reaction_reaction_22=compartment_compartment_0*reaction_reaction_22_k1*x(8);
...
% Reaction: id = reaction_23, name = Per_Cry and Clock_Bmal form inactive complex	% Local Parameter:   id =  k1, name = k7
	...
	reaction_reaction_23=compartment_compartment_0*(reaction_reaction_23_k1*x(13)*x(4)-reaction_reaction_23_k2*x(16));
...
% Reaction: id = reaction_24, name = Mb specific degradation	% Local Parameter:   id =  V, name = vmb
	...
	reaction_reaction_24=compartment_compartment_0*function_2(reaction_reaction_24_V, x(1), reaction_reaction_24_Km);
...
% Reaction: id = reaction_25, name = Mc specific degradation	% Local Parameter:   id =  V, name = vmc
	...
	reaction_reaction_25=compartment_compartment_0*function_2(reaction_reaction_25_V, x(6), reaction_reaction_25_Km);
...
% Reaction: id = reaction_33, name = PCnp specific degradation	% Local Parameter:   id =  V, name = vdpcn
	...
	reaction_reaction_33=compartment_compartment_0*function_2(reaction_reaction_33_V, x(15), reaction_reaction_33_Km);

% Reaction: id = reaction_34, name = Bc nonspecific degradation	% Local Parameter:   id =  k1, name = kdn
	reaction_reaction_34_k1=0.02;

	reaction_reaction_34=compartment_compartment_0*reaction_reaction_34_k1*x(2);
...
% Reaction: id = reaction_35, name = Bcp specific degradation	% Local Parameter:   id =  V, name = vdbc
	...
	reaction_reaction_35=compartment_compartment_0*function_2(reaction_reaction_35_V, x(3), reaction_reaction_35_Km);
...
% Reaction: id = reaction_36, name = Bn phospholation	% Local Parameter:   id =  V, name = V3b
	...
	reaction_reaction_36=compartment_compartment_0*function_2(reaction_reaction_36_V, x(4), reaction_reaction_36_Km);
...
% Reaction: id = reaction_37, name = Bnp specific degradation	% Local Parameter:   id =  V, name = vdbn
	...
	reaction_reaction_37=compartment_compartment_0*function_2(reaction_reaction_37_V, x(14), reaction_reaction_37_Km);

% Reaction: id = reaction_38, name = In nonspecific degration	% Local Parameter:   id =  k1, name = kdn
	reaction_reaction_38_k1=0.02;

	reaction_reaction_38=compartment_compartment_0*reaction_reaction_38_k1*x(16);
...
% Reaction: id = reaction_39, name = In specific degradation	% Local Parameter:   id =  V, name = vdin
	...
	reaction_reaction_39=compartment_compartment_0*function_2(reaction_reaction_39_V, x(16), reaction_reaction_39_Km);

% Reaction: id = reaction_40, name = Bn nonspecific degradation	% Local Parameter:   id =  k1, name = kdn
	reaction_reaction_40_k1=0.02;

	reaction_reaction_40=compartment_compartment_0*reaction_reaction_40_k1*x(4);
...
% Reaction: id = reaction_41, name = Bcp dephospholation	% Local Parameter:   id =  V, name = V2b
	...
	reaction_reaction_41=compartment_compartment_0*function_2(reaction_reaction_41_V, x(3), reaction_reaction_41_Km);
...
% Reaction: id = reaction_42, name = Bnp dephospholation	% Local Parameter:   id =  V, name = V4b
	...
	reaction_reaction_42=compartment_compartment_0*function_2(reaction_reaction_42_V, x(14), reaction_reaction_42_Km);
...
% Reaction: id = reaction_43, name = Ccp dephospholation	% Local Parameter:   id =  V, name = V2c
	...
	reaction_reaction_43=compartment_compartment_0*function_2(reaction_reaction_43_V, x(7), reaction_reaction_43_Km);
...
% Reaction: id = reaction_44, name = Pcp dephospholation	% Local Parameter:   id =  V, name = V2p
	...
	reaction_reaction_44=compartment_compartment_0*function_2(reaction_reaction_44_V, x(10), reaction_reaction_44_Km);
...
% Reaction: id = reaction_45, name = PCnp dephospholation	% Local Parameter:   id =  V, name = V4pc
	...
	reaction_reaction_45=compartment_compartment_0*function_2(reaction_reaction_45_V, x(15), reaction_reaction_45_Km);

% Reaction: id = reaction_46, name = PCn nonspecific degradation	% Local Parameter:   id =  k1, name = kdn
	reaction_reaction_46_k1=0.02;

	reaction_reaction_46=compartment_compartment_0*reaction_reaction_46_k1*x(13);
...
% Reaction: id = reaction_47, name = PCcp dephospholation	% Local Parameter:   id =  V, name = V2pc
	...
	reaction_reaction_47=compartment_compartment_0*function_2(reaction_reaction_47_V, x(12), reaction_reaction_47_Km);
...
% Reaction: id = reaction_48, name = Mr synthesized	% Local Parameter:   id =  Vs, name = vsr
	...
	reaction_reaction_48=compartment_compartment_0*function_3(reaction_reaction_48_Vs, x(4), reaction_reaction_48_n, reaction_reaction_48_K);

% Reaction: id = reaction_49, name = Mr nonspecific degradation	% Local Parameter:   id =  k1, name = kdmr
	reaction_reaction_49_k1=0.02;

	reaction_reaction_49=compartment_compartment_0*reaction_reaction_49_k1*x(17);
...
% Reaction: id = reaction_50, name = Mr specific degradation	% Local Parameter:   id =  V, name = vmr
	...
	reaction_reaction_50=compartment_compartment_0*function_2(reaction_reaction_50_V, x(17), reaction_reaction_50_Km);

% Reaction: id = reaction_51, name = Mr translated into protein	% Local Parameter:   id =  k, name = ksr
	reaction_reaction_51_k=1.7;

	reaction_reaction_51=compartment_compartment_0*function_1(reaction_reaction_51_k, x(17));
...
% Reaction: id = reaction_52, name = Rc transfered into nuclear	% Local Parameter:   id =  k1, name = k9
	...
	reaction_reaction_52=compartment_compartment_0*(reaction_reaction_52_k1*x(18)-reaction_reaction_52_k2*x(19));
...
% Reaction: id = reaction_53, name = Rc specific degradation	% Local Parameter:   id =  V, name = vdrc
	...
	reaction_reaction_53=compartment_compartment_0*function_2(reaction_reaction_53_V, x(18), reaction_reaction_53_Km);

% Reaction: id = reaction_54, name = Rc nonspecific degradation	% Local Parameter:   id =  k1, name = kdn
	reaction_reaction_54_k1=0.02;

	reaction_reaction_54=compartment_compartment_0*reaction_reaction_54_k1*x(18);
...
% Reaction: id = reaction_55, name = Rn specific degradation	% Local Parameter:   id =  V, name = vdrn
	...
	reaction_reaction_55=compartment_compartment_0*function_2(reaction_reaction_55_V, x(19), reaction_reaction_55_Km);

% Reaction: id = reaction_56, name = Rn nonspecific degradation	% Local Parameter:   id =  k1, name = kdn
	reaction_reaction_56_k1=0.02;

	reaction_reaction_56=compartment_compartment_0*reaction_reaction_56_k1*x(19);

	xdot=zeros(19,1);
	
% Species:   id = species_0, name = Mb, affected by kineticLaw
	xdot(1) = (1/(compartment_compartment_0))*(( 1.0 * reaction_reaction_0) + (-1.0 * reaction_reaction_2) + (-1.0 * reaction_reaction_24));
	
% Species:   id = species_1, name = Bc, affected by kineticLaw
	xdot(2) = (1/(compartment_compartment_0))*(( 1.0 * reaction_reaction_1) + (-1.0 * reaction_reaction_3) + (-1.0 * reaction_reaction_4) + (-1.0 * reaction_reaction_34) + ( 1.0 * reaction_reaction_41));
	
% Species:   id = species_2, name = Bcp, affected by kineticLaw
	xdot(3) = (1/(compartment_compartment_0))*(( 1.0 * reaction_reaction_3) + (-1.0 * reaction_reaction_18) + (-1.0 * reaction_reaction_35) + (-1.0 * reaction_reaction_41));
	
% Species:   id = species_3, name = Bn, affected by kineticLaw
	xdot(4) = (1/(compartment_compartment_0))*(( 1.0 * reaction_reaction_4) + (-1.0 * reaction_reaction_23) + (-1.0 * reaction_reaction_36) + (-1.0 * reaction_reaction_40) + ( 1.0 * reaction_reaction_42));
	
% Species:   id = species_4, name = Cc, affected by kineticLaw
	xdot(5) = (1/(compartment_compartment_0))*(( 1.0 * reaction_reaction_5) + (-1.0 * reaction_reaction_7) + (-1.0 * reaction_reaction_13) + (-1.0 * reaction_reaction_28) + ( 1.0 * reaction_reaction_43));
	
% Species:   id = species_5, name = Mc, affected by kineticLaw
	xdot(6) = (1/(compartment_compartment_0))*((-1.0 * reaction_reaction_6) + ( 1.0 * reaction_reaction_20) + (-1.0 * reaction_reaction_25));
	
% Species:   id = species_6, name = Ccp, affected by kineticLaw
	xdot(7) = (1/(compartment_compartment_0))*(( 1.0 * reaction_reaction_7) + (-1.0 * reaction_reaction_8) + (-1.0 * reaction_reaction_30) + (-1.0 * reaction_reaction_43));
	
% Species:   id = species_7, name = Mp, affected by kineticLaw
	xdot(8) = (1/(compartment_compartment_0))*(( 1.0 * reaction_reaction_9) + (-1.0 * reaction_reaction_22) + (-1.0 * reaction_reaction_26));
	
% Species:   id = species_8, name = Pc, affected by kineticLaw
	xdot(9) = (1/(compartment_compartment_0))*(( 1.0 * reaction_reaction_10) + (-1.0 * reaction_reaction_12) + (-1.0 * reaction_reaction_13) + (-1.0 * reaction_reaction_27) + ( 1.0 * reaction_reaction_44));
	
% Species:   id = species_9, name = Pcp, affected by kineticLaw
	xdot(10) = (1/(compartment_compartment_0))*((-1.0 * reaction_reaction_11) + ( 1.0 * reaction_reaction_12) + (-1.0 * reaction_reaction_29) + (-1.0 * reaction_reaction_44));
	
% Species:   id = species_10, name = PCc, affected by kineticLaw
	xdot(11) = (1/(compartment_compartment_0))*(( 1.0 * reaction_reaction_13) + (-1.0 * reaction_reaction_14) + (-1.0 * reaction_reaction_16) + (-1.0 * reaction_reaction_32) + ( 1.0 * reaction_reaction_47));
	
% Species:   id = species_11, name = PCcp, affected by kineticLaw
	xdot(12) = (1/(compartment_compartment_0))*(( 1.0 * reaction_reaction_14) + (-1.0 * reaction_reaction_15) + (-1.0 * reaction_reaction_31) + (-1.0 * reaction_reaction_47));
	
% Species:   id = species_12, name = PCn, affected by kineticLaw
	xdot(13) = (1/(compartment_compartment_0))*(( 1.0 * reaction_reaction_16) + (-1.0 * reaction_reaction_21) + (-1.0 * reaction_reaction_23) + ( 1.0 * reaction_reaction_45) + (-1.0 * reaction_reaction_46));
	
% Species:   id = species_13, name = Bnp, affected by kineticLaw
	xdot(14) = (1/(compartment_compartment_0))*((-1.0 * reaction_reaction_19) + ( 1.0 * reaction_reaction_36) + (-1.0 * reaction_reaction_37) + (-1.0 * reaction_reaction_42));
	
% Species:   id = species_14, name = PCnp, affected by kineticLaw
	xdot(15) = (1/(compartment_compartment_0))*((-1.0 * reaction_reaction_17) + ( 1.0 * reaction_reaction_21) + (-1.0 * reaction_reaction_33) + (-1.0 * reaction_reaction_45));
	
% Species:   id = species_15, name = In, affected by kineticLaw
	xdot(16) = (1/(compartment_compartment_0))*(( 1.0 * reaction_reaction_23) + (-1.0 * reaction_reaction_38) + (-1.0 * reaction_reaction_39));
	
% Species:   id = species_16, name = Mr, affected by kineticLaw
	xdot(17) = (1/(compartment_compartment_0))*(( 1.0 * reaction_reaction_48) + (-1.0 * reaction_reaction_49) + (-1.0 * reaction_reaction_50));
	
% Species:   id = species_17, name = Rc, affected by kineticLaw
	xdot(18) = (1/(compartment_compartment_0))*(( 1.0 * reaction_reaction_51) + (-1.0 * reaction_reaction_52) + (-1.0 * reaction_reaction_53) + (-1.0 * reaction_reaction_54));
	
% Species:   id = species_18, name = Rn, affected by kineticLaw
	xdot(19) = (1/(compartment_compartment_0))*(( 1.0 * reaction_reaction_52) + (-1.0 * reaction_reaction_55) + (-1.0 * reaction_reaction_56));
end
