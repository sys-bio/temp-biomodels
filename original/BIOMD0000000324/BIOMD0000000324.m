...
%
% Model name = Morris1981_MuscleFibre_Voltage_full
%
% is http://identifiers.org/biomodels.db/MODEL1011230001
% is http://identifiers.org/biomodels.db/BIOMD0000000324
...
% Compartment: id = musclefibre, name = musclefibre, constant
	compartment_musclefibre=1.0;
...
% Parameter:   id =  lambdaN_bar, name = lambdaN_bar
	global_par_lambdaN_bar=0.1;
% Parameter:   id =  lambdaM, name = lambdaM
% Parameter:   id =  lambdaM_bar, name = lambdaM_bar
	global_par_lambdaM_bar=1.0;
% Parameter:   id =  Iapp, name = I
	global_par_Iapp=50.0;
...
% assignmentRule: variable = lambdaM
	global_par_lambdaM=global_par_lambdaM_bar*cosh((global_par_V-global_par_V1)/(2*global_par_V2));
% rateRule: variable = N
global_par_N = x(2);
% rateRule: variable = M
global_par_M = x(3);
	...
	xdot=zeros(3,1);
	% rateRule: variable = V
	xdot(1) = (global_par_Iapp-global_par_gL*(global_par_V-global_par_VL)-global_par_gCa*global_par_M*(global_par_V-global_par_VCa)-global_par_gK*global_par_N*(global_par_V-global_par_VK))/global_par_C;
	% rateRule: variable = N
	xdot(2) = global_par_lambdaN*(global_par_Ninf-global_par_N);
	% rateRule: variable = M
	xdot(3) = global_par_lambdaM*(global_par_Minf-global_par_M);
end
